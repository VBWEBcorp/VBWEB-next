...
interface DeveloppementWebBrestContentProps {
  faqs: { question: string; answer: string }[]
}

export function DeveloppementWebBrestContent({ faqs }: DeveloppementWebBrestContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, développeur web à Brest"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">des sites taillés pour durer</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je développe des sites et applications web pour des entreprises brestoises et du Finistère. Stack moderne (Next.js, React, TypeScript), performance, et SEO intégré dès la première ligne de code. Plus de 150 projets livrés à ce jour.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Du web qui tient la route,{' '}
                    <span className="italic text-muted-foreground/80">même dans la tempête</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Un site web, c&apos;est comme un phare : il doit fonctionner tout le temps, sans défaillir, et guider les visiteurs vers vous. Avec les outils bricolés (WordPress plus 15 plugins), on a vite des pannes. Avec du code sur mesure en Next.js, on a de la solidité. C&apos;est mon approche, et c&apos;est ce qui fait la différence sur la durée.
                    </p>
                    <p>
                      J&apos;ai développé des sites pour des restaurants du centre-ville de Brest, des artisans à Guipavas, des professionnels de la mer à Plouzané, des cabinets à Le Relecq-Kerhuon. Chaque projet démarre par une analyse fine de l&apos;activité, puis un développement sur mesure en technos modernes.
                    </p>
                  </div>
                </Reveal>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Sites web', desc: 'Vitrines professionnelles rapides pour PME, artisans et commerces brestois.' },
                  { icon: FileSearch, title: 'Applications', desc: 'Outils métier, espaces clients, interfaces admin sur mesure.' },
                  { icon: TrendingUp, title: 'E-commerce', desc: 'Boutiques en ligne modernes et performantes, prêtes à scaler.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Code propre, bien documenté, vous restez propriétaire de tout.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Besoin d&apos;un site ou d&apos;une app qui tient la route ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un processus carré,{' '}
              <span className="italic text-muted-foreground/80">sans mauvaises surprises</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage', description: 'On fait le point sur votre activité brestoise, vos besoins, vos contraintes. Je vous livre un cahier des charges, une arborescence, des maquettes et un devis détaillé. Rien n\'est chiffré au doigt mouillé.' },
                { number: '02', title: 'Développement', description: 'Je code votre projet en Next.js et React. Vous suivez l\'avancée via une URL de preview en ligne. Chaque étape est validée ensemble avant de passer à la suivante.' },
                { number: '03', title: 'Livraison et maintenance', description: 'Mise en ligne, paramétrage SEO, tests de performance, formation si besoin. Ensuite, je reste disponible pour la maintenance, les mises à jour et les évolutions futures.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Stack moderne : Next.js, React, TypeScript">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Le trio Next.js, React et TypeScript est la référence du développement web moderne. C&apos;est utilisé par les plus grosses boîtes mondiales parce que ça permet de construire des sites rapides, maintenables et évolutifs. Et ça se voit : le score Lighthouse, les Core Web Vitals, tout est meilleur.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Rapidité', text: 'Pages rendues côté serveur, chargement instantané.' },
                            { icon: User, title: 'Fiabilité', text: 'TypeScript attrape les erreurs avant la prod.' },
                            { icon: Target, title: 'SEO friendly', text: 'Structure pensée pour les moteurs de recherche.' },
                            { icon: MessageCircle, title: 'Évolutif', text: 'Ajout de fonctionnalités sans casse.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Brest et le Finistère, un territoire que je connais">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Brest est une ville qui m&apos;est familière, avec son tissu d&apos;entreprises et son écosystème tech. J&apos;y viens régulièrement pour rencontrer des clients et discuter de leurs projets autour d&apos;un café.
                        </p>
                        <p>
                          J&apos;accompagne des projets à <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong> et <strong>Landerneau</strong>, ainsi que dans tout le nord-Finistère.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Freelance SEO Brest', desc: 'Référencement naturel local', href: '/freelance-seo-brest' },
                      { label: 'Agence SEO Brest', desc: 'Accompagnement complet', href: '/agence-seo-brest' },
                      { label: 'Consultant SEO Brest', desc: 'Expert SEO dédié', href: '/consultant-seo-brest' },
