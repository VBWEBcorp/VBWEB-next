...
interface SiteInternetProfessionnelDeSanteContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetProfessionnelDeSanteContent({ faqs }: SiteInternetProfessionnelDeSanteContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour professionnel de santé"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Site internet professionnel de santé,{' '}
              <span className="italic text-muted-foreground/80">conforme, clair et trouvé sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO et créateur de sites internet. Je crée des sites pour médecins, cabinets médicaux et professions réglementées partout en France. Conforme RGPD santé, respectueux du code de déontologie, optimisé pour que vos patients vous trouvent.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un cabinet qui se voit,{' '}
                    <span className="italic text-muted-foreground/80">sans jamais sortir du cadre</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand un patient tape &quot;médecin généraliste&quot; suivi de sa ville, Google affiche d&apos;abord les cabinets les mieux référencés. Si votre site n&apos;est pas là, il passe chez un confrère. Mon travail, c&apos;est de construire pour votre cabinet un site informatif, clair et bien positionné, tout en restant strictement dans le cadre fixé par votre Ordre.
                    </p>
                    <p>
                      Je connais bien les codes : pas d&apos;allégations thérapeutiques, pas de comparaisons, pas de publicité déguisée. Juste une présentation juste de votre parcours, de vos spécialités et des modalités pratiques. Et surtout, un site qui respecte le RGPD santé de bout en bout.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour professionnel de santé"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: User, title: 'Conformité ordre', desc: 'Site respectant le code de déontologie de votre profession, validé avec vous.' },
                  { icon: Zap, title: 'RGPD santé', desc: 'Mentions, consentement et hébergement adaptés aux données sensibles.' },
                  { icon: FileSearch, title: 'Référencement local', desc: 'Apparaître dans les recherches "médecin près de chez moi" partout en France.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Chaque élément du site est validé avec vous pour que tout respecte les règles de votre Ordre professionnel.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">des résultats concrets</span>
            </h2>
          </Reveal>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
              Sites créés pour des professionnels de santé
            </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Besoin d&apos;un site conforme pour votre cabinet ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage déontologique', description: 'On fait le point sur votre profession, votre Ordre et les contenus autorisés. Je vous oriente dès le départ pour éviter toute zone grise.' },
                { number: '02', title: 'Conception du site', description: 'Je construis les maquettes, rédige les textes conformes et intègre votre outil de prise de rendez-vous. Chaque élément est validé avec vous.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Mise en ligne, configuration de Google Business Profile, optimisation locale. Vous êtes formé pour garder la main sur votre site.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Déontologie médicale et communication en ligne">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Depuis 2020, les recommandations du Conseil National de l&apos;Ordre des Médecins se sont assouplies sur la communication en ligne. Vous pouvez désormais avoir un site internet professionnel, à condition de respecter certains principes simples : loyauté, dignité, absence de publicité comparative.
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Informatif', text: 'Présenter votre parcours, vos diplômes, votre approche.' },
                            { icon: Target, title: 'Non comparatif', text: 'Aucune mention de supériorité sur les confrères.' },
                            { icon: MessageCircle, title: 'Sans promesse', text: 'Pas d\'allégation de résultat thérapeutique.' },
                            { icon: Zap, title: 'Pratique', text: 'Horaires, tarifs, modes de paiement, accès.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Autres professions de santé accompagnées">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je n&apos;accompagne pas uniquement les médecins. J&apos;ai créé des sites pour des kinés, psychologues, ostéopathes et sophrologues, avec les mêmes exigences de conformité et de référencement local, partout en France.
                        </p>
                        <p>
                          Retrouvez les pages dédiées à chaque profession pour voir comment j&apos;adapte mon approche, ou rendez-vous sur la page hub <Link href="/site-internet-therapeute" className="text-primary underline underline-offset-2">site internet thérapeute</Link> qui regroupe toutes les pratiques.
                        </p>
                        <div className="grid gap-2 sm:grid-cols-2">
                          {[
                            ...
                            <Link
                              key={link.href}
                              href={link.href}
                              className="group flex items-center gap-2 rounded-lg border border-border/40 bg-background/30 px-3 py-2.5 transition-all hover:border-primary/30 hover:bg-background/50"
                            >
                              <ArrowRight className="size-3 shrink-0 text-muted-foreground/40 transition-all group-hover:translate-x-0.5 group-hover:text-primary" />
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Création de site', desc: 'Site optimisé SEO dès le départ', href: '/creation-site-internet-rennes' },
                      { label: 'SEO local', desc: 'Google Maps et proximité', href: '/referencement-local-rennes' },
                      { label: 'Freelance SEO', desc: 'Stratégie Google complète', href: '/freelance-seo-rennes' },
