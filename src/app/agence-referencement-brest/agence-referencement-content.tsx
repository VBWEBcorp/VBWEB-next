...
interface AgenceReferencementBrestContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementBrestContent({ faqs }: AgenceReferencementBrestContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Brest"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Brest :{' '}
              <span className="italic text-muted-foreground/80">un expert SEO à votre service</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Brest pour améliorer votre visibilité sur Google ? Je suis Victor Béasse, expert SEO en Bretagne. J&apos;aide les entreprises du Finistère à se positionner sur les recherches qui comptent. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Ce que je fais{' '}
                    <span className="italic text-muted-foreground/80">pour les entreprises brestoises</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement naturel permet à votre site d&apos;apparaître quand un prospect brestois tape &quot;électricien Brest&quot; ou &quot;restaurant rade de Brest&quot; sur Google. J&apos;identifie les requêtes de vos clients, j&apos;optimise vos pages et je construis votre visibilité dans le Finistère.
                    </p>
                    <p>
                      Brest est une ville avec un tissu économique dense : naval, numérique, recherche, commerce, tourisme. Chaque secteur a ses propres enjeux de visibilité en ligne. Mon rôle, c&apos;est de vous positionner là où vos clients vous cherchent.
                    </p>
                  </div>
                </Reveal>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site performant, bien indexé et adapté aux critères de Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages ciblées qui répondent aux recherches de vos clients.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens entrants de qualité pour asseoir votre crédibilité.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Premiers résultats visibles entre 3 et 6 mois, avec une progression qui s&apos;accélère au fil du temps.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">et des résultats concrets</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Curieux de voir ce que le référencement peut apporter à votre activité ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un accompagnement{' '}
              <span className="italic text-muted-foreground/80">structuré et transparent</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On fait connaissance', description: 'Un premier échange de 30 minutes pour comprendre votre activité, vos objectifs et les freins à votre visibilité. En visio ou en personne à Brest.' },
                { number: '02', title: 'Audit complet', description: 'J\'analyse votre site en profondeur : technique, contenu, positionnement, concurrents dans le Finistère. Vous recevez un plan d\'action avec les priorités identifiées.' },
                { number: '03', title: 'Progression mensuelle', description: 'Les optimisations sont déployées chaque mois. Vous suivez l\'évolution de vos positions, votre trafic et les conversions dans un espace dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert référencement vs agence à Brest">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Brest compte plusieurs agences digitales qui intègrent le référencement dans leurs services. La différence avec un expert dédié : le SEO n&apos;est pas un service parmi d&apos;autres, c&apos;est mon coeur de métier. Vous bénéficiez d&apos;une expertise pointue et d&apos;un suivi personnalisé.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Expert dédié', text: 'Le SEO est mon unique spécialité.' },
                            { icon: Zap, title: 'Réactivité', text: 'Réponse rapide, pas de circuit de validation.' },
                            { icon: Target, title: 'Connaissance locale', text: 'Le Finistère, je connais bien.' },
                            { icon: MessageCircle, title: 'Suivi clair', text: 'Rapport mensuel avec vos indicateurs.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Référencement naturel dans le Finistère">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le Finistère a une économie variée : industrie navale, tourisme, commerce, tech. Chaque secteur a ses mots-clés et sa saisonnalité. Un référencement bien pensé tient compte de ces spécificités pour vous apporter des clients au bon moment.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Brest et dans les communes voisines : <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong>, <strong>Landerneau</strong>. Je travaille aussi avec des clients dans tout le Finistère et en Bretagne.
                        </p>
