...
export function CreationSiteInternetSaintBrieucContent({ faqs }: CreationSiteInternetContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet à Saint-Brieuc"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">un site qui travaille pour vous sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites web à Saint-Brieuc qui attirent du trafic ciblé, convertissent et grimpent dans les résultats Google. Technique propre, design calme, SEO intégré dès le départ. Plus de 150 sites livrés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Pas une vitrine figée,{' '}
                    <span className="italic text-muted-foreground/80">un outil qui rapporte</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Beaucoup d&apos;entreprises briochines ont payé cher pour un site qui ne leur ramène pas un client. Le souci : un beau visuel, mais aucune logique de trafic. Moi, je pars du besoin : qui doit vous trouver, comment, et qu&apos;est-ce qui doit le pousser à vous appeler. Tout le reste en découle.
                    </p>
                    <p>
                      Un site, c&apos;est comme une devanture dans une rue passante. Si la rue est déserte ou si la devanture ne dit rien, personne ne pousse la porte. Mon rôle, c&apos;est de choisir la bonne rue (Google), de poser une devanture claire et d&apos;ouvrir grand la porte.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Création de site internet à Saint-Brieuc"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Design calme', desc: 'Une interface nette, qui met en avant ce qui compte pour vos clients.' },
                  { icon: Zap, title: 'Performance', desc: 'Pages qui s\'ouvrent en moins d\'une seconde, même sur un mobile lent.' },
                  { icon: FileSearch, title: 'SEO intégré', desc: 'Une structure pensée pour grimper sur les mots-clés des Côtes-d\'Armor.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                La plupart des sites sont en ligne en 3 à 5 semaines, avec un démarrage SEO dans la foulée.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Des résultats,{' '}
              <span className="italic text-muted-foreground/80">pas des slogans</span>
            </h2>
          </Reveal>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Des projets livrés,{' '}
              <span className="italic text-muted-foreground/80">des chiffres concrets</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir ce qu&apos;un site bien pensé peut changer pour votre activité briochine ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Trois étapes,{' '}
              <span className="italic text-muted-foreground/80">zéro flou</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage et audit', description: 'On démarre par une discussion pour comprendre votre activité, vos clients dans les Côtes-d\'Armor et vos concurrents directs. J\'identifie les requêtes sur lesquelles votre site doit absolument sortir, et on écrit ensemble une feuille de route claire.' },
                { number: '02', title: 'Conception et développement', description: 'Je réalise les maquettes que vous validez, puis je passe au développement. Tout est codé proprement en Next.js, avec un souci permanent de vitesse et de SEO. Vous suivez l\'évolution en direct grâce à un lien de prévisualisation.' },
                { number: '03', title: 'Lancement et suivi SEO', description: 'Mise en ligne avec une configuration SEO complète : balisage, sitemap, Search Console, Analytics. Dès le jour un, le site est prêt à être indexé et à progresser sur Google sur les requêtes briochines.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Le vrai coût d&apos;un site &quot;pas cher&quot;">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Un site acheté 500 euros chez un prestataire low cost finit souvent par coûter très cher. Soit parce qu&apos;il est invisible sur Google, soit parce qu&apos;il faut tout refaire deux ans plus tard. Je préfère investir dans un site propre dès le départ, qui tient dans la durée, et qui ramène du business mois après mois.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un seul interlocuteur', text: 'La même personne du début à la fin.' },
                            { icon: Zap, title: 'Rapide', text: 'Un site qui réagit au quart de tour.' },
                            { icon: Target, title: 'Sur mesure', text: 'Aucun template recyclé.' },
                            { icon: MessageCircle, title: 'Clair', text: 'Un devis lisible, pas de surcoûts.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Création de site et visibilité dans la baie de Saint-Brieuc">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Les clients des entreprises briochines cherchent sur Google avec des requêtes très locales. Pour capter ce trafic, le site doit être construit dès le départ pour parler &quot;proximité&quot; : balisage local, contenu géographique, fiche Google Business Profile bien reliée.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à <strong>Saint-Brieuc</strong>, <strong>Plérin</strong>, <strong>Langueux</strong>, <strong>Trégueux</strong>, <strong>Lamballe</strong> et <strong>Ploufragan</strong>.
                        </p>
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl">
              Création de site à Saint-Brieuc :{' '}
