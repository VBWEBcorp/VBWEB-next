...
interface AgenceSeoQuimperContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoQuimperContent({ faqs }: AgenceSeoQuimperContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Quimper - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence SEO à Quimper ?{' '}
              <span className="italic text-muted-foreground/80">Un expert dédié, c&apos;est encore mieux</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence SEO à Quimper pour développer votre présence sur Google. Je suis Victor Béasse, consultant SEO indépendant en Bretagne. Un seul interlocuteur, une stratégie taillée pour la Cornouaille. Plus de 200 projets SEO, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Du référencement adapté{' '}
                    <span className="italic text-muted-foreground/80">au marché de Cornouaille</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quimper est la capitale de la Cornouaille, avec un tissu économique qui va de l&apos;agroalimentaire au commerce de centre-ville en passant par l&apos;artisanat et le tourisme. Vos clients quimpérois recherchent sur Google des services comme &quot;dentiste Quimper&quot;, &quot;plombier Ergué-Gabéric&quot; ou &quot;crêperie Concarneau&quot;. Si vous n&apos;êtes pas visible, c&apos;est un concurrent qui répond à leur demande.
                    </p>
                    <p>
                      Mon approche est simple : je commence par comprendre votre marché et votre concurrence, puis je construis une stratégie SEO qui cible les requêtes les plus rentables pour votre activité. Chaque euro investi doit vous rapporter des clients.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir où se situe votre site sur Google en Cornouaille ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Un premier échange', description: '30 minutes pour comprendre votre activité à Quimper, votre clientèle cible et ce que Google peut vous apporter concrètement. Je vous dis sans détour si le SEO est le bon levier.' },
                { number: '02', title: 'Audit de votre site', description: 'Analyse technique, étude de contenu et cartographie de la concurrence en Cornouaille. Vous recevez un plan d\'action priorisé, avec des objectifs réalistes pour votre marché.' },
                { number: '03', title: 'Optimisations mensuelles', description: 'Les actions sont déployées progressivement : corrections techniques, contenus optimisés, liens de qualité. Chaque mois, vous voyez vos progrès dans votre espace de suivi.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert indépendant vs agence SEO à Quimper">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>À Quimper, le choix entre une agence et un expert indépendant revient souvent à une question de taille. Pour une PME ou un commerce local, un expert dédié offre un meilleur rapport qualité-investissement : moins de frais de structure, plus de temps passé sur votre projet, et une relation de confiance qui s&apos;installe dans la durée.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Contact direct', text: 'Vous parlez à celui qui fait le travail.' },
                            { icon: Zap, title: 'Souplesse', text: 'Pas de process rigide, on s\'adapte.' },
                            { icon: Target, title: 'Focus Cornouaille', text: 'Stratégie pensée pour votre zone.' },
                            { icon: MessageCircle, title: 'Clarté totale', text: 'Données ouvertes, rapports mensuels.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Référencement local en Cornouaille">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Quimper et la Cornouaille forment un bassin de vie où le commerce local et le tourisme se complètent. Les recherches Google sont nombreuses et variées, de la restauration à l&apos;artisanat en passant par les services à la personne. Se positionner sur ces requêtes locales, c&apos;est toucher des clients qui ont besoin de vous maintenant.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Quimper et dans les communes voisines : <strong>Ergué-Gabéric</strong>, <strong>Pluguffan</strong>, <strong>Fouesnant</strong>, <strong>Bénodet</strong>, <strong>Concarneau</strong>. Le SEO local couvre l&apos;ensemble de votre zone d&apos;activité.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Quimper', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-quimper' },
                      { label: 'Freelance SEO Quimper', desc: 'Expert indépendant à votre service', href: '/freelance-seo-quimper' },
