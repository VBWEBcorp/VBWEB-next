...
interface AgenceReferencementNantesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementNantesContent({ faqs }: AgenceReferencementNantesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Nantes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Nantes :{' '}
              <span className="italic text-muted-foreground/80">boostez votre visibilité Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Nantes ? Je suis Victor Béasse, expert SEO dans le Grand Ouest. J&apos;accompagne les entreprises nantaises pour gagner des positions sur Google et transformer leur site en véritable outil commercial. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Ce que je fais{' '}
                    <span className="italic text-muted-foreground/80">pour les entreprises nantaises</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Nantes est la 6e ville de France. La concurrence en ligne y est plus forte que dans les villes moyennes, mais le volume de recherche aussi. Le référencement naturel permet de capter cette demande sans dépenser en publicité. J&apos;analyse vos mots-clés, j&apos;optimise vos pages et je construis votre positionnement sur Google.
                    </p>
                    <p>
                      Que vous soyez dans le commerce, les services, la tech ou la restauration, les Nantais cherchent sur Google avant de prendre une décision. Mon travail, c&apos;est de faire en sorte que votre site soit là au bon moment, avec la bonne réponse.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Stratégie de référencement pour entreprises à Nantes"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site rapide, bien structuré et correctement indexé par Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages qui ciblent les recherches de vos clients nantais.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens de qualité pour renforcer votre positionnement.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Les premiers résultats concrets apparaissent entre 3 et 6 mois, puis la croissance s&apos;amplifie.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">avec des résultats mesurables</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir ce que le référencement peut changer pour votre business ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un process rodé{' '}
              <span className="italic text-muted-foreground/80">pour des résultats concrets</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier échange', description: 'On prend 30 minutes pour comprendre votre activité, votre marché et vos ambitions. En visio ou à Nantes si vous préférez vous voir.' },
                { number: '02', title: 'Audit stratégique', description: 'J\'analyse votre site et votre concurrence à Nantes : technique, contenu, liens, positionnement. Vous recevez un plan d\'action priorisé avec des objectifs clairs.' },
                { number: '03', title: 'Croissance mesurable', description: 'Les optimisations sont déployées chaque mois. Vous suivez en temps réel la progression de vos positions Google, de votre trafic et de vos prises de contact.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO vs agence de référencement à Nantes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Nantes compte de nombreuses agences de référencement, des plus petites aux plus grandes. La différence avec un expert indépendant : vous travaillez avec une seule personne qui connaît votre dossier, qui prend les décisions et qui rend des comptes. Pas de process lourds, pas de sous-traitance.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Contact direct', text: 'Un seul interlocuteur, celui qui fait le travail.' },
                            { icon: Zap, title: 'Agilité', text: 'Décisions rapides, ajustements immédiats.' },
                            { icon: Target, title: 'Vision Grand Ouest', text: 'Connaissance du marché nantais et de l\'Ouest.' },
                            { icon: MessageCircle, title: 'Reporting clair', text: 'Un point mensuel avec vos indicateurs clés.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement dans la métropole nantaise">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          La métropole nantaise concentre plus de 650 000 habitants et une activité économique dense. Le volume de recherche sur Google y est considérable, ce qui représente une opportunité majeure pour les entreprises qui investissent dans leur référencement.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Nantes et dans la métropole : <strong>Saint-Herblain</strong>, <strong>Rezé</strong>, <strong>Orvault</strong>, <strong>Carquefou</strong>, <strong>Saint-Nazaire</strong>. Je travaille aussi avec des clients en Loire-Atlantique et dans tout le Grand Ouest.
                        </p>
