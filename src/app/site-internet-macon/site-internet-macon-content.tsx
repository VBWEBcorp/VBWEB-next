...
interface SiteInternetMaconContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetMaconContent({ faqs }: SiteInternetMaconContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour maçon"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Site internet maçon,{' '}
              <span className="italic text-muted-foreground/80">votre savoir-faire dans la vitrine</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites internet pour les maçons, partout en France. Extensions, rénovations, terrasses, dalles béton, murs, gros œuvre : un site qui met en avant vos chantiers, rassure les futurs clients et attire les bons projets grâce à Google.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site qui raconte{' '}
                    <span className="italic text-muted-foreground/80">chaque pierre posée</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Un chantier de maçonnerie, ce n&apos;est pas une décision qu&apos;on prend en cinq minutes. Une extension, une rénovation, une terrasse, c&apos;est des milliers d&apos;euros et des semaines de travaux. Les clients comparent, regardent les avis, passent du temps sur les sites avant même de décrocher leur téléphone. Ils tapent &quot;maçon extension maison&quot;, &quot;rénovation maçonnerie&quot;, &quot;dalle béton terrasse&quot; ou &quot;maçon + leur ville&quot;.
                    </p>
                    <p>
                      Ma mission, c&apos;est de construire un site qui répond à toutes leurs questions avant même qu&apos;ils ne les posent. Photos avant/après de vos chantiers, pages détaillées par prestation, explication simple des techniques que vous utilisez, budgets indicatifs, zones d&apos;intervention, assurance décennale visible. Où que vous soyez en France, un site comme ça fait la différence entre un maçon qu&apos;on rappelle et un maçon qu&apos;on zappe.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour maçon"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Portfolio visuel', desc: 'Vos chantiers avant/après classés par type (extension, terrasse, mur, rénovation).' },
                  { icon: FileSearch, title: 'Pages par prestation', desc: 'Extension, dalle, terrasse, ravalement, gros œuvre : une page détaillée par métier.' },
                  { icon: TrendingUp, title: 'SEO local poussé', desc: 'Une page par ville ou zone d\'intervention, rédigée unique, jamais copiée-collée.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                En maçonnerie, un seul chantier décroché via le site rembourse largement le coût de sa création.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie d&apos;attirer les beaux chantiers ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Du premier café{' '}
              <span className="italic text-muted-foreground/80">au site qui tourne</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On fait le tour', description: 'Au téléphone, vous me racontez vos prestations, vos plus beaux chantiers, les projets que vous préférez et ceux que vous voulez attirer. Je note tout et je vous propose une structure de site claire.' },
                { number: '02', title: 'Je mets en forme', description: 'Je rédige les pages, j\'organise vos photos avant/après, j\'optimise pour les requêtes maçonnerie de votre zone. Vous relisez tranquillement, on ajuste si besoin.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Le site est en ligne, votre fiche Google est prête. Je suis joignable pour ajouter vos nouveaux chantiers, ajuster le contenu et répondre à vos questions au fil du temps.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Les chantiers les plus rentables pour un maçon">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Tous les chantiers n&apos;ont pas la même marge ni le même intérêt. Un site bien pensé vous permet d&apos;attirer les projets que vous aimez et qui rapportent, plutôt que des petites interventions chronophages. Voici les types de chantiers à mettre particulièrement en avant.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Extensions', text: 'Le chantier roi pour un maçon : beau budget, belle visibilité, belles photos.' },
                            { icon: User, title: 'Rénovations', text: 'Transformation complète, ravalement, reprise en sous-œuvre.' },
                            { icon: Target, title: 'Terrasses', text: 'Dalles béton, terrasses carrelées, muret de soutènement.' },
                            { icon: MessageCircle, title: 'Gros œuvre neuf', text: 'Fondations, dallage, élévation de murs pour construction neuve.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Vous êtes un autre artisan du bâtiment ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Chaque métier a ses spécificités, ses clients, ses recherches Google. Si vous êtes plombier, couvreur, électricien ou autre artisan, j&apos;ai une page pensée pour votre métier, avec les bons angles.
                        </p>
