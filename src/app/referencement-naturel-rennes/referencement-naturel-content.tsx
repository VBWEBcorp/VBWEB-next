...
interface ReferencementNaturelRennesContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelRennesContent({ faqs }: ReferencementNaturelRennesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Rennes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Rennes :{' '}
              <span className="italic text-muted-foreground/80">soyez visible là où vos clients vous cherchent</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO basé à Rennes. Le référencement naturel, c&apos;est mon quotidien depuis plus de 5 ans. J&apos;aide les PME, artisans et commerces bretons à se positionner sur Google pour attirer des clients qualifiés, sans dépendre de la publicité.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">change tout</span> ?
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand un habitant de Rennes cherche &quot;plombier Rennes&quot; ou &quot;restaurant Cesson-Sévigné&quot; sur Google, il clique sur les premiers résultats. Le référencement naturel, c&apos;est le travail qui permet à votre site de figurer parmi ces premiers résultats, sans payer de publicité.
                    </p>
                    <p>
                      Contrairement aux annonces Google Ads qui disparaissent dès que vous coupez le budget, le référencement naturel construit une visibilité pérenne. Chaque page optimisée continue de travailler pour vous, jour après jour, comme un commercial qui ne dort jamais.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Référencement naturel à Rennes : analyse et stratégie SEO"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site rapide, bien structuré et parfaitement lisible par Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages qui répondent aux vraies questions de vos clients avec les bons mots-clés.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens de qualité qui renforcent la crédibilité de votre site aux yeux de Google.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Le référencement naturel prend du temps, c&apos;est vrai. Mais les premiers résultats arrivent entre 3 et 6 mois, et la progression s&apos;accélère ensuite.
              </p>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
              Résultats en référencement naturel
            </p>
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Des entreprises que j&apos;ai accompagnées{' '}
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que le référencement naturel peut changer pour votre site ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Votre projet de référencement naturel,{' '}
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On fait le point', description: 'Un premier échange de 30 minutes pour comprendre votre activité, vos objectifs et ce qui bloque votre visibilité sur Google. Je vous dis honnêtement si le référencement naturel est le bon levier pour vous.' },
                { number: '02', title: 'J\'audite votre site', description: 'Analyse technique complète, étude de vos mots-clés, benchmark de vos concurrents à Rennes et en Bretagne. Vous recevez un plan d\'action concret, classé par priorité, avec des résultats estimés.' },
                { number: '03', title: 'On optimise mois après mois', description: 'Les corrections techniques, les contenus optimisés et le travail de notoriété sont déployés progressivement. Chaque mois, vous voyez vos positions, votre trafic et les demandes reçues dans votre espace de suivi.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Ce qui rend mon approche du référencement naturel différente">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Beaucoup de prestataires SEO appliquent les mêmes recettes à tous leurs clients. Mon approche est différente : je pars toujours de votre marché, de vos vrais concurrents et des mots-clés que vos futurs clients tapent réellement sur Google.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un seul interlocuteur', text: 'Vous échangez directement avec moi, pas avec un commercial.' },
                            { icon: Zap, title: 'Réactivité', text: 'Réponse dans la journée, ajustements rapides.' },
                            { icon: Target, title: 'Stratégie sur mesure', text: 'Pas de package générique, tout est adapté à votre situation.' },
                            { icon: MessageCircle, title: 'Transparence totale', text: 'Rapport mensuel clair, accès complet à vos données.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement naturel à Rennes et en Bretagne">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Rennes est une métropole dynamique avec un tissu économique dense. Les recherches locales explosent : &quot;boulangerie Rennes&quot;, &quot;avocat Rennes&quot;, &quot;plombier Bruz&quot;... Chaque requête est une opportunité pour capter un client qui a besoin de vous maintenant.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises dans toute la métropole rennaise : <strong>Cesson-Sévigné</strong>, <strong>Saint-Grégoire</strong>, <strong>Bruz</strong>, <strong>Chantepie</strong>, <strong>Pacé</strong>. Et aussi à <strong>Saint-Malo</strong>, <strong>Vannes</strong>, <strong>Brest</strong> et <strong>Lorient</strong>.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Freelance SEO', desc: 'Mon profil et ma méthode', href: '/freelance-seo-rennes' },
