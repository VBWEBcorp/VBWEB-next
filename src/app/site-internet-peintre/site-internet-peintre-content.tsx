...
interface SiteInternetPeintreContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetPeintreContent({ faqs }: SiteInternetPeintreContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour peintre"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pensé pour décrocher plus de chantiers</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites internet pour peintres en bâtiment partout en France. Des sites qui mettent en valeur vos photos avant/après, qui remontent sur Google, et qui transforment les visiteurs en demandes de devis pour votre peinture intérieure, vos ravalements ou vos enduits décoratifs.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site internet peintre{' '}
                    <span className="italic text-muted-foreground/80">qui ramène vraiment du chantier</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Un peintre ne vend pas un produit sur étagère, il vend un savoir-faire et un rendu. Tant qu&apos;un prospect ne voit pas vos photos avant/après, il ne peut pas juger de la qualité. C&apos;est exactement ce que fait votre site : il montre votre travail à la place du bouche-à-oreille quand celui-ci ne suffit plus.
                    </p>
                    <p>
                      Vos futurs clients tapent des requêtes très concrètes sur Google : &quot;peintre intérieur près de chez moi&quot;, &quot;ravalement façade prix&quot;, &quot;pose papier peint&quot;, &quot;peinture salon avant après&quot;. Mon travail, c&apos;est d&apos;aligner votre site sur ces recherches pour que vous apparaissiez au bon moment, celui où la personne est prête à demander un devis.
                    </p>
                    <p>
                      Imaginez votre site comme une vitrine ouverte en permanence. Pendant que vous êtes en haut d&apos;un échafaudage, elle travaille pour vous : elle montre vos chantiers, elle rassure, et elle fait sonner le téléphone le lendemain matin.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Création site internet pour peintre"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Galerie avant/après', desc: 'Une vitrine classée par prestation pour que vos chantiers parlent à votre place.' },
                  { icon: FileSearch, title: 'Pages métier ciblées', desc: 'Peinture intérieure, ravalement, papier peint, enduits : une page optimisée par prestation.' },
                  { icon: TrendingUp, title: 'SEO local solide', desc: 'Pour ressortir sur Google et Maps quand on cherche un peintre dans votre zone.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                J&apos;accompagne des peintres partout en France, du petit artisan seul à l&apos;entreprise de 10 salariés.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de voir ce qu&apos;un bon site pourrait apporter à votre activité de peintre ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On se cale une visio', description: 'On prend 30 minutes pour parler de vos prestations, de votre zone de chantier et des clients que vous voulez attirer. Je vous dis franchement ce qu\'un site peut vous apporter dans votre situation.' },
                { number: '02', title: 'Je construis votre site', description: 'Je conçois la structure autour de vos spécialités : peinture intérieure, ravalement de façade, papier peint, enduits décoratifs. Je prépare la galerie avant/après et j\'optimise chaque page pour Google.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Le site est livré, indexé, relié à votre fiche Google Business Profile. Chaque mois, vous voyez les visites, les positions et les demandes de devis reçues dans votre tableau de bord.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pourquoi les photos avant/après changent tout pour un peintre">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Un client qui cherche un peintre a besoin d&apos;être rassuré avant d&apos;appeler. Les photos avant/après font ce travail à votre place : elles prouvent le savoir-faire, elles donnent des idées, et elles déclenchent l&apos;envie.</p>
                        <p>Sur le site, je crée une galerie structurée par type de chantier : <strong>peinture intérieure</strong>, <strong>ravalement de façade</strong>, <strong>pose de papier peint</strong>, <strong>enduits décoratifs</strong>. Chaque projet devient une preuve visuelle qui travaille pour vous 24h/24.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Preuve sociale', text: 'Vos chantiers parlent à votre place.' },
                            { icon: Zap, title: 'Décision rapide', text: 'Le visiteur se projette en quelques secondes.' },
                            { icon: Target, title: 'Plus de devis', text: 'Un site avec photos convertit 2 à 3 fois plus.' },
                            { icon: MessageCircle, title: 'Moins d\'appels pour rien', text: 'Les curieux filtrent d\'eux-mêmes en amont.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Un site internet peintre, et aussi pour les autres métiers du bâtiment">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          J&apos;accompagne les peintres partout en France, mais aussi l&apos;ensemble des métiers du bâtiment. Si vous cumulez plusieurs activités, je construis votre site autour de votre métier principal et j&apos;ajoute des pages secondaires pour vos autres prestations.
                        </p>
                        <p>
                          Vous travaillez dans un autre métier ou vous connaissez un confrère ? Je réalise aussi des sites pour <Link href="/site-internet-plombier" className="text-primary underline-offset-2 hover:underline">plombiers</Link>, <Link href="/site-internet-couvreur" className="text-primary underline-offset-2 hover:underline">couvreurs</Link>, <Link href="/site-internet-paysagiste" className="text-primary underline-offset-2 hover:underline">paysagistes</Link>, <Link href="/site-internet-menuisier" className="text-primary underline-offset-2 hover:underline">menuisiers</Link> et <Link href="/site-internet-carreleur" className="text-primary underline-offset-2 hover:underline">carreleurs</Link>. Retrouvez l&apos;ensemble des offres sur la page <Link href="/site-internet-artisan" className="text-primary underline-offset-2 hover:underline">site internet artisan</Link>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Partout en France', 'Peinture intérieure', 'Ravalement', 'Papier peint', 'Enduits décoratifs'].map((tag) => (
