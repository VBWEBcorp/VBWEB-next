...
interface AgenceSeoSaintBrieucContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoSaintBrieucContent({ faqs }: AgenceSeoSaintBrieucContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Saint-Brieuc - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence SEO à Saint-Brieuc :{' '}
              <span className="italic text-muted-foreground/80">la force d&apos;un expert, sans la lourdeur d&apos;une agence</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence SEO à Saint-Brieuc pour être mieux positionné sur Google. Je vous propose une approche différente : un expert SEO dédié qui connait votre dossier et travaille avec vous en direct. Victor Béasse, consultant SEO en Bretagne. Plus de 200 projets, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">dans les Côtes-d&apos;Armor</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Saint-Brieuc est le coeur économique des Côtes-d&apos;Armor : agroalimentaire, commerce, services, tourisme autour de la Baie. Vos futurs clients cherchent sur Google &quot;boulangerie Saint-Brieuc&quot;, &quot;électricien Plérin&quot; ou &quot;restaurant Côtes-d&apos;Armor&quot;. Si votre site n&apos;est pas bien référencé, ces recherches profitent à vos concurrents.
                    </p>
                    <p>
                      Je prends le temps de comprendre votre activité et votre concurrence locale. Ensuite, je mets en place une stratégie SEO adaptée à votre marché, avec des actions concrètes et des résultats que vous pouvez suivre au fil des mois.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que Google peut vous apporter à Saint-Brieuc ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Discussion libre', description: '30 minutes pour échanger sur votre activité à Saint-Brieuc, comprendre vos enjeux et évaluer si le SEO peut réellement vous aider à gagner des clients. Pas de jargon, que du concret.' },
                { number: '02', title: 'Analyse approfondie', description: 'Audit technique, contenu et popularité de votre site. Étude de la concurrence dans les Côtes-d\'Armor. Vous recevez un plan d\'action clair avec les actions prioritaires.' },
                { number: '03', title: 'Résultats progressifs', description: 'Mois après mois, les optimisations sont déployées. Vous suivez l\'évolution de vos positions, de votre trafic et des demandes reçues dans un espace de suivi dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO vs agence à Saint-Brieuc : comment choisir">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les agences SEO ont leur place, mais pour une PME ou un commerce briochin, un expert indépendant offre souvent un meilleur accompagnement. Pourquoi ? Parce que votre dossier n&apos;est pas noyé parmi des dizaines d&apos;autres. Je consacre du temps à comprendre votre métier, vos clients et ce qui vous distingue de la concurrence.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation humaine', text: 'On se connait, on se comprend.' },
                            { icon: Zap, title: 'Vitesse d\'exécution', text: 'Pas de circuit de validation.' },
                            { icon: Target, title: 'Ancrage local', text: 'Connaissance des Côtes-d\'Armor.' },
                            { icon: MessageCircle, title: 'Zéro opacité', text: 'Vous voyez tout, vous savez tout.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le SEO dans l'agglomération briochine">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Saint-Brieuc et son agglomération offrent un vrai potentiel SEO. Beaucoup d&apos;entreprises costarmoricaines n&apos;ont pas encore travaillé leur référencement, ce qui laisse des opportunités pour celles qui s&apos;y mettent maintenant. La Baie de Saint-Brieuc, le secteur agroalimentaire et le commerce de proximité génèrent des recherches que votre site peut capter.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Saint-Brieuc et dans l&apos;agglomération : <strong>Plérin</strong>, <strong>Langueux</strong>, <strong>Trégueux</strong>, <strong>Lamballe</strong>, <strong>Ploufragan</strong>. Le référencement local couvre l&apos;intégralité de votre zone de chalandise.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Saint-Brieuc', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-saint-brieuc' },
                      { label: 'Freelance SEO Saint-Brieuc', desc: 'Expert indépendant à votre service', href: '/freelance-seo-saint-brieuc' },
