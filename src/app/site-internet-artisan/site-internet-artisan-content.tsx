...
interface SiteInternetArtisanContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetArtisanContent({ faqs }: SiteInternetArtisanContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour artisans"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">qui fait sonner votre téléphone</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites internet pour les artisans du bâtiment, partout en France. Un site simple, rapide, qui met vos chantiers en valeur et qui remonte sur Google quand quelqu&apos;un cherche votre métier dans votre secteur. Plus de 150 sites créés et 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site internet artisan{' '}
                    <span className="italic text-muted-foreground/80">qui travaille pour vous</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      La plupart de vos futurs clients vous cherchent sur Google au moment où ils ont un vrai besoin. Ils tapent &quot;plombier urgence dimanche&quot;, &quot;couvreur après tempête&quot;, &quot;électricien mise aux normes&quot; ou &quot;maçon extension maison&quot;. Si vous n&apos;êtes pas là au bon moment, c&apos;est un concurrent qui prend l&apos;appel.
                    </p>
                    <p>
                      Mon job, c&apos;est de vous rendre visible exactement à cet instant. Je crée un site pensé pour votre métier, où les photos de vos chantiers parlent pour vous, où le numéro est visible en gros sur chaque page, et où Google comprend en deux secondes ce que vous faites et où vous le faites. Pas de blabla marketing, juste un outil qui fait le travail, où que vous soyez en France.
                    </p>
                  </div>
                </Reveal>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Simple et rapide', desc: 'Un site qui charge vite, même sur mobile, même en chantier avec du mauvais réseau.' },
                  { icon: FileSearch, title: 'Trouvable sur Google', desc: 'Des pages pensées pour vos mots-clés métier et votre zone d\'intervention.' },
                  { icon: TrendingUp, title: 'Qui fait appeler', desc: 'Bouton téléphone bien visible, formulaire de devis simple, photos de vos chantiers.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site bien construit pour un artisan, c&apos;est souvent le premier appel dans le mois qui suit la mise en ligne.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce qu&apos;un site internet peut vous apporter ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange au téléphone', description: 'Une demi-heure pour que je comprenne votre métier, vos prestations, votre zone d\'intervention et ce qui freine votre visibilité. Pas besoin d\'être un pro du web, je parle votre langue.' },
                { number: '02', title: 'Je construis votre site', description: 'Vous m\'envoyez vos photos de chantiers et vos infos. Je rédige les textes, je structure les pages, j\'optimise pour Google. Vous validez chaque étape, sans jargon.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Le site est en ligne, votre fiche Google est optimisée. Je reste joignable pour les ajustements et on suit ensemble les appels qui rentrent, partout en France.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pourquoi les artisans ont un besoin particulier de SEO local">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Un artisan ne travaille pas partout. Il a un rayon d&apos;intervention, souvent 30 ou 50 km autour de son atelier. Ses clients ne cherchent pas &quot;le meilleur plombier de France&quot;, ils cherchent &quot;plombier&quot; suivi de leur ville ou quartier. Le SEO pour artisan, c&apos;est avant tout du référencement local, et ça passe par trois leviers.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: MapPin, title: 'Fiche Google', text: 'La fiche Google Business Profile bien remplie apporte souvent plus d\'appels que le site.' },
                            { icon: User, title: 'Avis clients', text: 'Les étoiles Google rassurent avant même que le client ait lu votre site.' },
                            { icon: Target, title: 'Pages par ville', text: 'Une page par ville où vous intervenez, avec du contenu unique, pas des copier-coller.' },
                            { icon: TrendingUp, title: 'Photos de chantiers', text: 'Vos réalisations sont vos meilleurs arguments, bien plus que des textes.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Sites internet par métier d'artisan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Chaque métier a ses propres codes, ses propres mots-clés, ses propres urgences. Un site de plombier ne se construit pas comme un site de paysagiste. Voici les pages dédiées par métier, pensées pour les spécificités de chacun.
                        </p>
