...
interface DeveloppementWebQuimperContentProps {
  faqs: { question: string; answer: string }[]
}

export function DeveloppementWebQuimperContent({ faqs }: DeveloppementWebQuimperContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, développeur web à Quimper"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">des sites faits main</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Développeur freelance basé à Rennes, je conçois des sites et applications web pour des entreprises de Quimper et du pays de Cornouaille. Code propre en Next.js et React, design sur mesure, SEO intégré. Plus de 150 sites livrés.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    L&apos;artisanat du code,{' '}
                    <span className="italic text-muted-foreground/80">version XXIe siècle</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quimper est une ville d&apos;artisans. La faïence, la broderie, la gastronomie : on y apprécie le travail bien fait, le détail, la patience. C&apos;est exactement ce que j&apos;applique au développement web. Chaque site est fait main, ligne par ligne, avec des outils modernes (Next.js, React, TypeScript) qui donnent un rendu professionnel et durable.
                    </p>
                    <p>
                      J&apos;accompagne des artisans à Ergué-Gabéric, des commerces à Pluguffan, des professionnels du tourisme à Bénodet, des PME à Concarneau. Chaque projet commence par une compréhension fine de votre activité, puis une construction sur mesure qui vous ressemble.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Développement web à Quimper"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Sites web', desc: 'Vitrines artisanales et professionnelles, pensées sur mesure pour Quimper.' },
                  { icon: FileSearch, title: 'Applications', desc: 'Espaces clients, outils métier, interfaces adaptées à votre quotidien.' },
                  { icon: TrendingUp, title: 'E-commerce', desc: 'Boutiques en ligne pour créateurs, artisans et producteurs cornouaillais.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Livraison propre, documentée, avec transfert complet de propriété.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un projet web à discuter ensemble ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Trois temps,{' '}
              <span className="italic text-muted-foreground/80">pour un projet carré</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Découverte et cadrage', description: 'Je prends le temps de comprendre votre activité quimpéroise, votre public, votre univers. Je vous propose une arborescence claire, des wireframes, un planning précis et un devis détaillé.' },
                { number: '02', title: 'Développement', description: 'Je code votre site en Next.js, étape par étape. Vous avez un accès preview en ligne pour suivre l\'avancée en temps réel. Chaque grande étape est validée avant de passer à la suivante.' },
                { number: '03', title: 'Livraison et suivi', description: 'Mise en ligne, configuration du SEO technique, formation à la prise en main si besoin. Je reste disponible pour la maintenance et les évolutions à venir.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pourquoi un développement sur mesure pour Quimper">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Un site sur mesure, c&apos;est un site qui vous ressemble vraiment, qui parle votre langage et qui reflète votre savoir-faire. Les templates achetés sont vite datés, génériques, et se ressemblent tous. Avec du code écrit spécifiquement pour votre activité, vous avez un outil unique qui vous démarque durablement.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Performance', text: 'Pas de bloat, pas de code inutile, que l\'essentiel.' },
                            { icon: User, title: 'Unicité', text: 'Un design taillé pour votre activité, pas un template.' },
                            { icon: Target, title: 'SEO', text: 'Balises, structure et vitesse optimisées dès le début.' },
                            { icon: MessageCircle, title: 'Évolutif', text: 'Le site grandit avec vos besoins, sans refonte complète.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Quimper et le pays de Cornouaille">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          La Cornouaille est un territoire attachant, avec une vraie identité culturelle et des entrepreneurs passionnés. Depuis Rennes, je me déplace régulièrement sur Quimper et les communes alentour pour rencontrer mes clients.
                        </p>
                        <p>
                          J&apos;accompagne des projets à <strong>Ergué-Gabéric</strong>, <strong>Pluguffan</strong>, <strong>Fouesnant</strong>, <strong>Bénodet</strong> et <strong>Concarneau</strong>, en plus du centre de Quimper.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Freelance SEO Quimper', desc: 'Référencement naturel local', href: '/freelance-seo-quimper' },
                      { label: 'Agence SEO Quimper', desc: 'Accompagnement complet', href: '/agence-seo-quimper' },
                      { label: 'Consultant SEO Quimper', desc: 'Expert SEO dédié', href: '/consultant-seo-quimper' },
