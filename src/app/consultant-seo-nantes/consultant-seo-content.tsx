...
interface ConsultantSeoNantesContentProps {
  faqs: { question: string; answer: string }[]
}

export function ConsultantSeoNantesContent({ faqs }: ConsultantSeoNantesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Consultant SEO à Nantes - Victor Béasse"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">boostez votre présence sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO basé à Rennes et intervenant à Nantes. J&apos;accompagne les entreprises nantaises pour qu&apos;elles gagnent en visibilité sur Google : audit, stratégie de contenu, optimisation technique. Plus de 200 projets SEO menés et 75 avis 5 étoiles.
            </p>
            ...
            <div className="relative p-6 sm:p-8 lg:p-10">
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Nantes, c&apos;est le plus gros marché du Grand Ouest : startup, agences, e-commerce, professions libérales... Tout le monde veut être visible sur Google, et la concurrence SEO y est bien plus rude qu&apos;à Rennes ou Angers. Un site bien conçu ne suffit pas. Il faut une stratégie de contenu solide, une technique irréprochable et des liens qui pèsent dans la balance de l&apos;algorithme.
                    </p>
                    <p>
                      Mon approche à Nantes est directe : je regarde ce qui bloque votre site aujourd&apos;hui, ce que font les concurrents qui vous devancent, et je construis un plan pour les dépasser. Pas de tableau Excel de 200 lignes que personne ne lit &mdash; des actions concrètes, priorisées, avec un impact mesurable sur votre trafic et vos demandes de contact.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Analyse de données SEO et référencement naturel pour entreprises à Nantes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  { icon: FileSearch, title: 'Contenu', desc: 'Que vos pages répondent aux bonnes questions avec les mots-clés recherchés à Nantes.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Que des sites de qualité pointent vers le vôtre pour renforcer votre autorité.' },
                ].map((axis, i) => {
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que le SEO peut apporter à votre entreprise nantaise ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange', description: 'Nous prenons 30 minutes pour comprendre votre activité, vos objectifs et ce qui freine votre visibilité sur Google à Nantes. Je vous dis sincèrement si le SEO est pertinent pour vous.' },
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Consultant SEO vs agence à Nantes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>En agence, votre dossier circule entre plusieurs interlocuteurs. Avec un consultant SEO, vous échangez directement avec la personne qui travaille sur votre référencement. Les choses avancent plus vite et vous gardez la maîtrise de votre stratégie.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Je connais votre métier et vos enjeux.' },
                            { icon: Zap, title: 'Réactivité', text: 'Réponse dans la journée, pas dans 48h.' },
                            { icon: Target, title: 'Stratégie sur mesure', text: 'Adaptée au marché nantais.' },
                    ...
                    <ReadMore title="Pourquoi travailler avec un consultant SEO dans le Grand Ouest">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Basé à Rennes, je suis à 1h10 de Nantes en TGV. Je connais l&apos;écosystème nantais : les startups de l&apos;Île de Nantes, le quartier de la création, les entreprises du numérique qui font de Nantes l&apos;une des métropoles les plus dynamiques du Grand Ouest.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Nantes et dans toute la Loire-Atlantique : <strong>Saint-Herblain</strong>, <strong>Rezé</strong>, <strong>Orvault</strong>, <strong>Carquefou</strong>, <strong>Saint-Nazaire</strong>, <strong>La Baule</strong>. Et aussi à <strong>Rennes</strong> et <strong>Vannes</strong>.
                        </p>
