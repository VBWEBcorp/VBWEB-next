...
interface AgenceDeveloppementWebRennesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebRennesContent({ faqs }: AgenceDeveloppementWebRennesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Rennes - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Rennes,{' '}
              <span className="italic text-muted-foreground/80">ou expert direct qui code votre site</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Rennes ? Voici une alternative directe avec un expert dédié. Je suis Victor Béasse, développeur web et consultant SEO basé à Rennes. Plus de 150 sites livrés et 75 avis 5 étoiles. Vous parlez à la personne qui code votre projet, de la première ligne à la mise en ligne.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Tout ce qu&apos;une agence vous vend,{' '}
                    <span className="italic text-muted-foreground/80">directement avec l&apos;expert</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand vous signez avec une agence web à Rennes, vous payez une équipe : un commercial qui vend, un chef de projet qui coordonne, un designer, un développeur, parfois un chef de studio. Chacun prend sa marge, et votre brief passe de main en main.
                    </p>
                    <p>
                      Avec moi, c&apos;est différent. Vous parlez directement au développeur. Je prends le cahier des charges, je dessine les maquettes, je code le site et je m&apos;occupe du SEO. Un seul interlocuteur du début à la fin, ce qui veut dire moins de malentendus et des décisions prises en quelques minutes.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Expert développement web à Rennes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Conception', desc: 'Architecture du site, maquettes, expérience utilisateur pensée pour convertir.' },
                  { icon: FileSearch, title: 'Développement', desc: 'Code propre, performant, sécurisé, prêt à évoluer avec votre activité.' },
                  { icon: TrendingUp, title: 'SEO technique', desc: 'Optimisation Google intégrée dès la conception, pas ajoutée après coup.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site vitrine professionnel est livré en 4 à 8 semaines, un e-commerce en 2 à 4 mois.
              </p>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
              Projets web livrés en Bretagne
            </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez un site qui tient la route à Rennes ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">voilà le déroulé</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On cadre le projet', description: 'Une visio ou un café à Rennes pour comprendre votre métier, vos objectifs et vos contraintes. Je vous dis franchement si le projet est réaliste et comment je le vois.' },
                { number: '02', title: 'Maquettes et code', description: 'Je conçois les maquettes, vous les validez, puis je développe. Vous voyez le site avancer en temps réel sur un lien de préproduction. Pas de surprise au bout de deux mois.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Je publie le site, je configure Google Analytics et je vous forme à l\'administration. Le site vous appartient, vous restez libre, je reste disponible pour la suite.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les agences web ont leur utilité. Sur les très gros projets nécessitant plusieurs équipes en parallèle, une structure d&apos;agence est pertinente. Pour un site vitrine, un e-commerce ou une application métier de taille PME, travailler directement avec l&apos;expert est souvent plus efficace.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Vous parlez au développeur, pas à un intermédiaire.' },
                            { icon: Zap, title: 'Décisions rapides', text: 'Validation en heures, pas en semaines.' },
                            { icon: Target, title: 'Budget maîtrisé', text: 'Pas de marge empilée entre plusieurs postes.' },
                            { icon: MessageCircle, title: 'Cohérence', text: 'Un seul regard sur le projet du début à la fin.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Pourquoi un expert direct à Rennes fait la différence">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je connais le marché rennais, les habitudes d&apos;achat locales et les entreprises qui performent sur Google. Cette connaissance du terrain se retrouve dans chaque site que je livre : contenu adapté aux Rennais, SEO local pensé dès la conception, exemples concrets issus de la métropole.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises dans Rennes et sa métropole : <strong>Cesson-Sévigné</strong>, <strong>Saint-Grégoire</strong>, <strong>Bruz</strong>, <strong>Chantepie</strong>, <strong>Pacé</strong>. La proximité facilite les rendez-vous physiques quand ils sont utiles, sans être une obligation.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Rennes', 'Cesson-Sévigné', 'Saint-Grégoire', 'Bruz', 'Chantepie', 'Pacé'].map((city) => (
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Création de site internet', desc: 'Sites vitrines et e-commerce', href: '/creation-site-internet-rennes' },
                      { label: 'Référencement SEO', desc: 'Stratégie Google complète', href: '/referencement-seo-rennes' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Rennes', href: '/freelance-seo-rennes' },
