...
interface SiteInternetCarreleurContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetCarreleurContent({ faqs }: SiteInternetCarreleurContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour carreleur"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pour faire parler vos poses</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites internet pour carreleurs partout en France. Salle de bain, sol cuisine, terrasse extérieure, faïence, mosaïque, rénovation complète : votre site met en avant vos poses, rassure sur la qualité, et transforme les recherches Google en devis concrets.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site internet carreleur{' '}
                    <span className="italic text-muted-foreground/80">qui vend avec vos photos</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le carrelage, c&apos;est un métier de précision qui se juge à l&apos;œil. Un joint bien tiré, un calepinage bien pensé, une coupe nette sur un angle : ce sont ces détails qui font la différence entre un pro et un bricoleur du dimanche. Votre site a un rôle clair : rendre ces détails visibles avant même que le client prenne son téléphone.
                    </p>
                    <p>
                      Quand quelqu&apos;un veut refaire sa salle de bain, il tape des requêtes très concrètes sur Google : &quot;carreleur près de chez moi&quot;, &quot;rénovation salle de bain&quot;, &quot;pose carrelage prix m2&quot;, &quot;carreleur terrasse&quot;. Si votre site n&apos;apparaît pas sur ces recherches, vous laissez tout ce volume à ceux qui ont pris leur visibilité au sérieux.
                    </p>
                    <p>
                      Votre site doit fonctionner comme un book d&apos;artisan. Chaque chantier publié devient une preuve qui vous représente 24h/24, même quand vous êtes en plein chantier avec les genoux dans le mortier.
                    </p>
                  </div>
                </Reveal>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Galerie par pièce', desc: 'Salle de bain, cuisine, terrasse, faïence, mosaïque : une galerie structurée par type de pose.' },
                  { icon: FileSearch, title: 'Pages rénovation', desc: 'Une page dédiée à la rénovation salle de bain, là où se jouent les plus gros chantiers.' },
                  { icon: TrendingUp, title: 'SEO local actif', desc: 'Pour apparaître dans le pack Google Maps dès qu\'un client cherche un carreleur dans votre zone.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                J&apos;accompagne des carreleurs partout en France, du poseur indépendant aux petites entreprises de 4 à 5 salariés.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie d&apos;un site qui transforme vos photos de poses en devis qualifiés ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On se cale une visio', description: 'On prend 30 minutes pour comprendre votre activité : salle de bain, sol, terrasse, rénovation complète. Je regarde vos photos de poses et on définit ensemble le positionnement du site en fonction des chantiers que vous voulez décrocher.' },
                { number: '02', title: 'Je construis votre site', description: 'Je conçois la structure autour de vos prestations principales. Chaque type de pose a sa galerie dédiée, chaque page est optimisée sur les bons mots-clés Google, et le formulaire de devis est pensé pour convertir sans faire fuir.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Le site est livré, indexé par Google, relié à votre fiche Google Business Profile. Chaque mois, vous voyez les visites, vos positions et les demandes de devis reçues dans un tableau de bord simple à lire.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Comment décrocher plus de chantiers de rénovation salle de bain">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>La rénovation de salle de bain représente le plus gros gisement de chantiers pour un carreleur. Le client type est un propriétaire entre 35 et 60 ans qui en a marre de sa vieille salle de bain et veut quelque chose de contemporain. Il va chercher pendant plusieurs semaines avant de demander un devis.</p>
                        <p>Sur le site, on met en place une page dédiée avec des <strong>photos avant/après</strong> de rénovations complètes, une explication claire du déroulement, et un formulaire simple. Les mots-clés visés sont précis : <strong>rénovation salle de bain</strong>, <strong>douche à l&apos;italienne</strong>, <strong>carrelage grand format</strong>, <strong>pose carrelage imitation parquet</strong>.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Client qualifié', text: 'Propriétaire avec un vrai budget de rénovation.' },
                            { icon: Zap, title: 'Décision longue', text: 'Le site travaille pendant ses semaines de recherche.' },
                            { icon: Target, title: 'Chantier plus gros', text: 'Une rénovation complète vaut 5 petits chantiers.' },
                            { icon: MessageCircle, title: 'Moins de négociation', text: 'Un client bien préparé discute moins le prix.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Un site internet carreleur, et pour les autres artisans">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          J&apos;accompagne les carreleurs partout en France, mais aussi les autres artisans du bâtiment et de l&apos;aménagement. Si votre activité est mixte (carrelage et plomberie, par exemple), on construit le site autour de votre métier principal et on ajoute une page secondaire.
                        </p>
                        <p>
                          Je crée également des sites pour <Link href="/site-internet-plombier" className="text-primary underline-offset-2 hover:underline">plombiers</Link>, <Link href="/site-internet-couvreur" className="text-primary underline-offset-2 hover:underline">couvreurs</Link>, <Link href="/site-internet-peintre" className="text-primary underline-offset-2 hover:underline">peintres</Link>, <Link href="/site-internet-paysagiste" className="text-primary underline-offset-2 hover:underline">paysagistes</Link> et <Link href="/site-internet-menuisier" className="text-primary underline-offset-2 hover:underline">menuisiers</Link>. Retrouvez toutes les offres sur la page <Link href="/site-internet-artisan" className="text-primary underline-offset-2 hover:underline">site internet artisan</Link>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Partout en France', 'Salle de bain', 'Sol cuisine', 'Terrasse', 'Faïence', 'Mosaïque', 'Rénovation'].map((tag) => (
