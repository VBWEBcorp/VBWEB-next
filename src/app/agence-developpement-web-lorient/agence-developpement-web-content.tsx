...
interface AgenceDeveloppementWebLorientContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebLorientContent({ faqs }: AgenceDeveloppementWebLorientContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Lorient - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Lorient,{' '}
              <span className="italic text-muted-foreground/80">ou un développeur qui vous parle vraiment</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Lorient ? Voici une alternative directe avec un expert dédié. Développeur web et consultant SEO, j&apos;ai livré plus de 150 sites et accompagné 200 entreprises sur leur visibilité Google. Un interlocuteur unique pour votre projet, de l&apos;idée initiale à la mise en ligne.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
                    Tout le travail d&apos;agence, par une seule main
                  </p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Exactement le même livrable,{' '}
                    <span className="italic text-muted-foreground/80">en passant par moins d&apos;étapes</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Dans une agence web classique, votre projet voyage entre plusieurs postes : commercial, chef de projet, designer, développeur, chef de studio. C&apos;est un peu comme une course au large avec plusieurs ports d&apos;escale. Chaque étape est nécessaire dans le modèle agence, mais elle allonge forcément le trajet.
                    </p>
                    <p>
                      Quand vous passez par moi, la course est en ligne droite. Je couvre la conception, le design, le code et le SEO. Votre brief est traité une seule fois, par la personne qui va réellement construire le site. Résultat : moins de flou, moins d&apos;attente, un résultat plus cohérent.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Expert développement web à Lorient"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Cadrage projet', desc: 'Un brief clair, des objectifs mesurables, un périmètre bien défini.' },
                  { icon: FileSearch, title: 'Développement', desc: 'Un code solide, sécurisé, conforme aux standards web actuels.' },
                  { icon: TrendingUp, title: 'SEO natif', desc: 'Un site pensé pour Google, qui se positionne rapidement.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Les projets sont livrés en 4 à 8 semaines pour un site vitrine, 2 à 4 mois pour un e-commerce.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Votre projet web mérite mieux qu&apos;un modèle standard ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Trois étapes,{' '}
              <span className="italic text-muted-foreground/80">sans mauvaise surprise</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On se rencontre', description: 'Un premier échange pour que je comprenne votre métier et vos enjeux. Je vous dis clairement si je peux vous aider et comment, ou si je dois vous orienter ailleurs.' },
                { number: '02', title: 'On construit le site', description: 'Maquettes, validation, puis développement. Vous avez accès à un lien de préproduction pour suivre l\'avancée et faire vos retours au fil de l\'eau.' },
                { number: '03', title: 'Mise en ligne et passation', description: 'Le site est publié, l\'analytique configurée, la formation à l\'administration effectuée. Vous repartez avec un site qui fonctionne et que vous maîtrisez.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les deux formules ont leurs arguments. L&apos;agence apporte une équipe et une structure rassurante. L&apos;expert indépendant apporte une relation directe et un coût plus léger. Dans la majorité des projets web qu&apos;on me confie à Lorient, la formule indépendante est celle qui convient le mieux aux PME et aux commerces.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Qualité constante', text: 'Toujours la même personne sur votre projet.' },
                            { icon: Zap, title: 'Disponible', text: 'Joignable rapidement quand c\'est urgent.' },
                            { icon: Target, title: 'Focus', text: 'Votre projet compte, pas un ticket dans une file.' },
                            { icon: MessageCircle, title: 'Langage clair', text: 'Explications sans jargon technique inutile.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Travailler avec un expert direct dans le bassin lorientais">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Lorient est une ville au tissu économique dynamique : pêche, agroalimentaire, nautisme, commerce, services. Chaque secteur a ses spécificités et ses logiques de clientèle. En travaillant directement avec moi, vous bénéficiez d&apos;une compréhension rapide de votre contexte, sans passer par des interlocuteurs qui découvrent votre métier.
                        </p>
                        <p>
                          Je travaille pour des clients à <strong>Lanester</strong>, <strong>Hennebont</strong>, <strong>Ploemeur</strong>, <strong>Larmor-Plage</strong> et <strong>Quéven</strong>, en plus de Lorient centre.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Agence SEO', desc: 'Référencement naturel à Lorient', href: '/agence-seo-lorient' },
                      { label: 'Référencement naturel', desc: 'Stratégie Google complète', href: '/referencement-naturel-lorient' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Lorient', href: '/freelance-seo-lorient' },
