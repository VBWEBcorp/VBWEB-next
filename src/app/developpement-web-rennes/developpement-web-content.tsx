...
interface DeveloppementWebRennesContentProps {
  faqs: { question: string; answer: string }[]
}

export function DeveloppementWebRennesContent({ faqs }: DeveloppementWebRennesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, développeur web à Rennes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">des sites modernes qui rankent</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je code des sites et des applications web avec Next.js, React et TypeScript. Objectif : des pages qui se chargent en moins d&apos;une seconde, un design soigné et un code propre qui plaît à Google. Plus de 150 sites livrés depuis Rennes.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Je code vos sites{' '}
                    <span className="italic text-muted-foreground/80">avec les outils d&apos;aujourd&apos;hui</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      La plupart des sites de PME rennaises tournent encore sous WordPress avec 15 plugins qui ralentissent tout. Moi, je fais différemment : je développe en Next.js et React, les mêmes outils que Netflix, TikTok ou Notion. Résultat, un site qui se charge instantanément, qui tient la route sur mobile et qui plaît à Google.
                    </p>
                    <p>
                      Concrètement, j&apos;accompagne des restaurants à Cesson-Sévigné, des artisans à Bruz, des cabinets à Saint-Grégoire, et des PME dans toute la métropole rennaise. Sites vitrines, e-commerce, espaces clients, outils métier : chaque projet est pensé pour performer en termes de design, de vitesse et de SEO.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Développement web à Rennes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Sites web', desc: 'Vitrines rapides en Next.js, optimisés SEO dès la première ligne de code.' },
                  { icon: FileSearch, title: 'Applications', desc: 'Espaces clients, tableaux de bord, outils métier sur mesure.' },
                  { icon: TrendingUp, title: 'E-commerce', desc: 'Boutiques en ligne performantes avec Stripe, Shopify ou headless.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Chaque site est livré propre, documenté, et vous restez propriétaire du code.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un projet de site ou d&apos;application en tête ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">voici le chemin</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage du projet', description: 'On définit ensemble vos objectifs, vos contraintes, votre charte graphique. Je vous propose une arborescence, un wireframe et un devis détaillé. Rien n\'est codé avant qu\'on soit aligné.' },
                { number: '02', title: 'Développement', description: 'Je développe votre site en Next.js, étape par étape. Vous avez accès à une preview en ligne que vous pouvez consulter à tout moment. Les retours sont intégrés au fil de l\'eau, pas en fin de projet.' },
                { number: '03', title: 'Livraison et maintenance', description: 'Mise en ligne, configuration du nom de domaine, tests de performance, référencement Google. Je reste disponible pour la maintenance, les mises à jour et l\'évolution du site.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Next.js vs WordPress : pourquoi ça change tout">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>WordPress, c&apos;est pratique, mais c&apos;est lourd. Un site WordPress moyen charge en 4 à 6 secondes avec les plugins empilés au fil du temps. Un site Next.js bien codé charge en moins d&apos;une seconde. Pour Google, c&apos;est un critère de classement direct.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Performance', text: 'Scores Lighthouse 95+ sur mobile et desktop.' },
                            { icon: User, title: 'Code propre', text: 'Pas de plugins bancals, que du code écrit sur mesure.' },
                            { icon: Target, title: 'SEO natif', text: 'Balises, structure, vitesse : tout est optimisé.' },
                            { icon: MessageCircle, title: 'Évolutivité', text: 'Le site grandit avec votre entreprise sans se casser.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Développement web à Rennes et sa métropole">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je suis basé à Rennes et je développe des sites pour des PME dans toute la métropole. Être à côté de mes clients, ça compte : on peut se voir autour d&apos;un café, faire un point dans leurs locaux, échanger sur l&apos;avancée du projet en direct.
                        </p>
                        <p>
                          J&apos;interviens à <strong>Cesson-Sévigné</strong>, <strong>Saint-Grégoire</strong>, <strong>Bruz</strong>, <strong>Chantepie</strong> et <strong>Pacé</strong>, mais aussi à <strong>Saint-Malo</strong>, <strong>Vannes</strong> et <strong>Brest</strong> pour les projets plus lointains.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Création de site', desc: 'Sites vitrines optimisés SEO', href: '/creation-site-internet-rennes' },
                      { label: 'Freelance SEO', desc: 'Référencement naturel sur Google', href: '/freelance-seo-rennes' },
