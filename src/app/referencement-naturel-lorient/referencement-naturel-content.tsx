...
interface ReferencementNaturelLorientContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelLorientContent({ faqs }: ReferencementNaturelLorientContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Lorient"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Lorient,{' '}
              <span className="italic text-muted-foreground/80">rendez votre entreprise visible sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vos concurrents apparaissent sur Google et pas vous ? Le référencement naturel est la solution pour inverser la tendance. J&apos;accompagne les entreprises lorientaises vers les premières positions. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">au bon moment</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement naturel, c&apos;est ce qui détermine si votre site apparaît quand un Lorientais tape &quot;serrurier Lorient&quot; ou &quot;restaurant Larmor-Plage&quot; sur Google. Sans travail de fond, votre site reste invisible. Avec les bonnes optimisations, il remonte et capte des clients qui ont un besoin concret.
                    </p>
                    <p>
                      Ce n&apos;est pas de la publicité : le référencement naturel vous positionne dans les résultats organiques de Google, ceux où les internautes cliquent le plus. Et une fois en place, ça continue de fonctionner sans payer au clic.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Référencement naturel à Lorient"
                      loading="lazy"
                      width={800}
                      height={600}
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir où en est votre site sur Google à Lorient ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier échange', description: 'On prend 30 minutes pour faire le point sur votre activité à Lorient, vos objectifs commerciaux et votre présence actuelle sur Google. Je vous dis franchement si le référencement naturel peut vous aider.' },
                { number: '02', title: 'Audit et plan d\'action', description: 'J\'analyse votre site, vos positions, vos mots-clés et la concurrence dans le bassin lorientais. Vous recevez un plan d\'action concret avec les priorités et le planning.' },
                { number: '03', title: 'Progression continue', description: 'Les optimisations sont mises en place chaque mois. Vous suivez vos positions Google, l\'évolution de votre trafic et les demandes reçues dans votre espace de suivi dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Le référencement naturel pour les entreprises maritimes et portuaires">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Lorient a une identité forte liée à la mer : chantiers navals, pêche, nautisme, activités portuaires. Ces secteurs ont des recherches spécifiques sur Google que vos concurrents ne travaillent pas toujours. Le référencement naturel vous permet de capter cette demande niche et de vous positionner comme la référence locale dans votre domaine.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Vous échangez avec moi, pas avec un intermédiaire.' },
                            { icon: Zap, title: 'Mots-clés de niche', text: 'Ciblage sur les recherches propres à votre secteur.' },
                            { icon: Target, title: 'Stratégie locale', text: 'Optimisation pour Lorient et le pays lorientais.' },
                            { icon: MessageCircle, title: 'Rapport mensuel', text: 'Positions, trafic, contacts : tout est suivi.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Référencement naturel dans le bassin lorientais">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le bassin de Lorient regroupe plusieurs communes avec des dynamiques économiques propres. Que vos clients soient à Lanester, Hennebont ou Larmor-Plage, le référencement naturel vous rend visible sur les recherches qui comptent pour votre zone de chalandise.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à <strong>Lanester</strong>, <strong>Hennebont</strong>, <strong>Ploemeur</strong>, <strong>Larmor-Plage</strong>, <strong>Quéven</strong>. Je travaille aussi avec des clients à <strong>Vannes</strong>, <strong>Quimper</strong> et <strong>Rennes</strong>.
                        </p>
