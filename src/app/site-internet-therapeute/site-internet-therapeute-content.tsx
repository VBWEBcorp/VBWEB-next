...
interface SiteInternetTherapeuteContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetTherapeuteContent({ faqs }: SiteInternetTherapeuteContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour thérapeute"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Site internet thérapeute,{' '}
              <span className="italic text-muted-foreground/80">pour présenter votre pratique avec justesse</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO et créateur de sites internet. Je crée des sites pour les thérapeutes partout en France : un site clair, humain, bien référencé sur Google, avec prise de rendez-vous en ligne. Plus de 150 sites créés et 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">et qui inspire confiance</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand quelqu&apos;un cherche un thérapeute, il est souvent dans un moment fragile. Ce qu&apos;il veut d&apos;abord, c&apos;est se sentir en sécurité. Votre site doit donc transmettre ce que vous êtes en vrai : votre écoute, votre parcours, votre cadre. Je prends le temps de vous connaître avant de poser la première ligne de code, pour que votre site soit l&apos;extension honnête de votre pratique.
                    </p>
                    <p>
                      Je construis aussi votre visibilité sur Google pour que les personnes qui cherchent un thérapeute dans leur ville vous trouvent, sans passer uniquement par les plateformes. Et je respecte votre cadre déontologique : pas de promesse, pas d&apos;exagération, juste une présentation juste et professionnelle.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Création site internet pour thérapeute"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: User, title: 'Présentation humaine', desc: 'Votre parcours, votre méthode et votre cadre, racontés avec justesse.' },
                  { icon: Zap, title: 'Prise de RDV en ligne', desc: 'Intégration Doctolib, Crénolibre ou Calendly, directement depuis votre site.' },
                  { icon: FileSearch, title: 'Trouvé sur Google', desc: 'Référencement local pour être visible dans votre ville et votre région.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Votre site est livré entre 3 et 6 semaines, avec une formation pour que vous puissiez le faire vivre vous-même.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez un site thérapeute qui vous ressemble ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Si on crée votre site ensemble,{' '}
              <span className="italic text-muted-foreground/80">voilà les étapes</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On apprend à se connaître', description: 'On prend le temps d\'échanger sur votre pratique, votre approche et les personnes que vous accompagnez. C\'est la base pour construire un site qui sonne juste.' },
                { number: '02', title: 'Je construis votre site', description: 'Maquette, rédaction, intégration de votre agenda de prise de rendez-vous, référencement Google. Vous validez à chaque étape, sans jargon inutile.' },
                { number: '03', title: 'Mise en ligne et autonomie', description: 'Je vous forme à l\'interface pour que vous puissiez modifier vos textes, vos horaires et publier des articles vous-même. Je reste disponible pour toute question.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Sites internet par profession de santé">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Chaque profession a ses codes, ses contraintes et ses attentes spécifiques. J&apos;ai créé des pages dédiées pour les professions que j&apos;accompagne le plus, avec des exemples et des conseils adaptés.
                        </p>
                        ...
                        <p>
                          Si votre profession n&apos;est pas listée, pas d&apos;inquiétude : j&apos;accompagne tous les praticiens du bien-être et de la santé partout en France. On en discute lors d&apos;un premier échange.
                        </p>
                      </div>
                    </ReadMore>

                    <ReadMore title="RGPD santé, déontologie : ce qu'il faut savoir">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Créer un site thérapeute, ce n&apos;est pas créer un site comme un autre. Les données de santé sont considérées comme sensibles par le RGPD, et chaque profession réglementée a son code de déontologie à respecter. Je le prends au sérieux.
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'RGPD santé', text: 'Mentions légales, consentement, hébergement adapté.' },
                            { icon: Target, title: 'Déontologie', text: 'Pas de promesse de résultat, ton juste et mesuré.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Vous validez chaque mot avant la mise en ligne.' },
                            { icon: Zap, title: 'Sécurité', text: 'Formulaires chiffrés, sauvegardes automatiques.' },
                          ].map((item) => {
