...
interface AgenceSeoSaintMaloContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoSaintMaloContent({ faqs }: AgenceSeoSaintMaloContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Saint-Malo - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence SEO à Saint-Malo :{' '}
              <span className="italic text-muted-foreground/80">optez pour un expert qui connait la Côte d&apos;Émeraude</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous recherchez une agence SEO à Saint-Malo pour attirer plus de visiteurs sur votre site. Je suis Victor Béasse, expert SEO en Bretagne. Je vous accompagne en direct pour que votre entreprise soit visible sur Google, en saison comme hors saison. Plus de 200 projets, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Le SEO au service{' '}
                    <span className="italic text-muted-foreground/80">du tourisme et du commerce malouin</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Saint-Malo accueille 3 millions de visiteurs par an. Ces touristes planifient tout sur Google : &quot;restaurant intra-muros Saint-Malo&quot;, &quot;hôtel vue mer Saint-Malo&quot;, &quot;activité Côte d&apos;Émeraude&quot;. Si votre établissement n&apos;apparait pas dans les résultats, vous passez à côté d&apos;une clientèle qui est déjà prête à réserver.
                    </p>
                    <p>
                      Que votre activité soit saisonnière ou permanente, le SEO vous permet de capter cette demande au bon moment. Je construis votre stratégie en anticipant les pics de recherche, pour que votre site soit prêt quand la saison démarre.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez préparer votre visibilité Google avant la prochaine saison ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier contact', description: '30 minutes pour comprendre votre activité à Saint-Malo, votre saisonnalité et vos ambitions de croissance. Je vous donne mon avis franc sur le potentiel SEO de votre marché.' },
                { number: '02', title: 'Audit et stratégie', description: 'Analyse technique, étude de contenu et cartographie de la concurrence sur la Côte d\'Émeraude. Vous recevez un plan d\'action avec un calendrier qui tient compte de votre saisonnalité.' },
                { number: '03', title: 'Déploiement progressif', description: 'Les optimisations sont mises en place mois après mois. Vous suivez vos positions, votre trafic et vos réservations dans un espace dédié. On ajuste la stratégie à chaque point mensuel.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Un expert dédié plutôt qu'une agence SEO à Saint-Malo">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Le marché malouin est particulier : forte saisonnalité, concurrence touristique, clientèle mixte entre locaux et visiteurs. Ce contexte demande de la réactivité et une compréhension fine des cycles de recherche. Un expert dédié peut ajuster votre stratégie SEO en temps réel, sans les délais d&apos;une structure plus lourde.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Votre dossier n\'est pas délégué.' },
                            { icon: Zap, title: 'Agilité', text: 'Ajustements rapides selon la saison.' },
                            { icon: Target, title: 'Expertise locale', text: 'Connaissance du marché touristique breton.' },
                            { icon: MessageCircle, title: 'Communication claire', text: 'Point mensuel, rapport accessible.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le SEO sur la Côte d'Émeraude et au-delà">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Saint-Malo est un pôle d&apos;attraction qui rayonne bien au-delà des remparts. La Côte d&apos;Émeraude, le pays de Rance et la baie du Mont-Saint-Michel génèrent des volumes de recherche considérables. Positionner votre site sur ces requêtes, c&apos;est toucher une audience large qui cherche activement ce que vous proposez.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Saint-Malo et dans toute la région : <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong>, <strong>Saint-Lunaire</strong>. Votre zone de chalandise est couverte intégralement.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Saint-Malo', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-saint-malo' },
                      { label: 'Freelance SEO Saint-Malo', desc: 'Expert indépendant à votre service', href: '/freelance-seo-saint-malo' },
                      { label: 'Audit SEO gratuit', desc: 'Analyse complète de votre visibilité', href: '/audit-seo-gratuit' },
