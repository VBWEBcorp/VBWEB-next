...
interface AgenceDeveloppementWebVannesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebVannesContent({ faqs }: AgenceDeveloppementWebVannesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Vannes - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Vannes,{' '}
              <span className="italic text-muted-foreground/80">ou l&apos;expert qui code votre site</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Vannes ? Voici une alternative directe avec un expert dédié. Je suis Victor Béasse, développeur web indépendant basé à Rennes, et j&apos;accompagne régulièrement des entreprises du Morbihan. Plus de 150 sites livrés, un seul interlocuteur sur votre projet du début à la fin.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">sans les intermédiaires</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      À Vannes comme ailleurs, une agence web c&apos;est une équipe. Vous rencontrez un commercial, qui passe le brief à un chef de projet, qui coordonne un designer et un développeur. Le parcours ressemble un peu au Golfe du Morbihan : beau à regarder, mais il faut contourner plusieurs îles pour aller d&apos;un point à l&apos;autre.
                    </p>
                    <p>
                      Avec moi, le trajet est direct. Vous expliquez votre projet une fois, à la bonne personne, et je prends en charge tout le reste : conception, design, code, SEO, mise en ligne. Un seul cerveau sur le sujet, une vision cohérente, des délais plus courts.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Expert développement web à Vannes"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Design', desc: 'Des maquettes propres, pensées pour votre clientèle et pour convertir.' },
                  { icon: FileSearch, title: 'Code', desc: 'Un site rapide, sécurisé, maintenable sur la durée.' },
                  { icon: TrendingUp, title: 'Visibilité', desc: 'Un SEO technique intégré pour que Google vous trouve dès la mise en ligne.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un projet cadré clairement est livré en 4 à 8 semaines pour un site vitrine, 2 à 4 mois pour un e-commerce.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un projet web qui attend de décoller à Vannes ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Discussion et cadrage', description: 'Un appel de 30 minutes pour comprendre ce que vous voulez vraiment. Je pose les bonnes questions et je vous remets une proposition claire avec budget et délai.' },
                { number: '02', title: 'Maquettes et réalisation', description: 'Je conçois les maquettes, vous validez, puis je développe. Un lien de préproduction vous permet de voir le site grandir en temps réel.' },
                { number: '03', title: 'Lancement et accompagnement', description: 'Le site part en ligne, je configure l\'analytique et je vous forme à l\'administration. Vous restez autonome, je reste joignable.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Chaque modèle a sa place. Les agences sont pertinentes sur les gros projets qui demandent plusieurs métiers en parallèle et une coordination lourde. Pour la grande majorité des entreprises vannetaises, un expert indépendant livre un résultat équivalent avec plus de souplesse et un coût maîtrisé.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Contact direct', text: 'Pas d\'intermédiaire entre vous et le code.' },
                            { icon: Zap, title: 'Souplesse', text: 'Les ajustements se font à la volée.' },
                            { icon: Target, title: 'Précision', text: 'Un cahier des charges interprété une seule fois.' },
                            { icon: MessageCircle, title: 'Clarté', text: 'Vous savez toujours où en est le projet.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Pourquoi un expert dédié marche bien dans le Morbihan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le tissu économique vannetais est fait d&apos;entreprises familiales, d&apos;artisans, de commerces saisonniers et de professions libérales. Ce sont précisément les structures pour lesquelles un accompagnement direct est le plus efficace : budget contenu, exigences claires, décisions rapides.
                        </p>
                        <p>
                          J&apos;interviens à Vannes et dans sa couronne : <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong>, <strong>Auray</strong>. Le Golfe du Morbihan a ses propres codes et je les comprends bien.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Vannes', 'Arradon', 'Séné', 'Theix-Noyalo', 'Sarzeau', 'Auray'].map((city) => (
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Création de site internet', desc: 'Sites vitrines et e-commerce', href: '/creation-site-internet-vannes' },
                      { label: 'Référencement naturel', desc: 'Stratégie Google complète', href: '/referencement-naturel-vannes' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Vannes', href: '/freelance-seo-vannes' },
