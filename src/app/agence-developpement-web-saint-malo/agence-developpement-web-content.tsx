...
interface AgenceDeveloppementWebSaintMaloContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebSaintMaloContent({ faqs }: AgenceDeveloppementWebSaintMaloContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Saint-Malo - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Saint-Malo,{' '}
              <span className="italic text-muted-foreground/80">ou la relation directe avec l&apos;expert</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Saint-Malo ? Voici une alternative directe avec un expert dédié. Je suis Victor Béasse, développeur web et consultant SEO. J&apos;accompagne les entreprises du pays malouin depuis Rennes, à 1h de route. Un interlocuteur unique, plus de 150 sites livrés et une vraie connaissance du secteur touristique.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
                    Un site à votre image, sans filtre
                  </p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Votre vision,{' '}
                    <span className="italic text-muted-foreground/80">directement traduite en code</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand une agence prend votre projet en charge, votre idée d&apos;origine passe par plusieurs filtres avant d&apos;arriver jusqu&apos;au développeur. C&apos;est un peu comme une marée qui traverse plusieurs bassins avant d&apos;atteindre le port : à chaque étape, un peu de la force initiale se dissipe.
                    </p>
                    <p>
                      Moi, je suis le point d&apos;arrivée et le point de départ en même temps. Vous m&apos;expliquez votre projet, et c&apos;est moi qui le réalise. Pas de perte d&apos;information, pas de réinterprétation. Ce que vous imaginiez au départ, c&apos;est ce qui finit à l&apos;écran.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Expert développement web à Saint-Malo"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Design adapté', desc: 'Un visuel qui correspond à votre identité et à votre clientèle.' },
                  { icon: FileSearch, title: 'Code fiable', desc: 'Une base technique solide, pensée pour durer des années.' },
                  { icon: TrendingUp, title: 'SEO local et touristique', desc: 'Une visibilité Google pensée pour attirer les visiteurs.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site vitrine est livré en 4 à 8 semaines, un projet plus complexe en 2 à 4 mois.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un site à hauteur de votre activité malouine ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un chemin balisé{' '}
              <span className="italic text-muted-foreground/80">du début à la fin</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Rencontre et cadrage', description: 'Une première discussion, sur Saint-Malo ou en visio, pour comprendre votre activité et définir précisément le périmètre du projet avec un budget clair.' },
                { number: '02', title: 'Maquettes et développement', description: 'Je conçois les maquettes, vous les validez, puis je développe. Vous suivez l\'avancée sur un lien de test et vous pouvez faire remonter vos retours à tout moment.' },
                { number: '03', title: 'Livraison et autonomie', description: 'Mise en ligne, configuration des outils, formation à l\'administration. Vous repartez avec un site fonctionnel, optimisé SEO et totalement entre vos mains.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Pour un très gros projet qui mobilise plusieurs métiers en parallèle sur une longue durée, une agence peut être le bon choix. Pour un projet web à la mesure d&apos;une PME, d&apos;un hôtel, d&apos;un restaurant ou d&apos;une boutique malouine, passer directement par l&apos;expert offre une relation plus humaine et un résultat plus fin.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Écoute directe', text: 'Vos idées ne passent par aucun filtre.' },
                            { icon: Zap, title: 'Ajustements rapides', text: 'Un détail à changer ? C\'est fait dans la journée.' },
                            { icon: Target, title: 'Identité forte', text: 'Un site vraiment à votre image.' },
                            { icon: MessageCircle, title: 'Suivi personnel', text: 'On se connaît, on avance ensemble.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Un expert qui comprend le pays malouin">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Saint-Malo et sa région ont une économie très orientée tourisme, avec une saisonnalité marquée et une clientèle internationale. Je connais ces particularités : sites multilingues, intégration de systèmes de réservation, SEO sur des requêtes touristiques. Ce sont des sujets que j&apos;ai déjà traités et qui demandent un regard spécifique.
                        </p>
                        <p>
                          J&apos;interviens dans toute la Côte d&apos;Émeraude : <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong>, <strong>Saint-Lunaire</strong>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Saint-Malo', 'Dinard', 'Dinan', 'Cancale', 'Dol-de-Bretagne', 'Saint-Lunaire'].map((city) => (
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Agence SEO', desc: 'Référencement naturel à Saint-Malo', href: '/agence-seo-saint-malo' },
                      { label: 'Référencement naturel', desc: 'Stratégie Google complète', href: '/referencement-naturel-saint-malo' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Saint-Malo', href: '/freelance-seo-saint-malo' },
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl">
              Développement web à Saint-Malo :{' '}
