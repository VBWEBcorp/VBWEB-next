...
export function CreationSiteInternetVannesContent({ faqs }: CreationSiteInternetContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet à Vannes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">un site qui vous ramène des clients du Morbihan</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je conçois des sites web à Vannes qui ne se contentent pas d&apos;être jolis. Ils sont rapides, lisibles par Google et pensés pour convertir vos visiteurs en vrais clients. Plus de 150 sites livrés et 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
                    Mon approche de la création web
                  </p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site vitrine,{' '}
                    <span className="italic text-muted-foreground/80">ça ne suffit plus à Vannes</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      À Vannes, la concurrence en ligne est réelle. Avoir un site qui ressemble à une carte de visite numérique, c&apos;est passer à côté de l&apos;essentiel. Ce que je fais, c&apos;est créer des sites qui sortent sur Google quand un habitant du Morbihan tape &quot;plombier Vannes&quot; ou &quot;coiffeur centre-ville Vannes&quot;.
                    </p>
                    <p>
                      Imaginez votre site comme une boutique. Un beau décor ne sert à rien si personne ne passe devant. Mon travail, c&apos;est d&apos;installer cette boutique sur la place des Lices, pas dans une ruelle perdue. Chaque ligne de code, chaque image, chaque titre est pensé pour ça.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Création de site internet à Vannes"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Design sur mesure', desc: 'Une identité visuelle alignée sur votre marque, pas un template recyclé.' },
                  { icon: Zap, title: 'Performance', desc: 'Chargement en moins d\'une seconde, même en 4G dans le Golfe.' },
                  { icon: FileSearch, title: 'SEO intégré', desc: 'Structure, balisage et contenu pensés pour Google dès la conception.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                La mise en ligne prend généralement 3 à 5 semaines, suivie d&apos;une phase d&apos;optimisation SEO continue.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Des chiffres plutôt{' '}
              <span className="italic text-muted-foreground/80">que des promesses</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir ce qu&apos;un vrai site optimisé pourrait apporter à votre activité à Vannes ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage et stratégie', description: 'Je prends le temps de comprendre votre activité, votre clientèle à Vannes et vos objectifs. On définit ensemble l\'arborescence, les mots-clés à cibler et le ton à adopter. Pas de projet lancé à l\'aveugle.' },
                { number: '02', title: 'Design et développement', description: 'Je conçois les maquettes, vous validez, puis je développe un site propre, rapide et optimisé pour Google. Vous suivez l\'avancement en direct sur une version de test que vous pouvez consulter à tout moment.' },
                { number: '03', title: 'Lancement et SEO', description: 'Mise en ligne, configuration Google Search Console, Analytics et optimisation continue. Votre site part avec toutes les bases pour grimper sur les requêtes locales du Morbihan dans les premiers mois.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pourquoi un site WordPress générique ne suffit pas à Vannes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Beaucoup d&apos;entreprises vannetaises lancent un site sur un template WordPress acheté 50 euros. Résultat : un site lent, saturé de plugins et invisible sur Google. Mes sites sont développés sur mesure avec des technologies modernes (Next.js, React), pour un chargement éclair et une structure pensée pour le SEO.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Vous parlez à la personne qui code.' },
                            { icon: Zap, title: 'Vitesse', text: 'Des pages qui s\'ouvrent instantanément.' },
                            { icon: Target, title: 'Sur mesure', text: 'Pas de template, juste votre marque.' },
                            { icon: MessageCircle, title: 'Clair', text: 'Devis transparent, zéro surprise.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Création de site et SEO local dans le Morbihan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Quand je crée un site pour une entreprise basée à Vannes, je ne m&apos;arrête pas au design. Je prépare le terrain pour que vous soyez trouvé sur les recherches locales : &quot;coiffeur Vannes&quot;, &quot;menuisier Arradon&quot;, &quot;restaurant Sarzeau&quot;. C&apos;est là que 80% de vos futurs clients vous cherchent.
                        </p>
                        <p>
                          J&apos;accompagne des activités à <strong>Vannes</strong>, <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong> et <strong>Auray</strong>.
                        </p>
