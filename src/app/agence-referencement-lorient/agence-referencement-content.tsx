...
interface AgenceReferencementLorientContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementLorientContent({ faqs }: AgenceReferencementLorientContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Lorient"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Lorient :{' '}
              <span className="italic text-muted-foreground/80">votre visibilité Google, sans détour</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Lorient ? Je suis Victor Béasse, expert SEO en Bretagne. J&apos;accompagne les entreprises lorientaises pour qu&apos;elles soient visibles sur Google quand leurs clients les cherchent. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">pour les pros lorientais</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand un habitant de Lorient tape &quot;plombier Lorient&quot; ou &quot;restaurant port de pêche&quot; sur Google, c&apos;est le référencement qui détermine quel site apparaît en premier. Mon travail : comprendre ce que vos clients cherchent et faire en sorte que votre site y réponde mieux que vos concurrents.
                    </p>
                    <p>
                      Lorient a ses particularités : un héritage maritime fort, un bassin d&apos;emploi qui se diversifie, des événements majeurs comme le Festival Interceltique qui génèrent des pics de recherche. Le référencement tient compte de tout cela pour vous apporter des résultats concrets.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Stratégie de référencement pour entreprises à Lorient"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Votre site chargé vite, bien structuré et compris par Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages optimisées sur les recherches de vos clients lorientais.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens de confiance qui renforcent votre positionnement.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Les premiers résultats apparaissent entre 3 et 6 mois, avec une montée en puissance progressive.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">pour des entreprises bretonnes</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir où en est votre référencement aujourd&apos;hui ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Trois étapes{' '}
              <span className="italic text-muted-foreground/80">pour avancer concrètement</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange', description: 'Un premier rendez-vous de 30 minutes pour comprendre votre métier, vos ambitions et ce qui freine votre visibilité. En visio ou à Lorient si vous préférez.' },
                { number: '02', title: 'Diagnostic complet', description: 'J\'audite votre site de fond en comble : technique, contenu, liens, positionnement face à la concurrence locale dans le Morbihan. Vous recevez un plan d\'action priorisé.' },
                { number: '03', title: 'Résultats mois après mois', description: 'Les optimisations sont mises en place progressivement. Chaque mois, vous voyez vos positions évoluer, votre trafic grandir et les demandes de contact augmenter.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert dédié vs agence de référencement à Lorient">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>À Lorient, les agences web proposent souvent le référencement comme un service parmi d&apos;autres. Avec un expert dédié, le SEO est au centre de la prestation. Vous bénéficiez d&apos;un accompagnement personnalisé, d&apos;une réactivité sans pareil et d&apos;une vraie connaissance du marché local.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un seul interlocuteur', text: 'La personne qui travaille est celle qui vous parle.' },
                            { icon: Zap, title: 'Décisions rapides', text: 'Pas de process interne à traverser.' },
                            { icon: Target, title: 'Stratégie locale', text: 'Connaissance du bassin lorientais.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Vous savez ce qui est fait chaque mois.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement naturel dans le pays de Lorient">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le pays de Lorient regroupe plusieurs communes dynamiques avec des besoins de visibilité en ligne croissants. Le référencement local permet de capter les recherches des habitants et des visiteurs au moment où ils en ont besoin.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Lorient et dans les communes voisines : <strong>Lanester</strong>, <strong>Hennebont</strong>, <strong>Ploemeur</strong>, <strong>Larmor-Plage</strong>, <strong>Quéven</strong>. Je travaille aussi avec des clients à Vannes, Rennes et dans toute la Bretagne.
                        </p>
