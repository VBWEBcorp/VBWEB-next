...
interface AgenceReferencementQuimperContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementQuimperContent({ faqs }: AgenceReferencementQuimperContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Quimper"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Quimper :{' '}
              <span className="italic text-muted-foreground/80">placez votre site devant vos clients</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Quimper ? Je suis Victor Béasse, expert SEO en Bretagne. J&apos;accompagne les entreprises du Finistère sud pour transformer leur site en outil d&apos;acquisition de clients sur Google. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Ce que je fais{' '}
                    <span className="italic text-muted-foreground/80">pour les entreprises quimpéroises</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand un habitant de Quimper tape &quot;boulangerie Quimper centre&quot; ou &quot;comptable Finistère&quot; sur Google, le référencement détermine quel site apparaît en premier. J&apos;analyse ce que vos clients recherchent, j&apos;optimise votre site en conséquence et je construis votre visibilité sur le long terme.
                    </p>
                    <p>
                      Quimper est la capitale de la Cornouaille, avec un bassin économique dynamique entre artisanat, commerce et services. Le référencement vous permet de toucher ces audiences locales au moment précis où elles ont besoin de vous.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Stratégie de référencement pour entreprises à Quimper"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site solide, rapide et compréhensible par Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages qui répondent précisément aux recherches locales.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens entrants qui renforcent votre crédibilité en ligne.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Les premiers résultats se font sentir entre 3 et 6 mois, avec une accélération progressive.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">avec des résultats tangibles</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que Google pense de votre site ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un accompagnement{' '}
              <span className="italic text-muted-foreground/80">pas à pas</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Discussion libre', description: 'On échange pendant 30 minutes sur votre activité, votre marché et ce que vous attendez du référencement. En visio ou à Quimper, comme vous préférez.' },
                { number: '02', title: 'Audit de votre site', description: 'Je passe votre site en revue : aspects techniques, qualité du contenu, positionnement face aux concurrents dans le Finistère. Résultat : un plan d\'action avec des priorités claires.' },
                { number: '03', title: 'Optimisation mois après mois', description: 'Les améliorations sont déployées progressivement. Chaque mois, vous voyez évoluer vos positions Google, votre trafic et vos prises de contact.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO vs agence de référencement à Quimper">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>À Quimper, les agences web sont souvent généralistes : création de site, graphisme, référencement. Avec un expert SEO dédié, vous bénéficiez d&apos;une compétence pointue sur le référencement, pas d&apos;un service secondaire. La différence se voit dans les résultats.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Vous parlez à l\'expert, pas à un commercial.' },
                            { icon: Zap, title: 'Réactivité', text: 'Ajustements rapides, pas de processus lourds.' },
                            { icon: Target, title: 'Expertise ciblée', text: 'Le SEO est mon unique spécialité.' },
                            { icon: MessageCircle, title: 'Suivi transparent', text: 'Rapport mensuel avec vos indicateurs clés.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement en Cornouaille">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          La Cornouaille est un territoire riche : artisanat, tourisme, agroalimentaire, services. Chaque secteur a ses mots-clés et sa saisonnalité. Un référencement adapté tient compte de ces particularités pour vous rendre visible au bon moment.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Quimper et dans les communes voisines : <strong>Ergué-Gabéric</strong>, <strong>Pluguffan</strong>, <strong>Fouesnant</strong>, <strong>Bénodet</strong>, <strong>Concarneau</strong>. Je travaille aussi avec des clients dans tout le Finistère et en Bretagne.
                        </p>
