...
interface SiteInternetPlombierContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetPlombierContent({ faqs }: SiteInternetPlombierContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour plombier"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">le téléphone qui sonne en urgence</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites internet pour les plombiers et chauffagistes, partout en France. Urgences, dépannage, débouchage, salle de bain, chauffe-eau : chaque prestation a sa page, et chaque page est pensée pour remonter sur Google quand un particulier a besoin de vous tout de suite.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un plombier qu&apos;on trouve{' '}
                    <span className="italic text-muted-foreground/80">à 23h un dimanche</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Dans la plomberie, la moitié des demandes sont des urgences. Une fuite qui déborde, une chasse d&apos;eau bloquée, un chauffe-eau qui lâche en plein hiver. Le client tape &quot;plombier urgence dimanche&quot;, &quot;fuite eau nuit&quot; ou &quot;débouchage canalisation&quot; sur son téléphone, et il appelle le premier qui a l&apos;air sérieux. Si vous n&apos;apparaissez pas, vous n&apos;existez pas pour lui.
                    </p>
                    <p>
                      Je construis des sites qui captent exactement ces moments-là. Une page par prestation (dépannage, débouchage, salle de bain, chauffe-eau), un bouton d&apos;appel toujours visible, une fiche Google qui ressort sur les cartes, et des textes qui rassurent : délai d&apos;intervention, zones couvertes, devis gratuit. Où que vous soyez en France, l&apos;objectif est le même : que le téléphone sonne plus souvent.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour plombier"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Pages urgence', desc: 'Une page dédiée aux interventions d\'urgence, avec numéro et zone de couverture.' },
                  { icon: FileSearch, title: 'Prestations détaillées', desc: 'Débouchage, fuite, salle de bain, chauffe-eau : une page par savoir-faire.' },
                  { icon: TrendingUp, title: 'Fiche Google au top', desc: 'Optimisée pour apparaître sur la carte quand un client cherche à proximité.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site de plombier bien construit, c&apos;est en moyenne entre 5 et 15 appels qualifiés par semaine après 3 mois.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de faire sonner votre téléphone plus souvent ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On cadre votre activité', description: 'Au téléphone, vous me dites vos prestations (dépannage, salle de bain, chauffage), vos zones d\'intervention, vos tarifs de déplacement. Je prends des notes et je vous rappelle les points importants.' },
                { number: '02', title: 'Je monte le site', description: 'Je rédige chaque page prestation, j\'intègre vos photos de chantiers, j\'optimise pour les requêtes urgence et locales. Vous validez tout, sans jargon technique.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Le site passe en ligne, la fiche Google est optimisée. On regarde ensemble les premiers appels qui rentrent, et on ajuste si besoin. Vous gardez la main sur tout.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Les requêtes Google qui rapportent le plus à un plombier">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Toutes les recherches ne se valent pas. Quand quelqu&apos;un tape &quot;comment réparer une fuite&quot;, il veut un tuto, pas un plombier. Mais &quot;plombier urgence dimanche&quot; ou &quot;dépannage chauffe-eau&quot;, c&apos;est un client qui est prêt à payer. Je construis votre site autour de ces requêtes qui font sonner le téléphone.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Urgence', text: 'plombier urgence, fuite eau, dégât des eaux, canalisation bouchée.' },
                            { icon: User, title: 'Dépannage', text: 'débouchage, chasse d\'eau, robinet qui fuit, chauffe-eau en panne.' },
                            { icon: Target, title: 'Travaux', text: 'installation salle de bain, rénovation plomberie, changement chauffe-eau.' },
                            { icon: MessageCircle, title: 'Local', text: 'plombier + nom de ville, zone intervention, tarifs déplacement.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Vous êtes un autre artisan du bâtiment ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je ne travaille pas qu&apos;avec des plombiers. Chaque métier d&apos;artisan a ses propres urgences, ses propres mots-clés et sa propre façon de convaincre un client. Si vous êtes couvreur, électricien, maçon ou un autre artisan du bâtiment, j&apos;ai une page dédiée à votre métier.
                        </p>
