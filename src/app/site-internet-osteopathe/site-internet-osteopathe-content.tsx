...
interface SiteInternetOsteopatheContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetOsteopatheContent({ faqs }: SiteInternetOsteopatheContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour ostéopathe"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pour être choisi avant vos confrères</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO et créateur de sites internet. Je crée des sites pour les ostéopathes partout en France : un site qui met en avant vos spécialités (bébé, femme enceinte, sportif), intègre la prise de rendez-vous et vous positionne sur &quot;ostéo près de chez moi&quot;. Plus de 150 sites créés.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site qui parle à{' '}
                    <span className="italic text-muted-foreground/80">tous vos types de patients</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      L&apos;ostéopathie rassemble des publics très différents : jeunes parents qui cherchent un ostéo pour leur bébé, femmes enceintes qui veulent un accompagnement doux, sportifs qui récupèrent après un effort, patients avec des douleurs chroniques. Chaque profil arrive sur votre site avec une attente spécifique. Mon travail, c&apos;est de construire une arborescence qui parle à chacun.
                    </p>
                    <p>
                      Concrètement, je crée des pages dédiées par profil de patient (&quot;ostéo bébé&quot;, &quot;ostéo femme enceinte&quot;, &quot;ostéo sportif&quot;), chacune optimisée pour sa recherche Google. Résultat : vous apparaissez précisément là où vos futurs patients cherchent, sans diluer votre identité globale.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour ostéopathe"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: User, title: 'Pages par public', desc: 'Bébé, femme enceinte, sportif : chaque profil a sa page dédiée.' },
                  { icon: Zap, title: 'RDV en ligne', desc: 'Intégration fluide de Doctolib, Crénolibre ou votre outil habituel.' },
                  { icon: MapPin, title: '"Ostéo près de chez moi"', desc: 'Référencement local optimisé pour que vos voisins vous trouvent.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Contenus rédigés dans le respect du code de déontologie : pas de promesse, pas de comparaison, information loyale.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">pas un beau discours</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un site ostéo qui fait venir les bons patients ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              De la première idée{' '}
              <span className="italic text-muted-foreground/80">à votre site en ligne</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cartographie de votre patientèle', description: 'On identifie ensemble les profils que vous accompagnez le plus (bébé, femme enceinte, sportif, douleurs chroniques) pour construire une arborescence adaptée.' },
                { number: '02', title: 'Rédaction et création', description: 'Je rédige les pages par spécialité, crée les maquettes, intègre votre agenda de prise de rendez-vous et prépare le référencement local. Vous validez chaque étape.' },
                { number: '03', title: 'Mise en ligne et formation', description: 'Votre site passe en ligne, votre Google Business Profile est optimisé, et je vous forme à l\'interface pour que vous gardiez la main sur vos contenus.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pages spécialisées : bébé, femme enceinte, sportif">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Créer des pages par profil, c&apos;est le moyen le plus efficace de capter les recherches précises. Un jeune parent qui tape &quot;ostéo bébé coliques&quot; veut atterrir sur une page qui lui parle directement de ça, pas sur la page d&apos;accueil générique de votre cabinet.
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Ostéo bébé', text: 'Coliques, régurgitations, plagiocéphalie, sommeil.' },
                            { icon: Target, title: 'Femme enceinte', text: 'Douleurs lombaires, bassin, préparation à l\'accouchement.' },
                            { icon: Zap, title: 'Sportif', text: 'Préparation, récupération, traumato, tendinites.' },
                            { icon: MessageCircle, title: 'Douleurs chroniques', text: 'Dos, cervicales, migraines, troubles digestifs.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Autres professions de santé accompagnées">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Vous partagez sûrement votre cabinet ou votre réseau avec d&apos;autres praticiens. J&apos;accompagne plusieurs professions de santé partout en France. Pour une vue d&apos;ensemble, rendez-vous sur la page <Link href="/site-internet-therapeute" className="text-primary underline underline-offset-2">site internet thérapeute</Link>.
                        </p>
