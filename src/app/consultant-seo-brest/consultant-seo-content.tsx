...
interface ConsultantSeoBrestContentProps {
  faqs: { question: string; answer: string }[]
}

export function ConsultantSeoBrestContent({ faqs }: ConsultantSeoBrestContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">votre expert en référencement naturel</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO basé en Bretagne. J&apos;aide les entreprises brestoises &mdash; du Technopôle Brest-Iroise aux commerces de la rue de Siam &mdash; à gagner des positions sur Google et à transformer leur visibilité en clients. Plus de 200 projets menés et 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Brest est un marché à part en Bretagne. L&apos;économie tourne autour de la navale, de la recherche océanographique, du CHU et d&apos;un tissu de commerces et de services qui dessert aussi Plouzané, Guipavas et tout le pays de Brest. Ces spécificités se retrouvent dans les recherches Google &mdash; &quot;réparation navale Brest&quot;, &quot;restaurant port de commerce&quot;, &quot;architecte Plouzané&quot; &mdash; et c&apos;est exactement là que je positionne votre site.
                    </p>
                    <p>
                      Là où d&apos;autres consultants SEO appliquent des recettes génériques, je creuse les données locales. Quels termes les Brestois tapent-ils vraiment ? Quels concurrents trustent la première page et pourquoi ? Je construis un plan d&apos;action basé sur ces réponses, pas sur des suppositions.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Consultant SEO à Brest : analyse et stratégie de référencement"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Vitesse, structure, indexation : que Google lise votre site sans obstacle.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages qui répondent aux recherches de vos clients brestois.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens entrants de qualité pour asseoir votre crédibilité en ligne.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Les premiers résultats se mesurent entre 3 et 6 mois, puis la courbe s&apos;accélère au fil des optimisations.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir ce que le SEO peut changer pour votre entreprise ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On fait le point', description: 'Un premier échange de 30 minutes pour comprendre votre activité, vos objectifs de croissance et vos freins actuels sur Google. Je vous dis franchement si le SEO est le bon levier pour vous.' },
                { number: '02', title: 'J\'audite et je planifie', description: 'Audit complet de votre site : performance technique, contenu, mots-clés, positionnement face à vos concurrents brestois. Vous repartez avec un plan d\'action hiérarchisé, pas une liste de 200 points.' },
                { number: '03', title: 'J\'exécute et on mesure', description: 'Les optimisations sont déployées progressivement. Chaque mois, on analyse ensemble les résultats en visio : positions gagnées, trafic, demandes de devis reçues. On ajuste la stratégie en continu.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Consultant SEO vs agence : que choisir à Brest ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les agences web à Brest proposent souvent le SEO en complément de leurs autres prestations. Le problème : votre dossier passe de main en main, entre le commercial, le chef de projet et le stagiaire qui fait les optimisations. Avec un consultant SEO indépendant, vous avez un seul interlocuteur qui maîtrise toute la chaîne.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Je gère votre projet de A à Z.' },
                            { icon: Zap, title: 'Rapidité d\'exécution', text: 'Décisions et ajustements immédiats.' },
                            { icon: Target, title: 'Stratégie locale', text: 'Adaptée au tissu économique brestois.' },
                            { icon: MessageCircle, title: 'Reporting mensuel', text: 'Données claires, sans jargon inutile.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le SEO à Brest et dans le Finistère">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Brest a un tissu économique particulier : le port, le secteur naval et de la défense, le Technopôle Brest-Iroise avec ses startups et laboratoires, le tourisme côtier. Chaque secteur a ses mots-clés et ses habitudes de recherche. Un consultant SEO qui connaît ce terrain peut cibler les bonnes requêtes dès le départ, sans perdre de temps sur des mots-clés qui ne convertissent pas.
                        </p>
                        <p>
                          J&apos;interviens à Brest et dans les communes voisines : <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong>, <strong>Landerneau</strong>. Et plus largement à <strong>Quimper</strong>, <strong>Saint-Brieuc</strong> et <strong>Rennes</strong>.
                        </p>
