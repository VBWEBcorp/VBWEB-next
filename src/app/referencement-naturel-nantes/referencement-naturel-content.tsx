...
interface ReferencementNaturelNantesContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelNantesContent({ faqs }: ReferencementNaturelNantesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Nantes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Nantes,{' '}
              <span className="italic text-muted-foreground/80">développez votre visibilité sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Dans une métropole aussi dynamique que Nantes, la concurrence en ligne est forte. Le référencement naturel vous permet de sortir du lot sur Google et d&apos;attirer des clients qualifiés sans dépendre de la publicité. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
                    Le référencement naturel, concrètement
                  </p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">quand ça compte</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Nantes compte plus de 650 000 habitants dans sa métropole. Chaque jour, des milliers de Nantais cherchent des services sur Google : &quot;avocat Nantes&quot;, &quot;plombier Saint-Herblain&quot;, &quot;restaurant Rezé&quot;. Le référencement naturel, c&apos;est le travail qui permet à votre site de figurer dans ces résultats, sans payer de publicité à chaque clic.
                    </p>
                    <p>
                      L&apos;idée est simple : Google classe les sites selon leur qualité technique, leur contenu et leur réputation. Mon travail, c&apos;est d&apos;optimiser ces trois dimensions pour que votre site remonte dans le classement et capte les clients qui vous cherchent.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Référencement naturel à Nantes"
                      loading="lazy"
                      width={800}
                      height={600}
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que le référencement naturel peut apporter à votre entreprise nantaise ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier contact', description: 'On échange 30 minutes sur votre activité à Nantes, vos objectifs de croissance et votre présence actuelle sur Google. Je vous dis honnêtement si le référencement naturel est pertinent pour votre cas.' },
                { number: '02', title: 'Audit complet', description: 'J\'analyse votre site de fond en comble : technique, contenu, positionnement, concurrence dans la métropole nantaise. Vous recevez un plan d\'action avec les priorités et un planning.' },
                { number: '03', title: 'Croissance continue', description: 'Les optimisations sont déployées chaque mois. Vous suivez vos positions Google, votre trafic et vos demandes de contact en temps réel dans un espace de suivi dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Le référencement naturel dans une métropole concurrentielle">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Nantes est la sixième ville de France, avec un écosystème économique riche et une concurrence en ligne proportionnelle. C&apos;est à la fois un défi et une opportunité : beaucoup d&apos;entreprises nantaises n&apos;ont pas encore investi sérieusement dans leur référencement naturel. Celles qui le font prennent une avance durable sur leurs concurrents.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Accompagnement direct', text: 'Vous échangez avec moi, pas avec un intermédiaire.' },
                            { icon: Zap, title: 'Avantage concurrentiel', text: 'Prenez de l\'avance sur vos concurrents nantais.' },
                            { icon: Target, title: 'Ciblage métropole', text: 'Mots-clés adaptés à Nantes et sa couronne.' },
                            { icon: MessageCircle, title: 'Données en temps réel', text: 'Accès à toutes vos données, rapport mensuel.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Référencement naturel en Loire-Atlantique">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          La métropole nantaise et la Loire-Atlantique offrent un bassin de clientèle important. Le référencement naturel vous permet de couvrir l&apos;ensemble de votre zone de chalandise, que vos clients soient dans le centre de Nantes, en première couronne ou jusqu&apos;à Saint-Nazaire.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à <strong>Saint-Herblain</strong>, <strong>Rezé</strong>, <strong>Orvault</strong>, <strong>Carquefou</strong>, <strong>Saint-Nazaire</strong>. Je travaille aussi avec des clients à <strong>Rennes</strong> et <strong>Vannes</strong>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Nantes', 'Saint-Herblain', 'Rezé', 'Orvault', 'Carquefou', 'Saint-Nazaire', 'Rennes'].map((city) => (
