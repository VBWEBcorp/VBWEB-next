...
interface DeveloppementWebVannesContentProps {
  faqs: { question: string; answer: string }[]
}

export function DeveloppementWebVannesContent({ faqs }: DeveloppementWebVannesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, développeur web à Vannes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">du sur mesure qui performe</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Basé à Rennes, j&apos;accompagne des PME vannetaises et du Morbihan dans la création de leurs sites et applications web. Technos modernes (Next.js, React, TypeScript), performance au rendez-vous et SEO intégré dès la conception.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Des sites comme{' '}
                    <span className="italic text-muted-foreground/80">un bateau bien conçu</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Un site web, c&apos;est un peu comme un bateau : on peut en bricoler un avec des pièces achetées en ligne (le WordPress plein de plugins), ou on peut le construire sur mesure, avec les bons matériaux, pour qu&apos;il tienne la mer. Moi, je choisis la seconde option. Next.js, React, TypeScript : des technologies solides, utilisées par les plus gros sites mondiaux.
                    </p>
                    <p>
                      J&apos;ai développé des sites pour des professionnels du tourisme à Arradon, des commerces du centre de Vannes, des artisans à Séné et Theix-Noyalo. Chaque projet part d&apos;une page blanche, avec un design pensé pour votre activité et un code optimisé pour le référencement.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Développement web à Vannes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Sites web', desc: 'Vitrines rapides pour artisans, commerces et professionnels du Golfe.' },
                  { icon: FileSearch, title: 'Applications', desc: 'Outils métier et espaces clients sur mesure pour les PME vannetaises.' },
                  { icon: TrendingUp, title: 'E-commerce', desc: 'Boutiques en ligne pour producteurs, créateurs et artisans locaux.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Le site est livré propre, documenté, et vous restez maître de tout votre projet.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie d&apos;un site qui sort vraiment du lot ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">voici comment on avance</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage et maquettes', description: 'On discute de vos objectifs, de votre univers, de vos inspirations. Je vous propose des wireframes, une charte, une arborescence claire. Le projet est balisé avant la première ligne de code.' },
                { number: '02', title: 'Développement en Next.js', description: 'Je code votre site avec des outils modernes et rigoureux. Vous suivez l\'avancée en temps réel via une URL de preview. Les retours se font au fur et à mesure, sans mauvaise surprise à la livraison.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Je m\'occupe de la configuration, de l\'hébergement, du SEO technique et de la performance. Une fois le site en ligne, je reste disponible pour la maintenance et les évolutions.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pourquoi la vitesse du site compte autant à Vannes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Dans le Golfe, beaucoup de visiteurs consultent votre site en mobilité, sur 4G, parfois dans des zones mal couvertes. Un site lent, c&apos;est un visiteur qui rebondit. Un site rapide, c&apos;est un client gagné. Next.js permet de rendre les pages instantanément, même en conditions réseau dégradées.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Vitesse mobile', text: 'Chargement en moins d\'une seconde même en 4G.' },
                            { icon: User, title: 'UX soignée', text: 'Des interfaces claires, intuitives, modernes.' },
                            { icon: Target, title: 'SEO natif', text: 'Le code est pensé pour Google dès l\'origine.' },
                            { icon: MessageCircle, title: 'Évolutif', text: 'Ajoutez des fonctionnalités sans tout casser.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="J'interviens dans tout le Morbihan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Basé à Rennes, je me déplace régulièrement dans le Morbihan pour rencontrer mes clients. Le Golfe, la côte, le rétro-littoral : chaque secteur a ses particularités que je connais bien à force d&apos;avoir bossé avec des entrepreneurs locaux.
                        </p>
                        <p>
                          J&apos;accompagne des projets à <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong> et <strong>Auray</strong>, sans oublier bien sûr le centre de Vannes.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Freelance SEO Vannes', desc: 'Référencement naturel local', href: '/freelance-seo-vannes' },
                      { label: 'Agence SEO Vannes', desc: 'Accompagnement complet', href: '/agence-seo-vannes' },
                      { label: 'Consultant SEO Vannes', desc: 'Expert SEO dédié', href: '/consultant-seo-vannes' },
