...
interface AgenceDeveloppementWebBrestContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebBrestContent({ faqs }: AgenceDeveloppementWebBrestContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Brest - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Brest,{' '}
              <span className="italic text-muted-foreground/80">un expert direct au bout du fil</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Brest ? Voici une alternative directe avec un expert dédié. Je suis Victor Béasse, développeur web et consultant SEO. J&apos;accompagne des entreprises du Finistère sans intermédiaires, avec plus de 150 sites livrés et 75 avis 5 étoiles. La relation est simple : vous et moi, rien d&apos;autre.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Ce qu&apos;une agence fait,{' '}
                    <span className="italic text-muted-foreground/80">en plus direct</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Une agence web, c&apos;est un peu comme un paquebot : solide, rassurant, mais plus long à manoeuvrer. Chaque décision traverse plusieurs étages avant d&apos;être prise. Pour certains projets très complexes, ça vaut le coup. Pour la majorité des sites dont ont besoin les entreprises brestoises, c&apos;est de la friction inutile.
                    </p>
                    <p>
                      Avec moi, vous êtes sur un bateau plus léger, plus rapide. Vous parlez directement au pilote. Conception, graphisme, code, SEO, mise en ligne, tout passe par la même personne. Votre projet avance sans perdre d&apos;énergie dans les passages de relais.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Expert développement web à Brest"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Stratégie', desc: 'Comprendre votre activité avant d\'écrire la moindre ligne de code.' },
                  { icon: FileSearch, title: 'Réalisation', desc: 'Un site propre, rapide, bien structuré, taillé pour durer.' },
                  { icon: TrendingUp, title: 'Performance SEO', desc: 'Un référencement Google pensé dès les premiers choix techniques.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site vitrine est livré en 4 à 8 semaines, un e-commerce en 2 à 4 mois.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un projet web qui patiente dans vos cartons à Brest ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un déroulé simple,{' '}
              <span className="italic text-muted-foreground/80">sans zone d&apos;ombre</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier échange', description: 'On prend le temps de comprendre votre activité, vos clients, vos objectifs. Je vous propose une approche concrète avec des chiffres clairs, pas un baratin commercial.' },
                { number: '02', title: 'Conception et code', description: 'Je dessine les maquettes et je les valide avec vous avant de coder. Vous suivez l\'avancement sur un lien de test accessible à tout moment.' },
                { number: '03', title: 'Livraison et transmission', description: 'Le site est mis en ligne, l\'analytique branchée, les accès transférés. Je vous forme à l\'administration pour que vous soyez autonome sur le contenu.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Sur les projets de taille moyenne qui représentent la majorité des besoins à Brest, travailler avec l&apos;expert directement évite les frais de structure et raccourcit la boucle de décision. Les agences gardent leur intérêt sur les très gros chantiers qui demandent plusieurs métiers simultanés.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Pas d\'intermédiaire', text: 'Vous parlez à la personne qui code.' },
                            { icon: Zap, title: 'Gain de temps', text: 'Les allers-retours sont directs.' },
                            { icon: Target, title: 'Coût juste', text: 'Vous payez le travail, pas la structure.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Chaque ligne du devis est expliquée.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Travailler avec un expert basé à Rennes pour un projet brestois">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le développement web se pratique très bien à distance. Les outils modernes rendent la collaboration aussi fluide qu&apos;en présentiel. Pour les moments clés du projet, je me déplace à Brest quand c&apos;est utile. La proximité culturelle bretonne fait que l&apos;on se comprend vite sur les attentes.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises dans Brest et son pays : <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong>, <strong>Landerneau</strong>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Brest', 'Guipavas', 'Plouzané', 'Le Relecq-Kerhuon', 'Plougastel-Daoulas', 'Landerneau'].map((city) => (
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Agence SEO', desc: 'Référencement naturel à Brest', href: '/agence-seo-brest' },
                      { label: 'Référencement naturel', desc: 'Stratégie Google complète', href: '/referencement-naturel-brest' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Brest', href: '/freelance-seo-brest' },
