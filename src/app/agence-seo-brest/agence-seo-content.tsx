...
interface AgenceSeoBrestContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoBrestContent({ faqs }: AgenceSeoBrestContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Brest - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Votre agence SEO à Brest,{' '}
              <span className="italic text-muted-foreground/80">en version expert dédié</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous recherchez une agence SEO à Brest pour gagner des positions sur Google. Je vous propose mieux : un expert SEO qui travaille directement sur votre site, sans intermédiaire. Victor Béasse, consultant SEO en Bretagne. Plus de 200 projets, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">à Brest et dans le Finistère</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Brest est un bassin économique solide : port, Technopôle, naval, recherche, commerce. Vos futurs clients tapent chaque jour des requêtes comme &quot;serrurier Brest&quot;, &quot;formation Brest&quot; ou &quot;expert-comptable Finistère&quot; sur Google. Si votre site n&apos;est pas dans les premiers résultats, ils ne vous trouveront pas.
                    </p>
                    <p>
                      Je prends le temps de comprendre votre activité et votre concurrence locale avant de toucher à quoi que ce soit. Chaque action est justifiée, chaque résultat est mesurable. Pas de boite noire, que de la clarté.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir où en est votre site sur Google à Brest ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange', description: 'Un premier appel de 30 minutes pour comprendre votre activité à Brest, vos ambitions et ce qui bloque votre visibilité aujourd\'hui. Je vous dis franchement si le SEO est le bon investissement.' },
                { number: '02', title: 'J\'analyse en profondeur', description: 'Audit technique, analyse de contenu, étude de la concurrence dans le Finistère. Vous recevez un plan d\'action hiérarchisé avec les quick wins et les chantiers de fond.' },
                { number: '03', title: 'On construit mois après mois', description: 'Les optimisations se déploient progressivement. Vous suivez vos positions, votre trafic et vos conversions dans un tableau de bord dédié. On ajuste ensemble à chaque point mensuel.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert dédié vs agence SEO à Brest">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les agences SEO à Brest font du bon travail, mais le modèle a ses limites : votre dossier est géré par une équipe qui jongle entre plusieurs clients. Avec un expert dédié, la relation est plus directe. Je connais votre site, votre marché et vos objectifs parce que c&apos;est moi qui travaille dessus chaque semaine.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Pas d\'intermédiaire entre vous et l\'expert.' },
                            { icon: Zap, title: 'Réactivité', text: 'Disponible dans la journée, pas sous 48h.' },
                            { icon: Target, title: 'Stratégie ciblée', text: 'Adaptée au marché brestois et finistérien.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Accès permanent à vos données et rapports.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le SEO à Brest et dans le Finistère">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Brest est la deuxième ville de Bretagne avec un tissu économique diversifié : le port, le Technopôle, le secteur naval, la recherche et un commerce de proximité dynamique. Le potentiel SEO est important car beaucoup d&apos;entreprises n&apos;ont pas encore investi ce levier.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Brest et dans les communes environnantes : <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong>, <strong>Landerneau</strong>. Le référencement local couvre votre zone de chalandise dans son ensemble.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Brest', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-brest' },
                      { label: 'Freelance SEO Brest', desc: 'Expert indépendant à votre service', href: '/freelance-seo-brest' },
