...
interface SiteInternetPaysagisteContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetPaysagisteContent({ faqs }: SiteInternetPaysagisteContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour paysagiste"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pour remplir votre carnet dès le printemps</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je conçois des sites internet pour paysagistes partout en France. Création de jardin, terrasse bois, entretien annuel, élagage : votre site capte les demandes au moment où elles explosent, saison après saison, et les transforme en devis concrets.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site internet paysagiste{' '}
                    <span className="italic text-muted-foreground/80">calé sur vos saisons</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le métier de paysagiste, c&apos;est un rythme particulier. En février, le téléphone n&apos;a pas encore sonné, et pourtant les gens commencent déjà à taper &quot;paysagiste près de chez moi&quot;, &quot;création jardin prix&quot;, &quot;terrasse bois sur mesure&quot; sur Google. Si vous êtes là au bon moment, vous remplissez votre saison avant les concurrents. Si vous arrivez en mai, c&apos;est trop tard.
                    </p>
                    <p>
                      Votre site devient un jardin lui aussi : on le plante en hiver, et au printemps il commence à produire des demandes de devis. Je structure chaque page pour qu&apos;elle réponde à une intention précise : création complète, entretien récurrent, élagage, piscine, bassin.
                    </p>
                    <p>
                      Les recherches varient aussi avec les saisons. Je pense le site pour qu&apos;il capte les pics naturels : création au printemps, arrosage en été, taille en automne, préparation en hiver. Résultat : un site qui travaille toute l&apos;année, pas seulement trois mois.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      src="https://pub-698f857760da42999dac8854114fbc41.r2.dev/unsplash-photo-1558904541-efa843a96f01-w800.webp"
                      alt="Création site internet pour paysagiste"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Pages prestations', desc: 'Création de jardin, terrasse bois, entretien, élagage, piscine : une page dédiée par savoir-faire.' },
                  { icon: FileSearch, title: 'Galerie saisonnière', desc: 'Vos réalisations à différentes saisons, pour prouver que votre travail tient dans le temps.' },
                  { icon: TrendingUp, title: 'Anticipation des pics', desc: 'Le site est en place avant le boom du printemps, prêt à capter les premières recherches.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                J&apos;accompagne des paysagistes partout en France, des indépendants aux entreprises de plusieurs salariés.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie d&apos;anticiper le rush du printemps avec un site prêt à tourner ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              De la graine{' '}
              <span className="italic text-muted-foreground/80">au site qui pousse</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange en visio', description: 'On prend 30 minutes pour parler de votre activité, de vos saisons fortes, du type de clients que vous voulez attirer et des prestations que vous voulez mettre en avant. Je vous dis franchement si un site peut vous aider.' },
                { number: '02', title: 'Je construis votre site', description: 'Je conçois la structure autour de vos spécialités : création de jardin, terrasse bois, entretien, élagage, piscine. Je prépare la galerie de réalisations avec vos photos et j\'optimise chaque page pour les bonnes recherches Google.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Le site est livré, indexé, relié à votre Google Business Profile. Chaque mois, vous voyez les visites, les positions et les demandes de devis reçues dans un tableau de bord simple à lire.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Comment anticiper le pic de demandes du printemps">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Chaque année, entre février et mai, les recherches autour du jardin explosent. &quot;Création jardin&quot;, &quot;paysagiste + ville&quot;, &quot;terrasse bois&quot;, &quot;élagage&quot; : des dizaines de milliers de personnes tapent ces requêtes. Le problème, c&apos;est que Google met du temps à bien indexer un nouveau site.</p>
                        <p>Il faut donc mettre le site en ligne en hiver, pas au printemps. Je livre en 2 à 3 semaines, puis les 2 mois suivants permettent à Google de positionner vos pages. Vous arrivez pile au début du pic avec un site qui ressort déjà dans les résultats.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Clients particuliers', text: 'Création, terrasse, aménagement d\'entrée.' },
                            { icon: Zap, title: 'Pic printemps', text: 'Le site est prêt avant la saison haute.' },
                            { icon: Target, title: 'Entretien annuel', text: 'Contrats récurrents qui sécurisent l\'année.' },
                            { icon: MessageCircle, title: 'Élagage d\'automne', text: 'Deuxième pic capté après l\'été.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Un site internet paysagiste, et les autres métiers artisans">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je conçois des sites pour paysagistes partout en France, mais j&apos;accompagne aussi les autres artisans du bâtiment et de l&apos;aménagement. Si vous connaissez un confrère d&apos;un autre métier, je peux vous orienter.
                        </p>
                        <p>
                          Je réalise également des sites pour <Link href="/site-internet-plombier" className="text-primary underline-offset-2 hover:underline">plombiers</Link>, <Link href="/site-internet-couvreur" className="text-primary underline-offset-2 hover:underline">couvreurs</Link>, <Link href="/site-internet-peintre" className="text-primary underline-offset-2 hover:underline">peintres</Link>, <Link href="/site-internet-menuisier" className="text-primary underline-offset-2 hover:underline">menuisiers</Link> et <Link href="/site-internet-carreleur" className="text-primary underline-offset-2 hover:underline">carreleurs</Link>. Vous retrouvez toutes les offres sur la page <Link href="/site-internet-artisan" className="text-primary underline-offset-2 hover:underline">site internet artisan</Link>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Partout en France', 'Création jardin', 'Terrasse bois', 'Élagage', 'Entretien annuel', 'Piscine'].map((tag) => (
