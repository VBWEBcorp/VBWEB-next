...
interface DeveloppementWebSaintMaloContentProps {
  faqs: { question: string; answer: string }[]
}

export function DeveloppementWebSaintMaloContent({ faqs }: DeveloppementWebSaintMaloContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, développeur web à Saint-Malo"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">des sites aussi solides que les remparts</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Développeur freelance et consultant SEO, je crée des sites web modernes pour les commerces, hôtels, restaurants et artisans de Saint-Malo et de la côte d&apos;Émeraude. Technologies récentes (Next.js, React), code propre et performance au rendez-vous.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Bâtir des sites solides,{' '}
                    <span className="italic text-muted-foreground/80">pierre par pierre</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Les remparts de Saint-Malo tiennent depuis des siècles parce qu&apos;ils sont bien construits. Un site web, c&apos;est pareil : il faut des fondations solides, des matériaux de qualité, et un plan réfléchi. Je développe en Next.js et React, des technos qui tiennent la route et qui font référence dans le web moderne.
                    </p>
                    <p>
                      À Saint-Malo, j&apos;accompagne des hôtels intra-muros, des restaurants du port, des artisans à Cancale, des commerces à Dinan, des professionnels du tourisme à Dinard. Chaque site est pensé pour capter les touristes qui cherchent sur mobile pendant leurs vacances.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Développement web à Saint-Malo"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Sites web', desc: 'Vitrines soignées pour hôtels, restaurants, artisans et commerces malouins.' },
                  { icon: FileSearch, title: 'Applications', desc: 'Outils sur mesure : réservation, espace client, gestion interne.' },
                  { icon: TrendingUp, title: 'E-commerce', desc: 'Boutiques en ligne pour vendre aux touristes et locaux.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Tout est livré propre, documenté, et vous restez propriétaire du projet.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous avez un projet web à faire grandir ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">en toute transparence</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On pose les fondations', description: 'Entretien de découverte, compréhension de votre activité, analyse de la concurrence locale, cadrage du projet. Vous recevez des maquettes, un planning et un devis ferme.' },
                { number: '02', title: 'On construit', description: 'Développement en Next.js, avec un accès preview permanent pour suivre l\'avancée jour après jour. Vous validez chaque grande étape, pas de boîte noire.' },
                { number: '03', title: 'Mise en ligne et maintenance', description: 'Configuration du nom de domaine, hébergement, SEO technique, tests complets. Après la livraison, je reste disponible pour la maintenance et les évolutions.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Un site qui capte les touristes à Saint-Malo">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les visiteurs de Saint-Malo cherchent en mobilité, sur mobile, souvent avec peu de patience. Un site lent, c&apos;est un visiteur perdu. Un site rapide, c&apos;est une réservation gagnée. Avec Next.js, vos pages s&apos;affichent en moins d&apos;une seconde, même sur une 4G moyenne.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: Zap, title: 'Mobile first', text: 'Chaque site est optimisé smartphone en priorité.' },
                            { icon: User, title: 'Design fort', text: 'Photos, ambiance, identité visuelle soignée.' },
                            { icon: Target, title: 'Géolocalisé', text: 'Balises locales pour ranker sur Saint-Malo.' },
                            { icon: MessageCircle, title: 'Conversion', text: 'CTA clairs pour transformer les visiteurs en clients.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="J'interviens sur toute la côte d'Émeraude">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Depuis Rennes, je suis à une heure de Saint-Malo. Je me déplace volontiers pour les premiers rendez-vous et les phases importantes du projet. La côte d&apos;Émeraude est un territoire que je connais bien et qui regorge d&apos;entrepreneurs exigeants.
                        </p>
                        <p>
                          J&apos;accompagne des projets à <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong> et <strong>Saint-Lunaire</strong>, sans oublier Saint-Malo intra-muros et Paramé.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Freelance SEO Saint-Malo', desc: 'Référencement naturel local', href: '/freelance-seo-saint-malo' },
                      { label: 'Agence SEO Saint-Malo', desc: 'Accompagnement complet', href: '/agence-seo-saint-malo' },
                      { label: 'Consultant SEO Saint-Malo', desc: 'Expert SEO dédié', href: '/consultant-seo-saint-malo' },
