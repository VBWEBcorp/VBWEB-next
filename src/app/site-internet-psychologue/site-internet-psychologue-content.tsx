...
interface SiteInternetPsychologueContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetPsychologueContent({ faqs }: SiteInternetPsychologueContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour psychologue"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pour accueillir sans intimider</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO et créateur de sites internet. Je crée des sites pour les psychologues partout en France : un site pédagogique, chaleureux, qui facilite la prise de rendez-vous et respecte scrupuleusement votre code de déontologie. Plus de 150 sites créés.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site qui accueille{' '}
                    <span className="italic text-muted-foreground/80">avant même la première séance</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Prendre rendez-vous chez un psychologue, c&apos;est souvent un pas difficile. La personne qui arrive sur votre site a souvent beaucoup hésité. Ce qu&apos;elle cherche, c&apos;est une présence rassurante, un parcours clair, une approche expliquée avec des mots simples. Mon travail, c&apos;est de créer cet espace d&apos;accueil numérique qui lève les freins.
                    </p>
                    <p>
                      Je rédige toujours dans un ton humain, sans jargon technique qui peut intimider. Je déstigmatise, j&apos;explique la thérapie sans en faire trop, et je reste dans le cadre strict du Code de Déontologie des Psychologues : pas de témoignages, respect absolu du secret professionnel, information loyale.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour psychologue"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: MessageCircle, title: 'Pédagogie', desc: 'Expliquer votre approche avec des mots simples, sans jargon qui peut freiner.' },
                  { icon: User, title: 'Cadre protégé', desc: 'Secret professionnel et numéro ADELI respectés à la lettre sur le site.' },
                  { icon: Zap, title: 'Premier rendez-vous', desc: 'Téléconsultation, cabinet, tarifs : tout est clair avant l\'appel.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Site conforme au Code de Déontologie des Psychologues : pas de témoignage, pas de promesse, juste un accueil juste.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Une expertise,{' '}
              <span className="italic text-muted-foreground/80">des résultats mesurables</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un site psychologue qui vous ressemble, ça vous parle ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Créer votre site,{' '}
              <span className="italic text-muted-foreground/80">étape par étape</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On pose votre cadre', description: 'Je vous écoute parler de votre pratique, de votre patientèle, de ce qui vous tient à cœur. Je cherche le ton juste, celui qui ressemble à votre manière d\'accueillir.' },
                { number: '02', title: 'Rédaction et design', description: 'Je rédige les textes (et vous corrigez tout), je construis un design apaisé et je vérifie la conformité avec le Code de Déontologie. Rien n\'est publié sans votre accord.' },
                { number: '03', title: 'Mise en ligne sereine', description: 'Mise en ligne, prise de rendez-vous en ligne activée, référencement Google local. Je vous forme pour que vous puissiez faire évoluer le site vous-même.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Déstigmatiser la consultation psychologique sur votre site">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Beaucoup de personnes hésitent encore à consulter un psychologue. Votre site peut jouer un rôle précieux pour lever ces freins, simplement en expliquant ce qui se passe vraiment dans un premier rendez-vous. Je m&apos;attache à écrire des textes qui parlent vrai, qui rassurent sans minimiser.
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Votre parcours', text: 'Diplôme, formations, supervision : tout ce qui rassure.' },
                            { icon: MessageCircle, title: 'Première séance', text: 'Expliquer concrètement comment ça se passe.' },
                            { icon: Target, title: 'Pour qui', text: 'Thématiques que vous accompagnez (anxiété, burn-out, couple).' },
                            { icon: Zap, title: 'Tarifs', text: 'Transparence sur les prix et les remboursements possibles.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Autres professions de santé accompagnées">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je travaille aussi avec d&apos;autres professions de santé partout en France. Chaque métier a sa page dédiée avec un traitement adapté à ses contraintes. Pour une vue d&apos;ensemble, rendez-vous sur la page <Link href="/site-internet-therapeute" className="text-primary underline underline-offset-2">site internet thérapeute</Link>.
                        </p>
