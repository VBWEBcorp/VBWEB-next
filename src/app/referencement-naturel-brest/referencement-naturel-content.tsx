...
interface ReferencementNaturelBrestContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelBrestContent({ faqs }: ReferencementNaturelBrestContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Brest"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Brest,{' '}
              <span className="italic text-muted-foreground/80">pour que Google travaille pour vous</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Votre site existe, mais vos clients ne le trouvent pas ? J&apos;accompagne les entreprises brestoises pour qu&apos;elles gagnent en visibilité sur Google grâce au référencement naturel. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Attirer des clients{' '}
                    <span className="italic text-muted-foreground/80">grâce à Google</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand un Brestois cherche &quot;dentiste Brest&quot; ou &quot;garage Guipavas&quot; sur Google, il tombe sur une liste de résultats. Le référencement naturel, c&apos;est le travail qui permet à votre site de figurer en haut de cette liste, sans payer de publicité.
                    </p>
                    <p>
                      Pensez-y comme un classement : Google évalue la qualité technique de votre site, la pertinence de son contenu et sa réputation en ligne. Mon rôle, c&apos;est d&apos;améliorer ces trois critères pour que votre site gagne des places et attire plus de visiteurs qualifiés.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Référencement naturel à Brest"
                      loading="lazy"
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Curieux de savoir où en est votre référencement naturel à Brest ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange', description: 'On prend le temps de comprendre votre activité à Brest, vos objectifs et les freins à votre visibilité sur Google. Je vous dis si le référencement naturel est la bonne solution pour vous.' },
                { number: '02', title: 'J\'analyse votre situation', description: 'Audit technique, analyse des mots-clés, étude de la concurrence dans le Finistère. Vous recevez un plan d\'action clair avec les priorités et le calendrier.' },
                { number: '03', title: 'On avance mois après mois', description: 'Les optimisations sont déployées progressivement. Chaque mois, vous voyez l\'évolution de vos positions Google, de votre trafic et des contacts reçus via votre site.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Pourquoi le référencement naturel est un investissement rentable">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Contrairement à la publicité Google, le référencement naturel ne vous coûte pas à chaque clic. C&apos;est un investissement : les premières semaines demandent du travail, mais une fois votre site bien positionné, il continue d&apos;attirer des visiteurs mois après mois sans coût supplémentaire. Pour une PME brestoise, c&apos;est souvent le meilleur rapport qualité-prix en acquisition de clients.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un seul interlocuteur', text: 'Je travaille sur votre projet de bout en bout.' },
                            { icon: Zap, title: 'Réactivité', text: 'Réponse dans la journée, ajustements rapides.' },
                            { icon: Target, title: 'Stratégie locale', text: 'Mots-clés ciblés sur Brest et le Finistère.' },
                            { icon: MessageCircle, title: 'Transparence totale', text: 'Accès à toutes vos données, rapport mensuel.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement naturel pour les entreprises du Finistère">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le Finistère a ses propres dynamiques économiques : activités maritimes, tourisme, agroalimentaire, technologies. Chaque secteur a ses mots-clés et ses opportunités sur Google. En connaissant le tissu local, je cible les recherches qui comptent vraiment pour votre activité.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong>, <strong>Landerneau</strong>. Je travaille aussi avec des clients à <strong>Quimper</strong>, <strong>Saint-Brieuc</strong> et <strong>Rennes</strong>.
                        </p>
