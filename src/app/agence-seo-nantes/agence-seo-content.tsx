...
interface AgenceSeoNantesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoNantesContent({ faqs }: AgenceSeoNantesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Nantes - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence SEO à Nantes :{' '}
              <span className="italic text-muted-foreground/80">pourquoi un expert dédié change tout</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Nantes regorge d&apos;agences SEO. Le choix est large. Mais si vous cherchez un accompagnement direct, sans intermédiaire, avec un expert qui connait votre dossier par coeur ? Je suis Victor Béasse, consultant SEO dans le Grand Ouest. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">sur le marché nantais</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Nantes est une métropole en pleine croissance : tech, startups, commerce, tourisme avec les Machines de l&apos;île. Le marché est dynamique mais la concurrence en ligne est forte. Vos futurs clients tapent &quot;développeur web Nantes&quot;, &quot;ostéopathe Saint-Herblain&quot; ou &quot;restaurant Nantes centre&quot; sur Google. Pour capter cette demande, votre site doit être visible.
                    </p>
                    <p>
                      Je ne vous vends pas un package standardisé. Je commence par comprendre votre positionnement, votre clientèle cible et vos concurrents nantais. Ensuite, je construis une stratégie SEO qui cible les requêtes les plus rentables pour votre activité dans la métropole.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de connaitre votre potentiel SEO sur le marché nantais ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Échange initial', description: '30 minutes pour comprendre votre activité à Nantes, vos ambitions de croissance et ce que Google peut vous apporter concrètement. Je vous donne un avis sincère sur votre potentiel SEO.' },
                { number: '02', title: 'Audit complet', description: 'Analyse technique, étude de contenu et cartographie de la concurrence dans la métropole nantaise. Vous recevez un plan d\'action priorisé avec des objectifs chiffrés et un calendrier.' },
                { number: '03', title: 'Croissance continue', description: 'Les optimisations sont déployées mois après mois. Technique, contenu, netlinking : chaque action est suivie dans votre espace dédié. On fait le point ensemble à chaque étape.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO indépendant vs agence SEO à Nantes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Nantes compte des dizaines d&apos;agences digitales et SEO. C&apos;est un marché mature. La question n&apos;est pas de savoir si les agences font du bon travail, c&apos;est de savoir quel modèle vous convient. Si vous cherchez un interlocuteur unique, des décisions rapides et une stratégie qui n&apos;est pas diluée entre 15 clients, un expert indépendant est souvent le meilleur choix.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Celui qui pense la stratégie l\'exécute.' },
                            { icon: Zap, title: 'Rapidité', text: 'Pas de comité, on décide et on avance.' },
                            { icon: Target, title: 'Vision Grand Ouest', text: 'Nantes, Rennes, et toute la façade.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Accès complet aux données et rapports.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le SEO dans la métropole nantaise">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Avec plus de 650 000 habitants dans la métropole, Nantes offre un bassin de recherche Google très large. La tech, le tourisme, le commerce et les services génèrent des volumes importants. Le potentiel est là, mais la concurrence aussi. C&apos;est pour cela qu&apos;une stratégie SEO bien pensée fait la différence.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Nantes et dans toute la métropole : <strong>Saint-Herblain</strong>, <strong>Rezé</strong>, <strong>Orvault</strong>, <strong>Carquefou</strong>, <strong>Saint-Nazaire</strong>. Le SEO local couvre l&apos;ensemble de votre zone d&apos;activité dans le Grand Ouest.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Nantes', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-nantes' },
                      { label: 'Freelance SEO Nantes', desc: 'Expert indépendant à votre service', href: '/freelance-seo-nantes' },
