...
interface FreelanceSeoSaintMaloContentProps {
  faqs: { question: string; answer: string }[]
}

export function FreelanceSeoSaintMaloContent({ faqs }: FreelanceSeoSaintMaloContentProps) {
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, freelance SEO à Saint-Malo"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Freelance SEO à Saint-Malo,{' '}
              <span className="italic text-muted-foreground/80">attirez plus de visiteurs depuis Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Saint-Malo accueille 3 millions de visiteurs par an, et la majorité prépare son séjour sur Google. Hôtels, restaurants, commerces intra-muros, activités nautiques : je vous aide à capter cette demande et à remplir votre carnet de réservations, même hors saison.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      À Saint-Malo, la concurrence sur Google est rude, surtout dans le tourisme et la restauration. J&apos;analyse votre positionnement actuel, j&apos;identifie les mots-clés que vos clients recherchent (par exemple &quot;hotel Saint-Malo intra-muros&quot; ou &quot;restaurant Saint-Malo plage&quot;), et j&apos;optimise votre site pour qu&apos;il apparaisse devant vos concurrents.
                    </p>
                    <p>
                      Votre site, c&apos;est comme une boutique dans les ruelles intra-muros. Aujourd&apos;hui, elle est peut-être cachée derrière les remparts. Mon rôle, c&apos;est de la placer face à la mer, là où passent tous les visiteurs.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Analyse SEO et stratégie de référencement pour entreprises à Saint-Malo"
                      loading="lazy"
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                ...
                { number: '02', title: 'J\'analyse votre site', description: 'Je passe votre site au peigne fin : technique, contenu, positionnement, concurrence locale à Saint-Malo. Vous recevez un plan d\'action clair avec les priorités.' },
                { number: '03', title: 'On avance ensemble', description: 'Les optimisations sont déployées mois après mois. Chaque mois, on fait le point en visio ou en personne à Saint-Malo. Vous voyez vos positions Google, votre trafic et les demandes reçues dans votre espace de suivi.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Freelance SEO vs agence à Saint-Malo">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les agences SEO généralistes ne connaissent pas forcément les spécificités du marché malouin : la saisonnalité du tourisme, la concurrence entre hôtels sur le Sillon, les pics de recherche avant l&apos;été. Avec un freelance SEO, vous travaillez avec quelqu&apos;un qui comprend ces dynamiques et qui adapte sa stratégie en conséquence.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            ...
                            { icon: Target, title: 'Sur mesure', text: 'Stratégie adaptée à la saisonnalité malouine.' },
                    ...
                    <ReadMore title="Pourquoi un freelance SEO sur la Côte d'Émeraude">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Basé à <strong>Rennes</strong>, je suis à 45 minutes de Saint-Malo et je connais bien le tissu économique de la Côte d&apos;Émeraude. J&apos;accompagne des entreprises sur tout le littoral nord-breton : hôtels, restaurants, commerces, prestataires d&apos;activités nautiques. Je sais comment les touristes cherchent sur Google quand ils préparent un séjour à Saint-Malo.
                        </p>
                        <p>
                          J&apos;interviens aussi à <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong> et <strong>Saint-Lunaire</strong>. Et bien sûr à <strong>Rennes</strong> et <strong>Saint-Brieuc</strong> pour les projets qui dépassent le cadre touristique.
                        </p>
