...
interface ReferencementNaturelVannesContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelVannesContent({ faqs }: ReferencementNaturelVannesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Vannes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Vannes,{' '}
              <span className="italic text-muted-foreground/80">votre site mérite d&apos;être trouvé</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous avez un site, mais vos clients ne vous trouvent pas sur Google ? Je vous accompagne pour améliorer votre référencement naturel à Vannes et dans le Morbihan. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
                    Le référencement naturel expliqué
                  </p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">sans publicité</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement naturel, c&apos;est ce qui fait qu&apos;un site apparaît dans les résultats Google sans payer de publicité. Quand un Vannetais cherche &quot;boulangerie Vannes centre&quot; ou &quot;plombier Séné&quot;, les sites les mieux référencés captent l&apos;essentiel des clics.
                    </p>
                    <p>
                      Mon travail consiste à faire en sorte que votre site fasse partie de ces premiers résultats. J&apos;analyse ce que vos clients cherchent sur Google, j&apos;optimise votre site pour qu&apos;il réponde à ces recherches, et je construis votre notoriété en ligne mois après mois.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Référencement naturel à Vannes"
                      loading="lazy"
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que le référencement naturel peut vous apporter à Vannes ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On fait le point', description: 'On prend 30 minutes pour comprendre votre activité à Vannes, vos objectifs et ce qui bloque votre visibilité sur Google. Je vous dis si le référencement naturel est la bonne piste pour vous.' },
                { number: '02', title: 'J\'audite votre site', description: 'J\'analyse votre positionnement actuel, vos mots-clés, la technique de votre site et la concurrence dans le Morbihan. Vous recevez un plan d\'action détaillé avec les priorités.' },
                { number: '03', title: 'On progresse mois après mois', description: 'Les optimisations sont mises en place progressivement. Chaque mois, vous suivez vos positions Google, votre trafic et les demandes de contact dans votre espace de suivi.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Référencement naturel et tourisme à Vannes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Le Golfe du Morbihan attire chaque année des centaines de milliers de visiteurs. Ces touristes préparent leur séjour en ligne : ils cherchent des restaurants, des hébergements, des activités nautiques. Le référencement naturel vous permet de capter cette demande saisonnière en vous positionnant sur les bonnes recherches avant le pic de fréquentation.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Vous travaillez directement avec moi, du début à la fin.' },
                            { icon: Zap, title: 'Anticipation', text: 'On prépare votre visibilité avant la haute saison.' },
                            { icon: Target, title: 'Mots-clés locaux', text: 'Ciblage précis sur Vannes et le Golfe du Morbihan.' },
                            { icon: MessageCircle, title: 'Suivi clair', text: 'Rapport mensuel avec positions, trafic et contacts.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Référencement naturel pour les commerces vannetais">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Les commerces du centre-ville de Vannes font face à une double concurrence : les grandes surfaces en périphérie et les boutiques en ligne. Le référencement naturel vous permet de toucher les personnes qui cherchent vos produits localement. Quand quelqu&apos;un tape &quot;bijouterie Vannes&quot; ou &quot;librairie centre Vannes&quot;, c&apos;est un client potentiel à quelques minutes de chez vous.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Vannes et dans ses environs : <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong>, <strong>Auray</strong>. Je travaille aussi à <strong>Lorient</strong> et <strong>Rennes</strong>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Vannes', 'Arradon', 'Séné', 'Theix-Noyalo', 'Sarzeau', 'Auray', 'Lorient'].map((city) => (
