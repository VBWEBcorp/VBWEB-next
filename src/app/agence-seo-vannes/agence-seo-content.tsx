...
interface AgenceSeoVannesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoVannesContent({ faqs }: AgenceSeoVannesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Vannes - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence SEO à Vannes ?{' '}
              <span className="italic text-muted-foreground/80">Travaillez directement avec un expert</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence SEO à Vannes pour développer votre visibilité sur Google. Et si vous travailliez directement avec l&apos;expert qui s&apos;occupe de votre site ? Je suis Victor Béasse, consultant SEO en Bretagne. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Du SEO concret{' '}
                    <span className="italic text-muted-foreground/80">pour votre entreprise vannetaise</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Vannes vit au rythme du Golfe du Morbihan : tourisme, nautisme, commerces de centre-ville. Vos clients cherchent sur Google des mots-clés comme &quot;restaurant Vannes&quot;, &quot;location bateau Golfe du Morbihan&quot; ou &quot;architecte Vannes&quot;. Si votre site n&apos;apparait pas dans les premiers résultats, ces clients vont chez vos concurrents.
                    </p>
                    <p>
                      Mon travail, c&apos;est de positionner votre site là où vos clients vous cherchent. Pas de discours commercial, pas de promesses floues. Un diagnostic précis, une stratégie adaptée à votre marché, et des résultats que vous pouvez suivre mois après mois.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce que le SEO peut vous apporter à Vannes ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On fait connaissance', description: 'Un échange de 30 minutes pour comprendre votre activité à Vannes, vos objectifs et vos freins actuels sur Google. Je vous dis honnêtement si le SEO est le bon levier pour vous.' },
                { number: '02', title: 'J\'audite votre site', description: 'Analyse technique, contenu, positionnement et concurrence dans le Morbihan. Vous recevez un plan d\'action clair avec les priorités pour votre marché vannetais.' },
                { number: '03', title: 'On avance mois après mois', description: 'Les optimisations sont déployées progressivement. Chaque mois, vous suivez vos positions Google, votre trafic et les demandes de contact reçues dans votre espace de suivi.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO vs agence SEO à Vannes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Quand vous confiez votre SEO à une agence, votre dossier passe souvent entre plusieurs personnes : commercial, chef de projet, rédacteur, technicien. Avec un expert indépendant, c&apos;est un seul interlocuteur qui connaît votre activité, votre marché vannetais et vos objectifs. Les échanges sont plus simples et les décisions plus rapides.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            ...
                            { icon: Target, title: 'Sur mesure', text: 'Stratégie adaptée au marché du Morbihan.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Suivi clair, données accessibles en permanence.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="SEO local à Vannes et dans le Golfe du Morbihan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Vannes bénéficie d&apos;une dynamique particulière grâce au tourisme du Golfe du Morbihan. Les recherches locales sont très nombreuses, surtout en saison. Positionner votre entreprise sur ces requêtes géolocalisées, c&apos;est capter une clientèle qui a déjà l&apos;intention d&apos;acheter.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Vannes et dans les communes voisines : <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong>, <strong>Auray</strong>. Le SEO local couvre toute votre zone d&apos;intervention.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Vannes', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-vannes' },
                      { label: 'Freelance SEO Vannes', desc: 'Expert indépendant à votre service', href: '/freelance-seo-vannes' },
