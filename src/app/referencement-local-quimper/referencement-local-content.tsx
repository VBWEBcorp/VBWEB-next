...
interface ReferencementLocalQuimperContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementLocalQuimperContent({ faqs }: ReferencementLocalQuimperContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          <div className="mx-auto max-w-3xl text-center" style={{ animation: 'hero-fade-up 0.65s cubic-bezier(0.22,1,0.36,1) both' }}>
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image src="/victor.jpg" alt="Victor Béasse, expert en référencement local à Quimper" width={96} height={96} priority className="size-full object-cover object-center" />
            </div>
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement local à Quimper :{' '}
              <span className="italic text-muted-foreground/80">attirez les clients de Cornouaille</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Artisan, commerçant ou professionnel à Quimper ? Quand vos clients tapent votre métier sur Google, c&apos;est votre concurrent qui apparaît. Je change ça. Fiche Google, avis, contenu local : je vous place dans le pack local quimpérois.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">Le référencement local en Cornouaille</p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Vos clients quimpérois vous cherchent.{' '}
                    <span className="italic text-muted-foreground/80">Est-ce qu&apos;ils vous trouvent ?</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Un habitant de Quimper qui cherche &quot;boulangerie rue Kéréon&quot; ou &quot;plombier Ergué-Gabéric&quot; tombe sur Google Maps. Trois résultats s&apos;affichent. Si vous n&apos;y êtes pas, c&apos;est votre concurrent qui récupère l&apos;appel.
                    </p>
                    <p>
                      En Cornouaille, le bouche-à-oreille reste fort, mais de plus en plus de clients passent par Google. Mon travail : faire en sorte que votre fiche Google soit irréprochable, que vos avis clients vous propulsent, et que votre site parle de Quimper aux yeux de Google.
                    </p>
                  </div>
                </Reveal>
                <Reveal delay={0.1}>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: MapPin, title: 'Google Business Profile', desc: 'Fiche optimisée de A à Z : catégories, photos de votre commerce, horaires, attributs. Votre vitrine sur Google Maps.' },
                  { icon: FileSearch, title: 'Contenu local', desc: 'Des pages qui mentionnent Quimper, Fouesnant, Bénodet naturellement. Google sait que vous êtes ici.' },
                  { icon: Star, title: 'Avis & Citations', desc: 'Un système pour collecter des avis Google réguliers et des mentions sur les annuaires de Cornouaille.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">Les premiers résultats sur Google Maps apparaissent souvent en quelques semaines.</p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez apparaître dans le top 3 Maps à Quimper ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">Trois étapes pour dominer{' '}<span className="italic text-muted-foreground/80">Google Maps en Cornouaille</span></h2>
          </Reveal>
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            <ScrollProgress />
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Audit de votre présence locale', description: 'J\'analyse votre fiche Google, vos avis, vos citations et votre positionnement actuel sur les requêtes quimpéroises. Vous savez où vous en êtes.' },
                { number: '02', title: 'Optimisation Cornouaille', description: 'Fiche Google restructurée, site optimisé pour les mots-clés locaux (Quimper, Fouesnant, Bénodet, Concarneau...) et stratégie de collecte d\'avis mise en place.' },
                { number: '03', title: 'Suivi de vos positions Maps', description: 'Chaque mois, on regarde ensemble vos positions dans le pack local. J\'ajuste la stratégie et vous voyez la progression.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Le pack local Google en Cornouaille">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Quand quelqu&apos;un cherche &quot;crêperie Quimper&quot; ou &quot;dentiste Fouesnant&quot;, Google affiche 3 résultats avec carte. C&apos;est le pack local. Pertinence de votre fiche, distance avec l&apos;utilisateur et notoriété en ligne : voilà les trois critères qui déterminent votre place.</p>
                        <p>Pour un commerce en Cornouaille, y figurer c&apos;est capter les clients qui cherchent activement vos services. Les trois premières positions récupèrent la grande majorité des clics.</p>
                      </div>
                    </ReadMore>
                    <ReadMore title="Référencement local sur Quimper et le sud Finistère">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>J&apos;interviens sur Quimper et tout le sud Finistère. Que vos clients soient à Ergué-Gabéric, Pluguffan, Fouesnant ou Concarneau, j&apos;adapte votre visibilité pour couvrir votre zone de chalandise.</p>
                        <div className="flex flex-wrap gap-2">
                          {['Quimper', 'Ergué-Gabéric', 'Pluguffan', 'Fouesnant', 'Bénodet', 'Concarneau', 'Douarnenez', 'Brest', 'Lorient', 'Rennes'].map((city) => (
      ...
      <section className="relative overflow-hidden bg-card">
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl">Référencement local à Quimper :{' '}<span className="italic text-muted-foreground/80">vos questions</span></h2>
          </Reveal>
