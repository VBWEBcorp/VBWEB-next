...
interface AgenceReferencementVannesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementVannesContent({ faqs }: AgenceReferencementVannesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Vannes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Vannes :{' '}
              <span className="italic text-muted-foreground/80">un expert dédié à votre visibilité</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Vannes ? Je suis Victor Béasse, expert SEO basé en Bretagne. J&apos;accompagne les entreprises du Morbihan pour qu&apos;elles gagnent en visibilité sur Google. Un interlocuteur unique, une stratégie claire, des résultats mesurables. Plus de 200 projets menés et 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Ce que je fais{' '}
                    <span className="italic text-muted-foreground/80">pour votre site à Vannes</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement, c&apos;est ce qui fait que votre site apparaît quand un client tape &quot;restaurant Vannes&quot; ou &quot;plombier Morbihan&quot; sur Google. J&apos;analyse votre positionnement, j&apos;identifie les mots-clés que vos prospects utilisent, et j&apos;optimise chaque page pour que vous remontiez dans les résultats.
                    </p>
                    <p>
                      À Vannes, le tissu économique mêle tourisme saisonnier, commerces du centre historique et entreprises du bassin morbihannais. Le référencement vous permet de capter ces différentes audiences toute l&apos;année, pas seulement pendant la saison estivale.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Stratégie de référencement pour les entreprises à Vannes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site rapide, bien structuré et lisible par les moteurs de recherche.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages qui répondent aux questions de vos clients vannetais.' },
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Les premiers résultats arrivent en général entre 3 et 6 mois, puis la progression s&apos;accélère avec le temps.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir ce que le référencement peut changer pour votre entreprise ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier échange', description: 'On prend 30 minutes pour comprendre votre activité, vos objectifs et ce qui bloque votre visibilité. En visio ou à Vannes, selon ce qui vous arrange.' },
                { number: '02', title: 'Audit et plan d\'action', description: 'Je passe votre site au crible : technique, contenu, positionnement face à vos concurrents dans le Morbihan. Vous recevez un plan d\'action concret avec les priorités.' },
                { number: '03', title: 'Optimisation continue', description: 'Chaque mois, des optimisations sont déployées et vous suivez la progression : positions Google, trafic, demandes de contact. Tout est transparent.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert référencement vs agence à Vannes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>À Vannes, plusieurs agences web proposent du référencement parmi d&apos;autres services. La différence avec un expert indépendant : vous parlez directement à celui qui optimise votre site. Pas de process complexe, pas de réunions inutiles. Le travail avance vite et vous savez exactement ce qui est fait.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Une seule personne qui maîtrise votre dossier.' },
                            { icon: Zap, title: 'Réactivité', text: 'Réponse dans la journée, ajustements rapides.' },
                            { icon: Target, title: 'Stratégie locale', text: 'Connaissance du marché morbihannais.' },
                            { icon: MessageCircle, title: 'Transparence totale', text: 'Rapport mensuel, accès complet aux données.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Référencement naturel dans le Morbihan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le Morbihan combine tourisme, commerce local et services aux entreprises. Chaque secteur a ses pics de recherche et ses mots-clés spécifiques. Un bon référencement tient compte de ces particularités pour maximiser votre visibilité au bon moment.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Vannes et dans les communes voisines : <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong>, <strong>Auray</strong>. Je travaille aussi avec des clients dans tout le Morbihan et en Bretagne.
                        </p>
