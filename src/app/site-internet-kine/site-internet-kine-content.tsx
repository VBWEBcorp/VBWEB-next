...
interface SiteInternetKineContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetKineContent({ faqs }: SiteInternetKineContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour kiné"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Site internet kiné,{' '}
              <span className="italic text-muted-foreground/80">pour remplir votre planning sans effort</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO et créateur de sites internet. Je crée des sites pour les kinésithérapeutes partout en France : un site clair avec prise de rendez-vous en ligne, bien positionné sur &quot;kiné près de chez moi&quot; et vos spécialités. Plus de 150 sites créés.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">pendant vos séances</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      La kinésithérapie est un métier de contact, mais la première rencontre se joue souvent sur Google. Un patient avec une tendinite ou des douleurs lombaires cherche un kiné dans son quartier, consulte trois ou quatre résultats, puis choisit. Mon travail, c&apos;est de construire un site qui vous place parmi ces premiers choix, avec une présentation claire de vos spécialités.
                    </p>
                    <p>
                      Je connais les contraintes du métier : peu de temps entre les patients, envie de rester concentré sur le soin. Je construis donc un site qui vit sans que vous ayez à y toucher : vos créneaux se remplissent via Doctolib ou Maiia, et Google fait son travail en arrière-plan.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour kiné"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Vos spécialités', desc: 'Sport, périnée, respiratoire, Mézières : chaque expertise a sa page dédiée.' },
                  { icon: Zap, title: 'Agenda intégré', desc: 'Doctolib, Maiia ou autre outil de prise de rendez-vous, intégré au site.' },
                  { icon: MapPin, title: 'Trouvé localement', desc: '"Kiné près de chez moi" et Google Maps optimisés pour votre quartier.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Site conforme aux règles de l&apos;Ordre des Masseurs-Kinésithérapeutes : informatif, factuel, sans promesse.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">pas du blabla</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie d&apos;un site kiné qui remplit votre agenda ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              En trois étapes,{' '}
              <span className="italic text-muted-foreground/80">votre site est en ligne</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Brief de votre pratique', description: 'On échange sur vos spécialités, votre patientèle et votre cabinet. Je comprends votre métier avant d\'esquisser une seule page.' },
                { number: '02', title: 'Création du site', description: 'Maquettes, rédaction conforme, intégration de votre agenda Doctolib ou Maiia, optimisation pour "kiné + votre ville". Vous validez chaque étape.' },
                { number: '03', title: 'Mise en ligne et autonomie', description: 'Formation à l\'interface, mise en ligne, optimisation Google Business Profile. Vous gardez la main sur votre site au quotidien.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Mettre en avant vos spécialités sans enfreindre les règles">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          L&apos;Ordre des Masseurs-Kinésithérapeutes autorise la mention des spécialisations, à condition qu&apos;elles reposent sur une formation avérée et qu&apos;elles ne sous-entendent pas une supériorité sur les autres kinés. Voici comment je construis une page &quot;spécialités&quot; qui fonctionne sans jamais sortir du cadre.
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Kiné du sport', text: 'Rééducation post-traumatique, préparation athlétique.' },
                            { icon: Target, title: 'Périnée', text: 'Rééducation post-partum, hypopression, incontinence.' },
                            { icon: Zap, title: 'Respiratoire', text: 'Bronchiolite du nourrisson, BPCO, drainage.' },
                            { icon: MessageCircle, title: 'Méthodes', text: 'Mézières, McKenzie, Mulligan et autres approches.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Autres professions de santé accompagnées">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Si vous êtes kiné, vous partagez souvent des cabinets ou des réseaux avec d&apos;autres professions de santé. J&apos;ai créé des pages dédiées pour chaque métier que j&apos;accompagne. Pour une vision d&apos;ensemble, rendez-vous sur la page <Link href="/site-internet-therapeute" className="text-primary underline underline-offset-2">site internet thérapeute</Link>.
                        </p>
