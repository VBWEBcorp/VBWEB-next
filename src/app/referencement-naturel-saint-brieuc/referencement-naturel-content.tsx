...
interface ReferencementNaturelSaintBrieucContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelSaintBrieucContent({ faqs }: ReferencementNaturelSaintBrieucContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Saint-Brieuc"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Saint-Brieuc,{' '}
              <span className="italic text-muted-foreground/80">attirez vos clients grâce à Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Votre site web ne vous apporte pas de clients ? Le référencement naturel y remédie. J&apos;accompagne les entreprises de Saint-Brieuc et des Côtes-d&apos;Armor pour gagner en visibilité sur Google. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Google est votre meilleur commercial,{' '}
                    <span className="italic text-muted-foreground/80">encore faut-il qu&apos;il vous connaisse</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Chaque jour, des centaines de personnes à Saint-Brieuc cherchent des services sur Google. &quot;Coiffeur Saint-Brieuc&quot;, &quot;comptable Côtes-d&apos;Armor&quot;, &quot;restaurant Plérin&quot;. Le référencement naturel, c&apos;est le travail qui fait que votre site apparaît dans ces résultats. Pas grâce à la publicité, mais grâce à un site bien construit, avec le bon contenu et une bonne réputation en ligne.
                    </p>
                    <p>
                      C&apos;est comme avoir un bon emplacement en ville : sauf que sur Google, le bon emplacement se construit avec de la méthode, pas avec un bail commercial. Et une fois acquis, il vous appartient.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Référencement naturel à Saint-Brieuc"
                      loading="lazy"
                      width={800}
                      height={600}
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Curieux de savoir ce que Google pense de votre site ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Échange initial', description: 'On prend le temps de comprendre votre activité à Saint-Brieuc, ce que vous cherchez et ce qui bloque votre visibilité sur Google. Je vous donne mon avis sincère sur le potentiel du référencement naturel pour vous.' },
                { number: '02', title: 'Analyse approfondie', description: 'Audit technique, étude des mots-clés, analyse de la concurrence dans les Côtes-d\'Armor. Vous recevez un plan d\'action avec les actions prioritaires et un calendrier réaliste.' },
                { number: '03', title: 'Résultats mois après mois', description: 'Les optimisations sont déployées progressivement. Vous suivez vos positions Google, votre trafic et vos contacts reçus dans un espace de suivi accessible à tout moment.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Référencement naturel vs publicité : que choisir à Saint-Brieuc ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>La publicité Google Ads vous donne une visibilité immédiate, mais temporaire : dès que vous arrêtez de payer, vous disparaissez. Le référencement naturel construit une visibilité pérenne. Les deux peuvent se combiner, mais pour la plupart des entreprises briochines, le référencement naturel offre le meilleur retour sur investissement à moyen terme.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Un seul interlocuteur du début à la fin.' },
                            { icon: Zap, title: 'ROI durable', text: 'Le trafic continue sans coût par clic.' },
                            { icon: Target, title: 'Ciblage précis', text: 'Mots-clés adaptés à Saint-Brieuc et ses environs.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Rapport mensuel avec tous les indicateurs.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement naturel dans les Côtes-d'Armor">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Les Côtes-d&apos;Armor offrent un terrain favorable pour le référencement naturel : la concurrence en ligne y est souvent plus modérée que dans les grandes métropoles. Les entreprises qui investissent dans leur visibilité Google ont un vrai avantage concurrentiel, parce que beaucoup de leurs confrères ne l&apos;ont pas encore fait.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à <strong>Plérin</strong>, <strong>Langueux</strong>, <strong>Trégueux</strong>, <strong>Lamballe</strong>, <strong>Ploufragan</strong>. Je travaille aussi avec des clients à <strong>Rennes</strong>, <strong>Saint-Malo</strong> et <strong>Brest</strong>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Saint-Brieuc', 'Plérin', 'Langueux', 'Trégueux', 'Lamballe', 'Ploufragan', 'Rennes'].map((city) => (
