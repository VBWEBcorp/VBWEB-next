              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80" alt="Référencement local à Saint-Brieuc" loading="lazy" className="aspect-[4/3] w-full object-cover" />
