...
interface ReferencementNaturelSaintMaloContentProps {
  faqs: { question: string; answer: string }[]
}

export function ReferencementNaturelSaintMaloContent({ faqs }: ReferencementNaturelSaintMaloContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement naturel à Saint-Malo"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Référencement naturel à Saint-Malo,{' '}
              <span className="italic text-muted-foreground/80">captez les clients qui vous cherchent</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Des millions de visiteurs chaque année, et la plupart préparent leur venue sur Google. Le référencement naturel vous rend visible au bon moment. J&apos;accompagne les entreprises malouines vers les premières positions. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
                    Le référencement naturel à Saint-Malo
                  </p>
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Votre vitrine sur Google,{' '}
                    <span className="italic text-muted-foreground/80">ouverte 24h/24</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Saint-Malo vit du tourisme, de la gastronomie, du commerce. Et vos futurs clients commencent tous par la même chose : une recherche Google. &quot;Hotel vue mer Saint-Malo&quot;, &quot;crêperie intra-muros&quot;, &quot;activité nautique côte d&apos;Émeraude&quot;. Le référencement naturel fait en sorte que votre site apparaisse dans ces résultats, sans payer de publicité.
                    </p>
                    <p>
                      Concrètement, j&apos;identifie les recherches qui comptent pour votre activité, j&apos;optimise votre site pour qu&apos;il plaise à Google, et je développe votre présence en ligne pour que votre site gagne en autorité.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Référencement naturel à Saint-Malo"
                      loading="lazy"
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir si votre site est bien positionné à Saint-Malo ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On se rencontre', description: 'On prend le temps de comprendre votre activité à Saint-Malo, vos objectifs et ce que vos clients cherchent sur Google. Je vous dis clairement si le référencement naturel peut vous aider.' },
                { number: '02', title: 'Diagnostic complet', description: 'J\'analyse votre site, vos positions actuelles, les mots-clés pertinents et la concurrence sur la côte d\'Émeraude. Vous recevez un plan d\'action avec les priorités.' },
                { number: '03', title: 'Résultats progressifs', description: 'Les optimisations sont déployées mois après mois. Vous voyez l\'évolution en temps réel : positions Google, trafic du site et demandes de contact reçues.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Référencement naturel et saisonnalité touristique">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Saint-Malo connaît un pic de recherches Google entre avril et septembre. Les touristes cherchent leur hébergement, leurs restaurants, leurs activités plusieurs semaines avant leur séjour. Le référencement naturel se prépare en amont : on optimise votre site pendant la basse saison pour récolter les fruits quand l&apos;affluence arrive.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un seul contact', text: 'Pas d\'intermédiaire, vous travaillez avec moi.' },
                            { icon: Zap, title: 'Anticipation', text: 'Préparation en basse saison pour la haute saison.' },
                            { icon: Target, title: 'Ciblage touristique', text: 'Mots-clés liés aux séjours et activités.' },
                            { icon: MessageCircle, title: 'Suivi mensuel', text: 'Rapport avec positions, trafic et contacts.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement naturel sur la côte d'Émeraude">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          La côte d&apos;Émeraude ne se limite pas à Saint-Malo intra-muros. Dinard, Cancale, Saint-Lunaire, Dol-de-Bretagne : chaque commune a ses recherches Google et ses opportunités. Le référencement naturel vous permet de couvrir l&apos;ensemble de votre zone de chalandise avec des contenus ciblés.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong>, <strong>Saint-Lunaire</strong>. Je travaille aussi avec des clients à <strong>Rennes</strong> et <strong>Saint-Brieuc</strong>.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Saint-Malo', 'Dinard', 'Dinan', 'Cancale', 'Dol-de-Bretagne', 'Saint-Lunaire', 'Rennes'].map((city) => (
