...
interface SiteInternetAvocatContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetAvocatContent({ faqs }: SiteInternetAvocatContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour avocat"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">sérieux, conforme, et trouvé sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je conçois des sites internet pour avocats partout en France. Image soignée, respect de la déontologie CNB, confidentialité absolue des échanges, et un vrai travail de référencement naturel pour attirer des clients sur des requêtes comme &quot;avocat divorce&quot; ou &quot;avocat droit du travail&quot;.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site à la fois{' '}
                    <span className="italic text-muted-foreground/80">sérieux et visible</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Un avocat ne peut pas s&apos;afficher comme un commerçant. Votre site internet doit inspirer le sérieux, respecter le Règlement intérieur national du CNB, et protéger la confidentialité des personnes qui vous contactent. Je connais ces règles et je les intègre dès la première maquette : pas de témoignages clients nominatifs, pas de comparatifs, pas de promesses de résultat.
                    </p>
                    <p>
                      Mais un site sérieux ne sert à rien s&apos;il n&apos;est jamais trouvé. C&apos;est là que ma double casquette change la donne. Je développe des sites rapides, accessibles, conformes au RGPD, et je les optimise pour apparaître sur les requêtes que vos futurs clients tapent vraiment. Le résultat : un site qui fait honneur à votre robe et qui remplit votre agenda.
                    </p>
                    <p>
                      Que vous soyez seul à votre compte ou à la tête d&apos;un cabinet, j&apos;interviens partout en France. Le travail se fait à distance, avec des points réguliers en visioconférence et une transparence totale sur l&apos;avancement.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour avocat"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Conformité', desc: 'Respect du RIN, RGPD, mentions obligatoires, confidentialité des échanges.' },
                  { icon: FileSearch, title: 'Image', desc: 'Sobriété, typographie classique, photos professionnelles, rendu mobile soigné.' },
                  { icon: TrendingUp, title: 'SEO', desc: 'Positionnement sur vos domaines de compétence et votre ville d\'exercice.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site d&apos;avocat bien pensé commence à générer des demandes qualifiées dès les premiers mois en ligne.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce qu&apos;un site bien pensé peut apporter à votre cabinet ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">voilà comment on avance</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On cadre votre cabinet', description: 'Nous prenons 30 minutes pour parler de vos domaines de compétence, de votre clientèle cible et de l\'image que vous voulez renvoyer. Je vérifie avec vous les contraintes déontologiques propres à votre barreau.' },
                { number: '02', title: 'Je conçois le site', description: 'Maquette, rédaction des pages de compétence, intégration du formulaire de contact sécurisé, mise en conformité RGPD. Vous validez chaque étape avant passage à la suivante.' },
                { number: '03', title: 'Mise en ligne et référencement', description: 'Le site est publié, puis je travaille le référencement sur les requêtes juridiques pertinentes. Vous suivez votre trafic et vos demandes de contact dans un espace dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Déontologie, RGPD et confidentialité : les règles à connaître">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Créer un site internet avocat, ce n&apos;est pas créer un site vitrine comme un autre. Le RIN encadre la publicité des avocats : pas de comparatif, pas de témoignage nominatif, pas de promesse chiffrée. Les mentions obligatoires (barreau, numéro de toque, RCP, maniement de fonds) doivent apparaître clairement.</p>
                        <p>Côté RGPD, c&apos;est encore plus strict. Un avocat traite des données sensibles dès le premier formulaire rempli. Hébergement en Europe, chiffrement des échanges, politique de confidentialité détaillée, registre des traitements : tout est prévu dès le départ.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'RIN respecté', text: 'Publicité conforme au Règlement CNB.' },
                            { icon: Zap, title: 'RGPD complet', text: 'Bannière, politique, hébergement UE.' },
                            { icon: Target, title: 'Confidentialité', text: 'Formulaire chiffré, pas de fuite.' },
                            { icon: MessageCircle, title: 'Mentions légales', text: 'Barreau, toque, RCP affichés.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Je crée aussi des sites pour d'autres professions juridiques">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Les avocats ne sont pas les seuls à avoir besoin d&apos;un site sérieux et bien référencé. J&apos;accompagne également d&apos;autres professions du droit, partout en France, avec la même exigence de conformité et de qualité.
                        </p>
                        <p>
                          Si vous êtes notaire ou commissaire de justice, vous trouverez des pages dédiées à vos enjeux spécifiques :
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          <Link href="/site-internet-notaire" className="group flex items-start gap-3 rounded-xl border border-border/40 bg-background/30 p-4 transition-colors hover:border-primary/30 hover:bg-background/50">
                            ...
                            <div>
                              ...
                              <p className="mt-0.5 text-[13px] text-muted-foreground">Image institutionnelle, immobilier, succession, donation.</p>
                            </div>
                          </Link>
                          <Link href="/site-internet-huissier" className="group flex items-start gap-3 rounded-xl border border-border/40 bg-background/30 p-4 transition-colors hover:border-primary/30 hover:bg-background/50">
                            ...
                            <div>
                              ...
                              <p className="mt-0.5 text-[13px] text-muted-foreground">Commissaire de justice, constat, recouvrement, signification.</p>
                            </div>
                          </Link>
                        </div>
                        <p>
                          Que vous exerciez à Paris, Lyon, Bordeaux, Marseille, Lille ou ailleurs en France, la méthode reste la même : écoute, conformité, image sérieuse, et référencement naturel travaillé sur le long terme.
                        </p>
                      </div>
                    </ReadMore>
                  </div>
