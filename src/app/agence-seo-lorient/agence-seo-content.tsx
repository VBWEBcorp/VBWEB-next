...
interface AgenceSeoLorientContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceSeoLorientContent({ faqs }: AgenceSeoLorientContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert SEO à Lorient - alternative à une agence SEO"
                width={96}
                height={96}
                priority
            ...
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence SEO à Lorient pour améliorer votre positionnement Google. Je suis Victor Béasse, consultant SEO indépendant. Je vous propose un accompagnement direct, sans intermédiaire, adapté aux réalités du pays de Lorient. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Rendre votre entreprise{' '}
                    <span className="italic text-muted-foreground/80">visible sur Google à Lorient</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Lorient est une ville tournée vers la mer : pêche, nautisme, Cité de la Voile, industries maritimes. Mais vos clients ne vous cherchent pas au port. Ils tapent &quot;poissonnier Lorient&quot;, &quot;garagiste Lanester&quot; ou &quot;location vacances Larmor-Plage&quot; sur leur téléphone. Si votre site n&apos;apparait pas, c&apos;est un concurrent qui récupère le client.
                    </p>
                    <p>
                      Je travaille avec vous pour identifier les requêtes qui comptent dans votre secteur et positionner votre site dessus. Un travail de fond, méthodique, avec des résultats que vous pouvez vérifier chaque mois.
                    </p>
                  </div>
                </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Curieux de savoir ce que le SEO peut apporter à votre entreprise lorientaise ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On se parle', description: '30 minutes pour comprendre votre activité à Lorient, vos objectifs de croissance et les freins que vous rencontrez sur Google. Je vous dis clairement si le SEO est adapté à votre situation.' },
                { number: '02', title: 'Diagnostic complet', description: 'Audit technique, analyse de contenu et étude de votre concurrence dans le pays de Lorient. Vous recevez un plan d\'action avec les priorités et un calendrier réaliste.' },
                { number: '03', title: 'Progression continue', description: 'Les optimisations sont mises en place au fil des mois. Vous suivez vos positions Google, votre trafic et les contacts générés dans votre espace de suivi personnel.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Travailler avec un expert SEO vs une agence à Lorient">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Une agence SEO fonctionne avec des process standardisés et plusieurs interlocuteurs. Un expert indépendant, c&apos;est une personne qui s&apos;investit dans votre projet comme si c&apos;était le sien. À Lorient, où les entreprises valorisent la proximité et la confiance, cette approche fait souvent la différence.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un seul interlocuteur', text: 'Celui qui analyse est celui qui optimise.' },
                            { icon: Zap, title: 'Décisions rapides', text: 'Pas de validation en chaine, on avance.' },
                            { icon: Target, title: 'Connaissance locale', text: 'Stratégie adaptée au Morbihan.' },
                            { icon: MessageCircle, title: 'Suivi transparent', text: 'Vos données, accessibles en permanence.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement local dans le pays de Lorient">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Lorient et son agglomération forment un bassin de vie dynamique entre pêche, industrie et tourisme côtier. Les recherches locales sont nombreuses et variées. Positionner votre entreprise sur les bonnes requêtes, c&apos;est intercepter des clients au moment où ils ont besoin de vous.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Lorient et dans les communes voisines : <strong>Lanester</strong>, <strong>Hennebont</strong>, <strong>Ploemeur</strong>, <strong>Larmor-Plage</strong>, <strong>Quéven</strong>. Le SEO local couvre toute votre zone d&apos;activité.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Consultant SEO Lorient', desc: 'Accompagnement SEO personnalisé', href: '/consultant-seo-lorient' },
                      { label: 'Freelance SEO Lorient', desc: 'Expert indépendant à votre service', href: '/freelance-seo-lorient' },
