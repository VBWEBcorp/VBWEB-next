...
export function CreationSiteInternetSaintMaloContent({ faqs }: CreationSiteInternetContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet à Saint-Malo"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pour capter locaux et touristes via Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je crée des sites à Saint-Malo qui transforment vos visiteurs en clients et en réservations. Design soigné, performance technique et référencement intégré dès les premiers pixels. Plus de 150 sites livrés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    À Saint-Malo, un site{' '}
                    <span className="italic text-muted-foreground/80">doit travailler toute l&apos;année</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      La particularité de Saint-Malo, c&apos;est son double public : les habitants toute l&apos;année et les touristes qui débarquent en saison. Un site efficace doit capter les deux. Je le structure pour qu&apos;il sorte sur les requêtes locales (&quot;artisan Saint-Malo&quot;) mais aussi touristiques (&quot;hôtel bord de mer Saint-Malo&quot;).
                    </p>
                    <p>
                      Voyez votre site comme un fort : bien planté, visible de loin, impossible à contourner. Mon travail, c&apos;est de poser les pierres dans le bon ordre, sur les bonnes fondations, pour que Google le remarque et pointe vos visiteurs vers vous.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création de site internet à Saint-Malo"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Design maîtrisé', desc: 'Une interface élégante qui met en valeur votre activité malouine.' },
                  { icon: Zap, title: 'Chargement éclair', desc: 'Un site qui s\'affiche avant que votre visiteur ait le temps de cligner.' },
                  { icon: FileSearch, title: 'SEO préparé', desc: 'Des pages pensées pour sortir sur les requêtes locales et touristiques.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Le projet est livré en 3 à 5 semaines, et la progression sur Google démarre dès la mise en ligne.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Pas des promesses,{' '}
              <span className="italic text-muted-foreground/80">juste des chiffres</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de voir ce qu&apos;un site bien conçu peut faire pour votre activité malouine ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage du projet', description: 'Un premier échange pour comprendre votre activité à Saint-Malo, la saisonnalité de votre business et vos objectifs précis. Je regarde vos concurrents directs et les requêtes sur lesquelles vous devriez apparaître.' },
                { number: '02', title: 'Design et développement', description: 'Je dessine les maquettes, on les ajuste, puis je développe le site. Vous suivez l\'avancement sur un lien dédié qui se met à jour à chaque modification. Vous n\'attendez pas une livraison finale pour voir le résultat.' },
                { number: '03', title: 'Mise en ligne et SEO', description: 'Le site passe en production avec tous les outils connectés : Search Console, Analytics, balisage structuré, sitemap. Dès le premier jour, Google sait qui vous êtes et sur quoi vous positionner.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Le piège des sites vitrines classiques à Saint-Malo">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Beaucoup d&apos;hôtels, restaurants et commerces malouins ont un site purement décoratif. Résultat : aucun trafic, aucune réservation en dehors des plateformes qui prennent 18% de commission. Je crée des sites qui vous rendent autonome, qui captent du trafic direct et qui réduisent votre dépendance à Booking et consorts.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Proximité', text: 'Je suis à 50 minutes de Saint-Malo.' },
                            { icon: Zap, title: 'Vitesse', text: 'Des pages prêtes avant que vos visiteurs blinquent.' },
                            { icon: Target, title: 'Sur mesure', text: 'Aucun template, que du code adapté à vous.' },
                            { icon: MessageCircle, title: 'Franc', text: 'Je vous dis ce qui marche et ce qui est inutile.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Création de site et visibilité locale sur la Côte d&apos;Émeraude">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Sur la Côte d&apos;Émeraude, le marché est concurrentiel. Un site qui ne sort pas sur &quot;restaurant Saint-Malo&quot; ou &quot;hôtel Dinard&quot; perd beaucoup de business. Je travaille dès la création sur la structure SEO locale, la fiche Google Business Profile et les signaux de proximité.
                        </p>
                        <p>
                          J&apos;accompagne des activités à <strong>Saint-Malo</strong>, <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong> et <strong>Saint-Lunaire</strong>.
                        </p>
