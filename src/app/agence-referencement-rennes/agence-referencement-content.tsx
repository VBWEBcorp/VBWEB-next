...
interface AgenceReferencementRennesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementRennesContent({ faqs }: AgenceReferencementRennesContentProps) {
  ...
  return (
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Rennes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence de référencement à Rennes :{' '}
              <span className="italic text-muted-foreground/80">et si vous travailliez directement avec l&apos;expert ?</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Rennes pour gagner en visibilité sur Google. Je suis Victor Béasse, consultant en référencement basé à Rennes. Je fais le même travail qu&apos;une agence, mais vous travaillez directement avec la personne qui s&apos;occupe de votre site. Plus de 200 projets menés et 75 avis 5 étoiles.
            </p>
      ...
      {/* ══ CE QUE COUVRE LE RÉFÉRENCEMENT ══ */}
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un travail complet{' '}
                    <span className="italic text-muted-foreground/80">pour être trouvé sur Google</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement, c&apos;est plus large que le SEO au sens strict. Cela englobe tout ce qui permet à votre site d&apos;apparaitre dans les résultats de Google : la technique, le contenu, la notoriété, mais aussi le référencement local sur Google Maps et la stratégie de mots-clés adaptée à votre zone de chalandise.
                    </p>
                    <p>
                      Quand un habitant de Rennes tape &quot;plombier proche de moi&quot; ou &quot;restaurant Cesson-Sévigné&quot;, votre site doit sortir dans les premiers résultats. C&apos;est exactement ce que je construis pour mes clients, projet après projet.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      src="https://pub-698f857760da42999dac8854114fbc41.r2.dev/unsplash-photo-1551288049-bebda4e38f71-w800.webp"
                      alt="Tableau de bord de référencement et suivi de positionnement Google pour une entreprise à Rennes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: FileSearch, title: 'Référencement technique', desc: 'Votre site doit être rapide, bien structuré et parfaitement lisible par les moteurs de recherche.' },
                  { icon: Target, title: 'Référencement de contenu', desc: 'Chaque page cible les mots-clés que vos clients tapent réellement sur Google.' },
                  { icon: MapPin, title: 'Référencement local', desc: 'Fiche Google, avis clients, citations locales : tout ce qui vous rend visible à Rennes et alentours.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Le référencement est un investissement qui prend de la valeur avec le temps. Les premiers résultats se voient entre 3 et 6 mois.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">pas des discours</span>
            </h2>
          </Reveal>
          ...
          <div className="mt-14 grid gap-5 sm:grid-cols-3">
            ...
            <Reveal delay={0.1} className="rounded-[1.35rem] border border-border/60 bg-background/50 p-8 text-center">
              ...
              <p className="mt-2 text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground/60">projets référencement</p>
            </Reveal>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
              Résultats de référencement à Rennes
            </p>
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">que j&apos;ai accompagnées</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Votre site mérite un meilleur référencement. On en parle ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">votre référencement</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Diagnostic complet', description: 'J\'audite votre site sous tous les angles : technique, contenu, positionnement actuel, concurrence locale. Vous repartez avec une vision claire de votre situation et des leviers prioritaires.' },
                { number: '02', title: 'Plan de référencement', description: 'Je construis une stratégie de référencement adaptée à votre activité et à votre zone géographique. Quels mots-clés cibler, quelles pages créer ou retravailler, quel calendrier suivre.' },
                { number: '03', title: 'Déploiement et suivi', description: 'Les optimisations sont mises en place mois après mois. Vous suivez vos positions Google, votre trafic et les demandes reçues depuis votre espace de suivi dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence de référencement ou consultant : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Les agences de référencement emploient des équipes : commerciaux, chefs de projet, consultants juniors et seniors. Votre dossier circule entre plusieurs mains. Avec un consultant indépendant, la chaine est courte. Vous parlez à la personne qui travaille sur votre site, point final.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'Pas de turnover, pas de passage de relais.' },
                            { icon: Zap, title: 'Décisions rapides', text: 'Pas de validation en cascade.' },
                            { icon: Target, title: 'Stratégie sur mesure', text: 'Adaptée à votre marché local.' },
                            { icon: MessageCircle, title: 'Transparence totale', text: 'Accès complet à vos données et résultats.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement à Rennes : un marché local qui a ses spécificités">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Rennes est une métropole en croissance, avec un tissu économique dense de PME, artisans et commerces. Le référencement local y est particulièrement important : les recherches géolocalisées représentent une part croissante du trafic Google.
                        </p>
                        <p>
                          Je travaille avec des entreprises dans toute la métropole rennaise : <strong>Cesson-Sévigné</strong>, <strong>Saint-Grégoire</strong>, <strong>Bruz</strong>, <strong>Chantepie</strong>, <strong>Pacé</strong>. La connaissance du terrain local fait la différence pour cibler les bons mots-clés et les bonnes zones.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      ...
                      { label: 'Freelance SEO', desc: 'Accompagnement SEO sur mesure', href: '/freelance-seo-rennes' },
      ...
      <section className="relative overflow-hidden bg-card">
        ...
        <div className="relative mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <Reveal delay={0.3} className="mt-10 text-center">
            <p className="text-[15px] text-muted-foreground">Une question sur le référencement de votre site ?</p>
