...
interface SiteInternetSophrologueContentProps {
  faqs: { question: string; answer: string }[]
}

export function SiteInternetSophrologueContent({ faqs }: SiteInternetSophrologueContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet pour sophrologue"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Site internet sophrologue,{' '}
              <span className="italic text-muted-foreground/80">pour expliquer votre méthode et remplir votre agenda</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, consultant SEO et créateur de sites internet. Je crée des sites pour les sophrologues partout en France : un site pédagogique qui explique la sophrologie, met en avant vos thématiques (stress, sommeil, accouchement) et facilite la prise de rendez-vous. Plus de 150 sites créés.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un site qui fait connaître{' '}
                    <span className="italic text-muted-foreground/80">votre pratique et votre méthode</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      La sophrologie, beaucoup en ont entendu parler sans vraiment savoir ce que c&apos;est. Votre rôle est déjà pédagogique en cabinet, et votre site doit l&apos;être aussi. Mon travail, c&apos;est de transformer votre approche en pages claires qui donnent envie d&apos;essayer, sans jargon et sans promesse excessive.
                    </p>
                    <p>
                      Je construis aussi une stratégie de mots-clés précise : &quot;sophrologue stress&quot;, &quot;sophrologue préparation accouchement&quot;, &quot;sophrologue sommeil&quot;. Chaque thématique devient une porte d&apos;entrée vers votre cabinet. C&apos;est ce qui fait la différence entre un site vitrine statique et un site qui vous amène des rendez-vous chaque semaine.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Création site internet pour sophrologue"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: MessageCircle, title: 'Méthode expliquée', desc: 'Ce qu\'est vraiment la sophrologie, avec des mots simples et concrets.' },
                  { icon: Target, title: 'Pages thématiques', desc: 'Stress, sommeil, accouchement, sportifs : une page par besoin clair.' },
                  { icon: Zap, title: 'Prise de RDV', desc: 'Calendly, Crénolibre ou formulaire intégré, au choix selon votre besoin.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Ton juste, sans promesse thérapeutique, dans le respect des bonnes pratiques des syndicats de sophrologie.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">des résultats qui se voient</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Prêt à faire connaître votre pratique en ligne ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On pose votre positionnement', description: 'On échange sur votre pratique, votre formation, les publics que vous accompagnez et les thématiques que vous voulez mettre en avant. C\'est la clé pour un site qui vous ressemble.' },
                { number: '02', title: 'Création et rédaction', description: 'Je construis les maquettes, rédige les pages thématiques, intègre la prise de rendez-vous et prépare le référencement. Vous validez tout avant mise en ligne.' },
                { number: '03', title: 'Mise en ligne et suivi', description: 'Votre site est en ligne, votre fiche Google Business Profile est optimisée, et je vous forme à l\'interface pour que vous puissiez publier des articles et modifier vos contenus.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Construire une stratégie de contenu par thématique">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          En sophrologie, les demandes sont très variées : une jeune maman qui prépare son accouchement, un cadre en burn-out, un sportif qui veut améliorer sa concentration, une personne qui n&apos;arrive plus à dormir. Un site qui parle à chacun de ces profils avec sa propre page performera bien mieux qu&apos;une seule page fourre-tout.
                        </p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Gestion du stress', text: 'Burn-out, anxiété, charge mentale, retour au calme.' },
                            { icon: Target, title: 'Sommeil', text: 'Insomnies, endormissement, qualité du repos.' },
                            { icon: Zap, title: 'Accouchement', text: 'Préparation à la naissance, gestion de la douleur.' },
                            { icon: MessageCircle, title: 'Sportifs', text: 'Concentration, confiance, préparation mentale.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Autres professions de santé accompagnées">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Je travaille aussi avec d&apos;autres professions du soin et du bien-être partout en France. Chaque métier a sa propre page avec un contenu adapté. Pour une vision globale, rendez-vous sur la page <Link href="/site-internet-therapeute" className="text-primary underline underline-offset-2">site internet thérapeute</Link>.
                        </p>
