...
export function CreationSiteInternetBrestContent({ faqs }: CreationSiteInternetContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, créateur de sites internet à Brest"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              ...
              <span className="italic text-muted-foreground/80">pour sortir du lot dans le Finistère</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je développe des sites web à Brest qui cochent les trois cases qui comptent : rapides, pensés pour convertir et optimisés SEO dès la première ligne de code. Plus de 150 sites livrés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">pas une carte de visite numérique</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      À Brest, beaucoup d&apos;entreprises ont un site qui dort. Joli, fonctionnel, mais personne ne le trouve. Ma mission, c&apos;est l&apos;inverse : je crée des sites qui remontent sur Google quand un Brestois cherche &quot;menuisier Brest&quot;, &quot;agence immobilière Finistère&quot; ou &quot;garagiste Guipavas&quot;.
                    </p>
                    <p>
                      Pensez à votre site comme à un phare. Si personne ne le voit depuis la mer, il ne sert à rien. Mon boulot, c&apos;est de l&apos;allumer et de le placer là où les bateaux passent. Chaque site est construit pour être vu, lu et cliqué.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Création de site internet à Brest"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Target, title: 'Design affûté', desc: 'Une interface qui guide le visiteur vers l\'action, pas qui l\'impressionne pour rien.' },
                  { icon: Zap, title: 'Ultra-rapide', desc: 'Moins d\'une seconde de chargement, Google adore, vos visiteurs aussi.' },
                  { icon: FileSearch, title: 'SEO natif', desc: 'Structure, balisage et contenu préparés pour sortir dans le Finistère.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Un site vitrine à Brest est en ligne en 3 à 5 semaines. Les premiers résultats SEO arrivent généralement dans les 3 mois qui suivent.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Pas des promesses,{' '}
              <span className="italic text-muted-foreground/80">des chiffres réels</span>
            </h2>
          </Reveal>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Des sites qui tournent{' '}
              <span className="italic text-muted-foreground/80">et génèrent du business</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Vous voulez savoir ce qu&apos;un site vraiment optimisé changerait pour votre activité brestoise ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage et audit', description: 'On passe 1 heure ensemble à comprendre votre activité, votre marché brestois et vos concurrents directs. J\'identifie les mots-clés porteurs dans le Finistère et je pose les fondations stratégiques du projet.' },
                { number: '02', title: 'Design et dev', description: 'Je conçois des maquettes que vous validez, puis je développe le site sur mesure en Next.js. Vous suivez tout sur un lien de prévisualisation mis à jour en temps réel. Aucune mauvaise surprise à la livraison.' },
                { number: '03', title: 'Mise en ligne et SEO', description: 'Le site part en production avec un paramétrage SEO complet : Search Console, Analytics, sitemaps, balisages. Dès le premier jour, tout est prêt pour progresser sur Google.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Freelance ou agence web : quel choix pour votre projet brestois ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>En agence, votre projet passe de main en main : commercial, chef de projet, designer, dev junior. À chaque passage, l&apos;information se perd un peu. Avec moi, c&apos;est toujours la même personne qui discute, conçoit, code et accompagne. Moins d&apos;intermédiaires, moins de friction, plus de résultats.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Un interlocuteur', text: 'La personne qui code vous parle.' },
                            { icon: Zap, title: 'Réactivité', text: 'Un message, une réponse le jour même.' },
                            { icon: Target, title: 'Sur mesure', text: 'Aucun template, que du code maison.' },
                            { icon: MessageCircle, title: 'Honnêteté', text: 'Je vous dis ce qui marche, et ce qui ne sert à rien.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Création de site et visibilité locale dans le Finistère">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Créer un site pour une entreprise brestoise, c&apos;est aussi préparer le terrain local : fiche Google Business Profile, pages géolocalisées, balisage adapté aux requêtes du Finistère. Un site qui sort sur &quot;entreprise Brest&quot; rapporte plus qu&apos;un site qui sort sur &quot;entreprise&quot; tout court.
                        </p>
                        <p>
                          J&apos;accompagne des sociétés à <strong>Brest</strong>, <strong>Guipavas</strong>, <strong>Plouzané</strong>, <strong>Le Relecq-Kerhuon</strong>, <strong>Plougastel-Daoulas</strong> et <strong>Landerneau</strong>.
                        </p>
