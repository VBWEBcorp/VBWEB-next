...
interface AgenceReferencementSaintBrieucContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementSaintBrieucContent({ faqs }: AgenceReferencementSaintBrieucContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Saint-Brieuc"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Saint-Brieuc :{' '}
              <span className="italic text-muted-foreground/80">rendez votre site visible sur Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Saint-Brieuc ? Je suis Victor Béasse, expert SEO en Bretagne. J&apos;aide les entreprises des Côtes-d&apos;Armor à se positionner sur Google et à attirer plus de clients. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">ça change pour vous</span> ?
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement naturel détermine quels sites apparaissent quand un habitant de Saint-Brieuc tape &quot;coiffeur Saint-Brieuc&quot; ou &quot;garage Côtes-d&apos;Armor&quot; sur Google. Mon travail : comprendre ces recherches, optimiser votre site pour y répondre et vous faire remonter dans les résultats.
                    </p>
                    <p>
                      L&apos;agglomération briochine est en pleine transformation numérique. Les entreprises qui investissent dans leur référencement aujourd&apos;hui prennent une longueur d&apos;avance sur leurs concurrents qui comptent encore uniquement sur le bouche-à-oreille.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Référencement et visibilité Google pour entreprises à Saint-Brieuc"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site performant, bien indexé et conforme aux attentes de Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages optimisées sur les mots-clés de vos clients briochins.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens entrants pour renforcer la confiance de Google envers votre site.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Premiers résultats entre 3 et 6 mois, puis une montée en puissance constante.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">et voilà leurs résultats</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Curieux de savoir où en est votre site sur Google ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">pour démarrer</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On se parle', description: 'Un premier rendez-vous de 30 minutes pour comprendre votre activité et vos objectifs. En visio ou à Saint-Brieuc.' },
                { number: '02', title: 'Audit et stratégie', description: 'J\'analyse votre site en détail : technique, contenu, positionnement face à la concurrence dans les Côtes-d\'Armor. Vous recevez un plan d\'action clair.' },
                { number: '03', title: 'Résultats progressifs', description: 'Les optimisations sont déployées mois après mois. Vous suivez vos positions, votre trafic et vos contacts dans un espace de suivi dédié.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO vs agence de référencement à Saint-Brieuc">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Saint-Brieuc dispose de quelques agences digitales qui proposent du référencement dans leur offre. La différence avec un expert indépendant : le SEO n&apos;est pas un complément, c&apos;est toute mon activité. Vous bénéficiez d&apos;une expertise approfondie et d&apos;un suivi sans intermédiaire.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Interlocuteur unique', text: 'C\'est moi qui fais le travail et qui vous en parle.' },
                            { icon: Zap, title: 'Réactivité', text: 'Pas de circuit de validation, on avance vite.' },
                            { icon: Target, title: 'Connaissance locale', text: 'Les Côtes-d\'Armor, je connais.' },
                            { icon: MessageCircle, title: 'Transparence', text: 'Un rapport mensuel clair sur vos résultats.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement dans les Côtes-d'Armor">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Les Côtes-d&apos;Armor offrent un marché local où beaucoup d&apos;entreprises n&apos;ont pas encore investi dans le référencement. C&apos;est une opportunité pour celles qui s&apos;y prennent maintenant : moins de concurrence en ligne signifie des résultats plus rapides.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Saint-Brieuc et dans les communes voisines : <strong>Plérin</strong>, <strong>Langueux</strong>, <strong>Trégueux</strong>, <strong>Lamballe</strong>, <strong>Ploufragan</strong>. Je travaille aussi avec des clients à Rennes et dans toute la Bretagne.
                        </p>
