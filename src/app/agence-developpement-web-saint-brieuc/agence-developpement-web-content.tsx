...
interface AgenceDeveloppementWebSaintBrieucContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebSaintBrieucContent({ faqs }: AgenceDeveloppementWebSaintBrieucContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Saint-Brieuc - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Saint-Brieuc,{' '}
              <span className="italic text-muted-foreground/80">ou un expert qui prend votre projet au sérieux</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Saint-Brieuc ? Voici une alternative directe avec un expert dédié. Je suis Victor Béasse, développeur web et consultant SEO. J&apos;accompagne des entreprises des Côtes-d&apos;Armor avec une approche simple : un interlocuteur, un engagement, un résultat mesurable. Plus de 150 sites livrés.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Moins de discours,{' '}
                    <span className="italic text-muted-foreground/80">plus de résultats concrets</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      À Saint-Brieuc comme ailleurs, beaucoup d&apos;entreprises ont déjà eu une expérience mitigée avec des prestataires web : devis qui gonflent, délais qui s&apos;allongent, promesses qui s&apos;évaporent. Ce n&apos;est pas propre aux agences, c&apos;est surtout une question de méthode.
                    </p>
                    <p>
                      Ma méthode est simple : un cahier des charges clair dès le départ, un prix ferme, un calendrier tenu. Je prends moins de projets en parallèle mais je m&apos;investis à fond sur chacun. C&apos;est ce qui fait la différence entre un site qui marche et un site qui se contente d&apos;exister.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Expert développement web à Saint-Brieuc"
                      loading="lazy"
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Méthode', desc: 'Un cadrage sérieux dès le départ pour éviter les mauvaises surprises.' },
                  { icon: FileSearch, title: 'Exécution', desc: 'Un développement propre, documenté, maintenu à jour.' },
                  { icon: TrendingUp, title: 'Résultat', desc: 'Un site qui se positionne sur Google et amène de vrais clients.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Le calendrier est fixé au départ et tenu : 4 à 8 semaines pour un vitrine, 2 à 4 mois pour un e-commerce.
              </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un projet web à lancer dans les Côtes-d&apos;Armor ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Trois temps forts,{' '}
              <span className="italic text-muted-foreground/80">trois engagements tenus</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Comprendre votre besoin', description: 'Un appel ou un rendez-vous à Saint-Brieuc pour poser les bases. Je comprends votre activité et vos objectifs, et je vous propose une solution réaliste avec un prix clair.' },
                { number: '02', title: 'Construire le site', description: 'Je travaille les maquettes et je développe. Vous avez un accès permanent à une préproduction pour suivre l\'avancée et donner vos retours au fil de l\'eau.' },
                { number: '03', title: 'Livrer et transmettre', description: 'Publication, configuration des outils d\'analyse, formation à l\'administration. Vous êtes autonome et vous savez exactement comment gérer votre site au quotidien.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Pour un grand compte avec un projet de plusieurs centaines de milliers d&apos;euros, une agence a sa place. Pour une PME briochine qui veut un site efficace avec un budget raisonnable, travailler en direct avec le développeur est souvent plus pertinent. Les deux modèles ne s&apos;opposent pas, ils ciblent des projets différents.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Proximité', text: 'Vous savez à qui vous parlez.' },
                            { icon: Zap, title: 'Efficacité', text: 'Pas de temps perdu en coordination.' },
                            { icon: Target, title: 'Budget juste', text: 'Vous payez le travail réellement fait.' },
                            { icon: MessageCircle, title: 'Suivi long terme', text: 'Je reste joignable après la livraison.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Un expert au service des entreprises costarmoricaines">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Saint-Brieuc et son agglomération ont un tissu d&apos;entreprises très varié : industrie, commerce, services, artisanat, tourisme sur la côte. Chacune a ses propres besoins digitaux. Travailler directement avec un expert qui comprend votre activité, c&apos;est gagner du temps à chaque étape.
                        </p>
                        <p>
                          J&apos;interviens pour des clients à <strong>Plérin</strong>, <strong>Langueux</strong>, <strong>Trégueux</strong>, <strong>Lamballe</strong>, <strong>Ploufragan</strong>, en plus de Saint-Brieuc.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Agence SEO', desc: 'Référencement naturel à Saint-Brieuc', href: '/agence-seo-saint-brieuc' },
                      { label: 'Référencement naturel', desc: 'Stratégie Google complète', href: '/referencement-naturel-saint-brieuc' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Saint-Brieuc', href: '/freelance-seo-saint-brieuc' },
