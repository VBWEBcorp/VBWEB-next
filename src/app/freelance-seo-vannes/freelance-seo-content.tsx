...
interface FreelanceSeoVannesContentProps {
  faqs: { question: string; answer: string }[]
}

export function FreelanceSeoVannesContent({ faqs }: FreelanceSeoVannesContentProps) {
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, freelance SEO à Vannes"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Freelance SEO à Vannes,{' '}
              <span className="italic text-muted-foreground/80">votre visibilité sur Google commence ici</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, freelance SEO basé à Rennes. J&apos;accompagne les entreprises vannetaises pour qu&apos;elles soient trouvées sur Google : commerces du centre historique, activités nautiques du Golfe du Morbihan, restaurants, artisans. Plus de 200 projets SEO menés et 75 avis 5 étoiles.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Le référencement naturel, c&apos;est ce qui permet à votre site d&apos;apparaître quand quelqu&apos;un tape &quot;restaurant Vannes centre&quot; ou &quot;hotel Golfe du Morbihan&quot; sur Google. J&apos;analyse votre positionnement actuel, j&apos;identifie les mots-clés que vos clients recherchent, et j&apos;optimise votre site pour que vous remontiez dans les résultats.
                    </p>
                    <p>
                      À Vannes, beaucoup d&apos;entreprises dépendent du tourisme et de la saisonnalité. Le SEO vous permet de capter des clients toute l&apos;année, pas uniquement en juillet-août. C&apos;est un investissement qui travaille pour vous 24h/24.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Analyse SEO et stratégie de référencement pour entreprises à Vannes"
                      loading="lazy"
                      width={800}
                      height={600}
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'On échange', description: 'Nous prenons 30 minutes pour que je comprenne votre activité, vos objectifs et ce qui freine votre visibilité. En visio ou en personne à Vannes, comme vous préférez.' },
                { number: '02', title: 'J\'analyse votre site', description: 'Je passe votre site au peigne fin : technique, contenu, positionnement, concurrence locale dans le Morbihan. Vous recevez un plan d\'action clair avec les priorités.' },
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Freelance SEO vs agence à Vannes">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>À Vannes, vous avez le choix entre quelques agences web généralistes et des freelances spécialisés. La différence principale : avec un freelance SEO, vous parlez directement à la personne qui optimise votre site. Pas de commercial entre vous et le travail concret.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            ...
                            { icon: Target, title: 'Sur mesure', text: 'Stratégie adaptée au marché morbihannais.' },
                    ...
                    <ReadMore title="Pourquoi travailler avec un freelance SEO dans le Morbihan">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Le Morbihan a ses particularités : une économie fortement liée au tourisme, des pics de recherche saisonniers, et une concurrence locale qui se digitalise de plus en plus. Un freelance SEO qui connaît ce contexte sait adapter sa stratégie en conséquence.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Vannes et dans les communes voisines : <strong>Arradon</strong>, <strong>Séné</strong>, <strong>Theix-Noyalo</strong>, <strong>Sarzeau</strong>, <strong>Auray</strong>. Je travaille aussi avec des clients à <strong>Lorient</strong>, <strong>Rennes</strong> et <strong>Saint-Malo</strong>.
                        </p>
