...
interface AgenceDeveloppementWebNantesContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceDeveloppementWebNantesContent({ faqs }: AgenceDeveloppementWebNantesContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert développement web à Nantes - alternative à une agence"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence développement web à Nantes,{' '}
              <span className="italic text-muted-foreground/80">ou un expert qui code avec vous</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence à Nantes ? Voici une alternative directe avec un expert dédié. Je suis Victor Béasse, développeur web et consultant SEO indépendant. J&apos;interviens régulièrement dans le Grand Ouest pour livrer des sites performants. Plus de 150 réalisations, 75 avis 5 étoiles et un seul interlocuteur pour votre projet.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    Un expert agile,{' '}
                    <span className="italic text-muted-foreground/80">au cœur de votre projet</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Nantes est un terrain particulièrement dense côté web : grosses agences, studios créatifs, collectifs de freelances, startups tech. Dans ce paysage, choisir le bon partenaire n&apos;est pas évident. Les agences offrent une structure et une équipe, mais leurs tarifs et leurs délais peuvent freiner les projets à budget serré.
                    </p>
                    <p>
                      Un expert indépendant comme moi joue une carte différente : je suis plus agile, plus accessible, et j&apos;apporte la même expertise technique qu&apos;un développeur senior en agence. Vous traitez directement avec la personne qui construit votre site, sans intermédiaires qui filtrent ou ralentissent les décisions.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Expert développement web à Nantes"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Stack moderne', desc: 'WordPress ou Next.js selon votre projet, avec du code actuel et maintenu.' },
                  { icon: FileSearch, title: 'Exécution rapide', desc: 'Des décisions prises en heures et un développement qui avance sans friction.' },
                  { icon: TrendingUp, title: 'SEO compétitif', desc: 'Optimisation poussée pour se positionner sur un marché nantais dense.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Comptez 4 à 8 semaines pour un site vitrine, 2 à 4 mois pour un e-commerce ou une application.
              </p>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            <p className="font-display text-[11px] font-semibold tracking-[0.24em] text-primary/80 uppercase">
              Projets web livrés dans le Grand Ouest
            </p>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Un projet web ambitieux à lancer sur Nantes ?</p>
          <AuditButton />
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-background">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              Un parcours clair,{' '}
              <span className="italic text-muted-foreground/80">sans jargon inutile</span>
            </h2>
          </Reveal>
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Cadrage du projet', description: 'Un premier échange, en visio ou à Nantes, pour définir précisément vos besoins, vos objectifs et vos contraintes. Je vous propose une approche concrète avec un prix ferme.' },
                { number: '02', title: 'Design et développement', description: 'Je travaille les maquettes, vous validez, puis je code. Vous suivez l\'avancée sur un environnement de préproduction accessible à tout moment.' },
                { number: '03', title: 'Lancement et passation', description: 'Mise en ligne, configuration de l\'analytique, formation. Vous êtes pleinement autonome sur votre site et vous savez exactement comment l\'administrer.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Agence ou expert direct : que choisir ?">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Sur un très gros projet avec plusieurs intervenants, une agence nantaise reste souvent le meilleur choix. Pour un site de PME, une refonte ciblée ou une application métier de taille raisonnable, passer directement par l&apos;expert raccourcit le circuit et concentre le budget sur le travail réel. Les deux approches coexistent selon les besoins.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Lien direct', text: 'Pas d\'intermédiaire commercial ou administratif.' },
                            { icon: Zap, title: 'Agilité', text: 'Les ajustements se font vite et bien.' },
                            { icon: Target, title: 'Budget ciblé', text: 'L\'argent va au développement, pas à la structure.' },
                            { icon: MessageCircle, title: 'Relation durable', text: 'Disponible aussi après la livraison.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Un expert au service du Grand Ouest">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Nantes est le pôle économique majeur du Grand Ouest, avec un tissu dense d&apos;entreprises dans la tech, le commerce, les services, l&apos;industrie et la culture. Travailler avec un expert indépendant, c&apos;est choisir la simplicité face à cette densité, avec la garantie d&apos;un interlocuteur qui reste disponible sur la durée.
                        </p>
                        <p>
                          Je travaille sur toute la métropole nantaise : <strong>Saint-Herblain</strong>, <strong>Rezé</strong>, <strong>Orvault</strong>, <strong>Carquefou</strong>, et jusqu&apos;à <strong>Saint-Nazaire</strong> en Loire-Atlantique.
                        </p>
                ...
                <div className="p-6 sm:p-8 lg:p-10">
                  ...
                  <div className="mt-8 space-y-2">
                    {[
                      { label: 'Agence SEO', desc: 'Référencement naturel à Nantes', href: '/agence-seo-nantes' },
                      { label: 'Référencement naturel', desc: 'Stratégie Google complète', href: '/referencement-naturel-nantes' },
                      { label: 'Freelance SEO', desc: 'Consultant indépendant à Nantes', href: '/freelance-seo-nantes' },
