...
interface FreelanceSeoSaintBrieucContentProps {
  faqs: { question: string; answer: string }[]
}

export function FreelanceSeoSaintBrieucContent({ faqs }: FreelanceSeoSaintBrieucContentProps) {
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, freelance SEO à Saint-Brieuc"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Freelance SEO à Saint-Brieuc,{' '}
              <span className="italic text-muted-foreground/80">développez votre clientèle grâce à Google</span>
            </h1>
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Je suis Victor Béasse, freelance SEO basé à Rennes. J&apos;accompagne les entreprises de Saint-Brieuc et des Côtes-d&apos;Armor pour gagner en visibilité sur Google. Du commerce de centre-ville à l&apos;industriel de la Baie, j&apos;aide mes clients à attirer plus de prospects grâce au référencement naturel.
            </p>
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Dans les Côtes-d&apos;Armor, beaucoup d&apos;entreprises locales ont un bon service mais une visibilité en ligne quasi nulle. Pourquoi ? Parce que leurs concurrents ont investi en SEO avant elles. Résultat : quand un habitant cherche &quot;garage Saint-Brieuc&quot; ou &quot;ostéopathe Plérin&quot;, ce sont toujours les mêmes qui apparaissent. Mon rôle, c&apos;est de rééquilibrer la balance en votre faveur.
                    </p>
                    <p>
                      Imaginez le marché des Halles de Saint-Brieuc. Votre stand existe, vos produits sont excellents — mais vous êtes tout au fond, derrière trois rangées. Personne ne vous trouve par hasard. Ce que je fais, c&apos;est vous installer à l&apos;entrée, là où chaque visiteur passe obligatoirement.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <img
                      ...
                      alt="Analyse de données SEO et référencement naturel pour entreprises à Saint-Brieuc"
                      loading="lazy"
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                ...
                { number: '02', title: 'J\'analyse votre site', description: 'Je passe votre site au peigne fin : technique, contenu, positionnement, concurrence locale dans les Côtes-d\'Armor. Vous recevez un plan d\'action clair avec les priorités.' },
                { number: '03', title: 'On avance ensemble', description: 'Les optimisations sont déployées mois après mois. Chaque mois, on fait le point en visio ou en personne à Saint-Brieuc. Vous voyez vos positions Google, votre trafic et les demandes reçues dans votre espace de suivi.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                ...
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Freelance SEO vs agence à Saint-Brieuc">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>En agence, votre dossier passe entre plusieurs interlocuteurs. Le commercial qui vous a convaincu n&apos;est pas celui qui travaille sur votre site. Avec un freelance SEO, vous échangez directement avec la personne qui connaît votre marché briochin et qui met les mains dans le code.</p>
                        <p>Saint-Brieuc a ses spécificités : un tissu économique marqué par l&apos;agroalimentaire, un tourisme balnéaire autour de la Baie, un centre-ville en pleine revitalisation. Une agence parisienne ne connaît pas ces réalités. Moi, je sais que le port du Légué attire un public différent des Champs, et ça change tout dans la stratégie de mots-clés.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Relation directe', text: 'Je comprends votre métier et le marché costarmoricain.' },
                            { icon: Zap, title: 'Réactivité', text: 'Réponse dans la journée, pas dans 48h.' },
                            { icon: Target, title: 'Sur mesure', text: 'Stratégie adaptée à Saint-Brieuc et sa zone de chalandise.' },
                    ...
                    <ReadMore title="Pourquoi un freelance SEO dans les Côtes-d'Armor">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          Les Côtes-d&apos;Armor ont un tissu économique riche mais la concurrence en ligne reste moins féroce que dans les grandes métropoles. C&apos;est une opportunité : avec une stratégie SEO bien menée, vous pouvez prendre des positions dominantes sur Google avant vos concurrents locaux.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises sur tout le département : <strong>Plérin</strong>, <strong>Langueux</strong>, <strong>Trégueux</strong>, <strong>Lamballe</strong>, <strong>Ploufragan</strong>, <strong>Paimpol</strong>. Et aussi à <strong>Rennes</strong>, <strong>Saint-Malo</strong> et <strong>Brest</strong>, parce que le SEO n&apos;a pas de frontière départementale.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          {['Saint-Brieuc', 'Plérin', 'Langueux', 'Trégueux', 'Lamballe', 'Ploufragan', 'Paimpol'].map((city) => (
