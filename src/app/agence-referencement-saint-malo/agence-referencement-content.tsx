...
interface AgenceReferencementSaintMaloContentProps {
  faqs: { question: string; answer: string }[]
}

export function AgenceReferencementSaintMaloContent({ faqs }: AgenceReferencementSaintMaloContentProps) {
    ...
    <>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-28">
          ...
          >
            <div className="mx-auto mb-6 size-20 overflow-hidden rounded-full border-2 border-primary/20 ring-1 ring-foreground/5 sm:size-24">
              <Image
                src="/victor.jpg"
                alt="Victor Béasse, expert en référencement à Saint-Malo"
                width={96}
                height={96}
                priority
            ...
            <h1 className="mt-5 font-display text-balance text-4xl font-medium leading-[1.08] tracking-[-0.03em] text-foreground sm:text-5xl">
              Agence référencement à Saint-Malo :{' '}
            ...
            <p className="hero-description mx-auto mt-6 max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground sm:text-base">
              Vous cherchez une agence de référencement à Saint-Malo ? Je suis Victor Béasse, expert SEO basé à Rennes. J&apos;accompagne les entreprises malouines pour qu&apos;elles captent les bonnes recherches Google, toute l&apos;année. Plus de 200 projets menés, 75 avis 5 étoiles.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[1.5rem] border border-border/60 bg-background/30 sm:rounded-[1.75rem]">
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
                <Reveal>
                  ...
                  <h2 className="mt-4 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[2.75rem]">
                    ...
                    <span className="italic text-muted-foreground/80">change pour vous</span>
                  </h2>
                  <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                    <p>
                      Quand un touriste prépare son week-end à Saint-Malo ou qu&apos;un habitant cherche un artisan de confiance, c&apos;est Google qui oriente le choix. Le référencement naturel, c&apos;est l&apos;art de placer votre site devant les yeux des bonnes personnes, au bon moment.
                    </p>
                    <p>
                      Saint-Malo est une ville où le tourisme pèse lourd, mais pas seulement. Le commerce local, les services aux entreprises, l&apos;artisanat : tous ces secteurs bénéficient d&apos;une meilleure visibilité en ligne. Mon travail, c&apos;est de transformer cette visibilité en clients.
                    </p>
                  </div>
                </Reveal>
                ...
                <Reveal delay={0.1}>
                  <div className="relative overflow-hidden rounded-[1.25rem] border border-border/40">
                    <Image
                      ...
                      alt="Référencement et visibilité Google pour entreprises à Saint-Malo"
                      loading="lazy"
                      width={800}
                      height={600}
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  { icon: Zap, title: 'Technique', desc: 'Un site rapide et bien construit pour plaire à Google.' },
                  { icon: FileSearch, title: 'Contenu', desc: 'Des pages qui ciblent les recherches de vos clients malouins.' },
                  { icon: TrendingUp, title: 'Notoriété', desc: 'Des liens de qualité pour renforcer votre autorité en ligne.' },
                ].map((axis, i) => {
              ...
              <p className="mt-6 text-[14px] text-muted-foreground/70">
                Comptez entre 3 et 6 mois pour les premières améliorations de positionnement, puis une progression continue.
              </p>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-5 font-display text-balance text-3xl font-medium leading-[1.1] tracking-[-0.025em] text-foreground sm:text-4xl lg:text-[3rem]">
              ...
              <span className="italic text-muted-foreground/80">avec des résultats chiffrés</span>
            </h2>
          </Reveal>
      ...
      <div className="bg-card py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <p className="text-[15px] text-muted-foreground">Envie de savoir comment votre site se positionne sur Google ?</p>
          <AuditButton />
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
          ...
          <div className="timeline-container relative mx-auto mt-16 max-w-3xl">
            ...
            <ol className="space-y-6 sm:space-y-8">
              {[
                { number: '01', title: 'Premier contact', description: 'On prend le temps de se parler : votre activité, vos objectifs, ce qui bloque. 30 minutes en visio ou à Saint-Malo.' },
                { number: '02', title: 'Analyse approfondie', description: 'Je passe votre site au crible : performance technique, contenu, liens, positionnement face aux concurrents en Ille-et-Vilaine. Vous recevez un plan d\'action concret.' },
                { number: '03', title: 'Suivi et résultats', description: 'Les optimisations sont déployées chaque mois. Vous suivez en temps réel vos positions Google, votre trafic et les demandes de contact générées.' },
              ].map((step, i) => (
              ...
              <div className="relative grid lg:grid-cols-[1fr_360px]">
                <div className="border-b border-border/40 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-10">
                  ...
                  <div className="mt-8 space-y-3">
                    <ReadMore title="Expert SEO vs agence de référencement à Saint-Malo">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>Saint-Malo compte quelques agences web locales qui proposent du référencement. La différence avec un expert dédié : je ne fais que du SEO, c&apos;est mon coeur de métier. Vous bénéficiez d&apos;une expertise concentrée, d&apos;un suivi rapproché et d&apos;un budget maîtrisé.</p>
                        <div className="grid gap-3 sm:grid-cols-2">
                          {[
                            { icon: User, title: 'Contact direct', text: 'Vous parlez à celui qui fait le travail.' },
                            { icon: Zap, title: 'Vitesse d\'exécution', text: 'Pas de circuit de validation interne.' },
                            { icon: Target, title: 'Connaissance locale', text: 'Le marché malouin, je le connais.' },
                            { icon: MessageCircle, title: 'Reporting mensuel', text: 'Un point clair sur vos résultats chaque mois.' },
                          ].map((item) => {
                    ...
                    <ReadMore title="Le référencement sur la Côte d'Émeraude">
                      <div className="space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                        <p>
                          La Côte d&apos;Émeraude attire des visiteurs toute l&apos;année, avec un pic estival marqué. Le référencement permet de capter cette audience dès la phase de recherche, bien avant l&apos;arrivée sur place. C&apos;est un avantage concurrentiel pour les entreprises locales.
                        </p>
                        <p>
                          J&apos;accompagne des entreprises à Saint-Malo et dans les environs : <strong>Dinard</strong>, <strong>Dinan</strong>, <strong>Cancale</strong>, <strong>Dol-de-Bretagne</strong>, <strong>Saint-Lunaire</strong>. Je travaille aussi avec des clients à Rennes et dans toute la Bretagne.
                        </p>
